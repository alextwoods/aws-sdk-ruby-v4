  ...
  module Validators
    ...
    class Addon
      def self.validate!(input, context:)
        ...
        AddonHealth.validate!(input[:health], context: "#{context}[:health]") unless input[:health].nil?
    ...
    class AddonHealth
      def self.validate!(input, context:)
        ...
        AddonIssueList.validate!(input[:issues], context: "#{context}[:issues]") unless input[:issues].nil?
      end
    end
    ...
    class AddonInfo
      def self.validate!(input, context:)
        ...
        AddonVersionInfoList.validate!(input[:addon_versions], context: "#{context}[:addon_versions]") unless input[:addon_versions].nil?
      end
    end
    ...
    class AddonIssue
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:message], ::String, context: "#{context}[:message]")
        StringList.validate!(input[:resource_ids], context: "#{context}[:resource_ids]") unless input[:resource_ids].nil?
      end
    end
    ...
    class AddonIssueList
      def self.validate!(input, context:)
        ...
        input.each_with_index do |element, index|
          AddonIssue.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class AddonVersionInfo
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:addon_version], ::String, context: "#{context}[:addon_version]")
        StringList.validate!(input[:architecture], context: "#{context}[:architecture]") unless input[:architecture].nil?
        Compatibilities.validate!(input[:compatibilities], context: "#{context}[:compatibilities]") unless input[:compatibilities].nil?
      end
    end
    ...
    class AddonVersionInfoList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          AddonVersionInfo.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class Addons
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          AddonInfo.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class AssociateEncryptionConfigInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:cluster_name], ::String, context: "#{context}[:cluster_name]")
        EncryptionConfigList.validate!(input[:encryption_config], context: "#{context}[:encryption_config]") unless input[:encryption_config].nil?
    ...
    class AssociateIdentityProviderConfigInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:cluster_name], ::String, context: "#{context}[:cluster_name]")
        OidcIdentityProviderConfigRequest.validate!(input[:oidc], context: "#{context}[:oidc]") unless input[:oidc].nil?
        TagMap.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
        Hearth::Validator.validate!(input[:client_request_token], ::String, context: "#{context}[:client_request_token]")
      end
    end
    ...
    class Cluster
      def self.validate!(input, context:)
        ...
        VpcConfigResponse.validate!(input[:resources_vpc_config], context: "#{context}[:resources_vpc_config]") unless input[:resources_vpc_config].nil?
        KubernetesNetworkConfigResponse.validate!(input[:kubernetes_network_config], context: "#{context}[:kubernetes_network_config]") unless input[:kubernetes_network_config].nil?
        ...
        Hearth::Validator.validate!(input[:status], ::String, context: "#{context}[:status]")
        Certificate.validate!(input[:certificate_authority], context: "#{context}[:certificate_authority]") unless input[:certificate_authority].nil?
        Hearth::Validator.validate!(input[:client_request_token], ::String, context: "#{context}[:client_request_token]")
        Hearth::Validator.validate!(input[:platform_version], ::String, context: "#{context}[:platform_version]")
        TagMap.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
        EncryptionConfigList.validate!(input[:encryption_config], context: "#{context}[:encryption_config]") unless input[:encryption_config].nil?
        ConnectorConfigResponse.validate!(input[:connector_config], context: "#{context}[:connector_config]") unless input[:connector_config].nil?
      end
    end
    ...
    class Compatibilities
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Compatibility.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class Compatibility
      def self.validate!(input, context:)
        ...
        StringList.validate!(input[:platform_versions], context: "#{context}[:platform_versions]") unless input[:platform_versions].nil?
    ...
    class CreateAddonOutput
      def self.validate!(input, context:)
        ...
        Addon.validate!(input[:addon], context: "#{context}[:addon]") unless input[:addon].nil?
      end
    end
    ...
    class CreateClusterInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:version], ::String, context: "#{context}[:version]")
        Hearth::Validator.validate!(input[:role_arn], ::String, context: "#{context}[:role_arn]")
        VpcConfigRequest.validate!(input[:resources_vpc_config], context: "#{context}[:resources_vpc_config]") unless input[:resources_vpc_config].nil?
        KubernetesNetworkConfigRequest.validate!(input[:kubernetes_network_config], context: "#{context}[:kubernetes_network_config]") unless input[:kubernetes_network_config].nil?
        Logging.validate!(input[:logging], context: "#{context}[:logging]") unless input[:logging].nil?
        Hearth::Validator.validate!(input[:client_request_token], ::String, context: "#{context}[:client_request_token]")
        TagMap.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
        EncryptionConfigList.validate!(input[:encryption_config], context: "#{context}[:encryption_config]") unless input[:encryption_config].nil?
    ...
    class CreateFargateProfileInput
      def self.validate!(input, context:)
        ...
        FargateProfileSelectors.validate!(input[:selectors], context: "#{context}[:selectors]") unless input[:selectors].nil?
        Hearth::Validator.validate!(input[:client_request_token], ::String, context: "#{context}[:client_request_token]")
        TagMap.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
      end
    end
    ...
    class CreateFargateProfileOutput
      def self.validate!(input, context:)
        ...
        FargateProfile.validate!(input[:fargate_profile], context: "#{context}[:fargate_profile]") unless input[:fargate_profile].nil?
      end
    end
    ...
    class CreateNodegroupInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:cluster_name], ::String, context: "#{context}[:cluster_name]")
        Hearth::Validator.validate!(input[:nodegroup_name], ::String, context: "#{context}[:nodegroup_name]")
        NodegroupScalingConfig.validate!(input[:scaling_config], context: "#{context}[:scaling_config]") unless input[:scaling_config].nil?
        Hearth::Validator.validate!(input[:disk_size], ::Integer, context: "#{context}[:disk_size]")
        StringList.validate!(input[:subnets], context: "#{context}[:subnets]") unless input[:subnets].nil?
        StringList.validate!(input[:instance_types], context: "#{context}[:instance_types]") unless input[:instance_types].nil?
        Hearth::Validator.validate!(input[:ami_type], ::String, context: "#{context}[:ami_type]")
        RemoteAccessConfig.validate!(input[:remote_access], context: "#{context}[:remote_access]") unless input[:remote_access].nil?
        Hearth::Validator.validate!(input[:node_role], ::String, context: "#{context}[:node_role]")
        LabelsMap.validate!(input[:labels], context: "#{context}[:labels]") unless input[:labels].nil?
        TaintsList.validate!(input[:taints], context: "#{context}[:taints]") unless input[:taints].nil?
        TagMap.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
        Hearth::Validator.validate!(input[:client_request_token], ::String, context: "#{context}[:client_request_token]")
        ...
        NodegroupUpdateConfig.validate!(input[:update_config], context: "#{context}[:update_config]") unless input[:update_config].nil?
    ...
    class CreateNodegroupOutput
      def self.validate!(input, context:)
        ...
        Nodegroup.validate!(input[:nodegroup], context: "#{context}[:nodegroup]") unless input[:nodegroup].nil?
      end
    end
    ...
    class DescribeAddonVersionsOutput
      def self.validate!(input, context:)
        ...
        Addons.validate!(input[:addons], context: "#{context}[:addons]") unless input[:addons].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class DescribeIdentityProviderConfigInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:cluster_name], ::String, context: "#{context}[:cluster_name]")
        IdentityProviderConfig.validate!(input[:identity_provider_config], context: "#{context}[:identity_provider_config]") unless input[:identity_provider_config].nil?
      end
    end
    ...
    class DescribeIdentityProviderConfigOutput
      def self.validate!(input, context:)
        ...
        IdentityProviderConfigResponse.validate!(input[:identity_provider_config], context: "#{context}[:identity_provider_config]") unless input[:identity_provider_config].nil?
      end
    end
    ...
    class EncryptionConfig
      def self.validate!(input, context:)
        ...
        StringList.validate!(input[:resources], context: "#{context}[:resources]") unless input[:resources].nil?
        Provider.validate!(input[:provider], context: "#{context}[:provider]") unless input[:provider].nil?
      end
    end
    ...
    class EncryptionConfigList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          EncryptionConfig.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class FargateProfileSelector
      def self.validate!(input, context:)
        ...
        FargateProfileLabel.validate!(input[:labels], context: "#{context}[:labels]") unless input[:labels].nil?
      end
    end
    ...
    class FargateProfileSelectors
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          FargateProfileSelector.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class Identity
      def self.validate!(input, context:)
        ...
        OIDC.validate!(input[:oidc], context: "#{context}[:oidc]") unless input[:oidc].nil?
      end
    end
    ...
    class IdentityProviderConfigResponse
      def self.validate!(input, context:)
        ...
        OidcIdentityProviderConfig.validate!(input[:oidc], context: "#{context}[:oidc]") unless input[:oidc].nil?
      end
    end
    ...
    class IdentityProviderConfigs
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          IdentityProviderConfig.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class IssueList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Issue.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListAddonsOutput
      def self.validate!(input, context:)
        ...
        StringList.validate!(input[:addons], context: "#{context}[:addons]") unless input[:addons].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListClustersInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        IncludeClustersList.validate!(input[:include], context: "#{context}[:include]") unless input[:include].nil?
      end
    end
    ...
    class ListFargateProfilesOutput
      def self.validate!(input, context:)
        ...
        StringList.validate!(input[:fargate_profile_names], context: "#{context}[:fargate_profile_names]") unless input[:fargate_profile_names].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListIdentityProviderConfigsOutput
      def self.validate!(input, context:)
        ...
        IdentityProviderConfigs.validate!(input[:identity_provider_configs], context: "#{context}[:identity_provider_configs]") unless input[:identity_provider_configs].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListNodegroupsOutput
      def self.validate!(input, context:)
        ...
        StringList.validate!(input[:nodegroups], context: "#{context}[:nodegroups]") unless input[:nodegroups].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListUpdatesOutput
      def self.validate!(input, context:)
        ...
        StringList.validate!(input[:update_ids], context: "#{context}[:update_ids]") unless input[:update_ids].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class LogSetup
      def self.validate!(input, context:)
        ...
        LogTypes.validate!(input[:types], context: "#{context}[:types]") unless input[:types].nil?
    ...
    class LogSetups
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          LogSetup.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class Logging
      def self.validate!(input, context:)
        ...
        LogSetups.validate!(input[:cluster_logging], context: "#{context}[:cluster_logging]") unless input[:cluster_logging].nil?
      end
    end
    ...
    class Nodegroup
      def self.validate!(input, context:)
        ...
        LabelsMap.validate!(input[:labels], context: "#{context}[:labels]") unless input[:labels].nil?
        TaintsList.validate!(input[:taints], context: "#{context}[:taints]") unless input[:taints].nil?
        NodegroupResources.validate!(input[:resources], context: "#{context}[:resources]") unless input[:resources].nil?
        Hearth::Validator.validate!(input[:disk_size], ::Integer, context: "#{context}[:disk_size]")
        NodegroupHealth.validate!(input[:health], context: "#{context}[:health]") unless input[:health].nil?
        NodegroupUpdateConfig.validate!(input[:update_config], context: "#{context}[:update_config]") unless input[:update_config].nil?
        LaunchTemplateSpecification.validate!(input[:launch_template], context: "#{context}[:launch_template]") unless input[:launch_template].nil?
        TagMap.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
      end
    ...
    class NodegroupHealth
      def self.validate!(input, context:)
        ...
        IssueList.validate!(input[:issues], context: "#{context}[:issues]") unless input[:issues].nil?
      end
    end
    ...
    class OidcIdentityProviderConfig
      def self.validate!(input, context:)
        ...
        RequiredClaimsMap.validate!(input[:required_claims], context: "#{context}[:required_claims]") unless input[:required_claims].nil?
        TagMap.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
        Hearth::Validator.validate!(input[:status], ::String, context: "#{context}[:status]")
      end
    end
    ...
    class RegisterClusterInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:name], ::String, context: "#{context}[:name]")
        ConnectorConfigRequest.validate!(input[:connector_config], context: "#{context}[:connector_config]") unless input[:connector_config].nil?
        Hearth::Validator.validate!(input[:client_request_token], ::String, context: "#{context}[:client_request_token]")
        TagMap.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
      end
    end
    ...
    class RemoteAccessConfig
      def self.validate!(input, context:)
        ...
        StringList.validate!(input[:source_security_groups], context: "#{context}[:source_security_groups]") unless input[:source_security_groups].nil?
      end
    end
    ...
    class UnsupportedAvailabilityZoneException
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:cluster_name], ::String, context: "#{context}[:cluster_name]")
        Hearth::Validator.validate!(input[:nodegroup_name], ::String, context: "#{context}[:nodegroup_name]")
        StringList.validate!(input[:valid_zones], context: "#{context}[:valid_zones]") unless input[:valid_zones].nil?
      end
    end
    ...
    class Update
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:status], ::String, context: "#{context}[:status]")
        Hearth::Validator.validate!(input[:type], ::String, context: "#{context}[:type]")
        UpdateParams.validate!(input[:params], context: "#{context}[:params]") unless input[:params].nil?
        Hearth::Validator.validate!(input[:created_at], ::Time, context: "#{context}[:created_at]")
        ErrorDetails.validate!(input[:errors], context: "#{context}[:errors]") unless input[:errors].nil?
      end
    end
    ...
    class UpdateLabelsPayload
      def self.validate!(input, context:)
        ...
        LabelsMap.validate!(input[:add_or_update_labels], context: "#{context}[:add_or_update_labels]") unless input[:add_or_update_labels].nil?
        LabelsKeyList.validate!(input[:remove_labels], context: "#{context}[:remove_labels]") unless input[:remove_labels].nil?
      end
    end
    ...
    class UpdateNodegroupConfigInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:cluster_name], ::String, context: "#{context}[:cluster_name]")
        Hearth::Validator.validate!(input[:nodegroup_name], ::String, context: "#{context}[:nodegroup_name]")
        UpdateLabelsPayload.validate!(input[:labels], context: "#{context}[:labels]") unless input[:labels].nil?
        UpdateTaintsPayload.validate!(input[:taints], context: "#{context}[:taints]") unless input[:taints].nil?
        NodegroupScalingConfig.validate!(input[:scaling_config], context: "#{context}[:scaling_config]") unless input[:scaling_config].nil?
        NodegroupUpdateConfig.validate!(input[:update_config], context: "#{context}[:update_config]") unless input[:update_config].nil?
        Hearth::Validator.validate!(input[:client_request_token], ::String, context: "#{context}[:client_request_token]")
      end
    ...
    class UpdateParams
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          UpdateParam.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class UpdateTaintsPayload
      def self.validate!(input, context:)
        ...
        TaintsList.validate!(input[:add_or_update_taints], context: "#{context}[:add_or_update_taints]") unless input[:add_or_update_taints].nil?
        TaintsList.validate!(input[:remove_taints], context: "#{context}[:remove_taints]") unless input[:remove_taints].nil?
      end
    end
    ...
    class VpcConfigRequest
      def self.validate!(input, context:)
        ...
        StringList.validate!(input[:public_access_cidrs], context: "#{context}[:public_access_cidrs]") unless input[:public_access_cidrs].nil?
      end
    end
    ...
    class TaintsList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Taint.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
