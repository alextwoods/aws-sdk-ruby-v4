  ...
  module Builders
    ...
    class AssignInstance
      def self.build(http_req, input:)
        ...
        data['LayerIds'] = Strings.build(input[:layer_ids]) unless input[:layer_ids].nil?
    ...
    class CloneStack
      def self.build(http_req, input:)
        ...
        data['Attributes'] = StackAttributes.build(input[:attributes]) unless input[:attributes].nil?
        ...
        data['ConfigurationManager'] = StackConfigurationManager.build(input[:configuration_manager]) unless input[:configuration_manager].nil?
        data['ChefConfiguration'] = ChefConfiguration.build(input[:chef_configuration]) unless input[:chef_configuration].nil?
        ...
        data['CustomCookbooksSource'] = Source.build(input[:custom_cookbooks_source]) unless input[:custom_cookbooks_source].nil?
        ...
        data['CloneAppIds'] = Strings.build(input[:clone_app_ids]) unless input[:clone_app_ids].nil?
    ...
    class CreateApp
      def self.build(http_req, input:)
        ...
        data['DataSources'] = DataSources.build(input[:data_sources]) unless input[:data_sources].nil?
        data['Type'] = input[:type] unless input[:type].nil?
        data['AppSource'] = Source.build(input[:app_source]) unless input[:app_source].nil?
        data['Domains'] = Strings.build(input[:domains]) unless input[:domains].nil?
        data['EnableSsl'] = input[:enable_ssl] unless input[:enable_ssl].nil?
        data['SslConfiguration'] = SslConfiguration.build(input[:ssl_configuration]) unless input[:ssl_configuration].nil?
        data['Attributes'] = AppAttributes.build(input[:attributes]) unless input[:attributes].nil?
    ...
    class DataSources
      def self.build(input)
        data = []
        input.each do |element|
          data << DataSource.build(element) unless element.nil?
        end
        data
      end
    end
    ...
    class CreateDeployment
      def self.build(http_req, input:)
        ...
        data['InstanceIds'] = Strings.build(input[:instance_ids]) unless input[:instance_ids].nil?
        data['LayerIds'] = Strings.build(input[:layer_ids]) unless input[:layer_ids].nil?
        data['Command'] = DeploymentCommand.build(input[:command]) unless input[:command].nil?
    ...
    class DeploymentCommand
      def self.build(input)
        data = {}
        data['Name'] = input[:name] unless input[:name].nil?
        data['Args'] = DeploymentCommandArgs.build(input[:args]) unless input[:args].nil?
        data
      end
    end
    ...
    class CreateInstance
      def self.build(http_req, input:)
        ...
        data['BlockDeviceMappings'] = BlockDeviceMappings.build(input[:block_device_mappings]) unless input[:block_device_mappings].nil?
    ...
    class BlockDeviceMappings
      def self.build(input)
        data = []
        input.each do |element|
          data << BlockDeviceMapping.build(element) unless element.nil?
        end
        data
      end
    end
    ...
    class BlockDeviceMapping
      def self.build(input)
        ...
        data['Ebs'] = EbsBlockDevice.build(input[:ebs]) unless input[:ebs].nil?
        data
      end
    end
    ...
    class CreateLayer
      def self.build(http_req, input:)
        ...
        data['Name'] = input[:name] unless input[:name].nil?
        data['Shortname'] = input[:shortname] unless input[:shortname].nil?
        data['Attributes'] = LayerAttributes.build(input[:attributes]) unless input[:attributes].nil?
        data['CloudWatchLogsConfiguration'] = CloudWatchLogsConfiguration.build(input[:cloud_watch_logs_configuration]) unless input[:cloud_watch_logs_configuration].nil?
        data['CustomInstanceProfileArn'] = input[:custom_instance_profile_arn] unless input[:custom_instance_profile_arn].nil?
        data['CustomJson'] = input[:custom_json] unless input[:custom_json].nil?
        data['CustomSecurityGroupIds'] = Strings.build(input[:custom_security_group_ids]) unless input[:custom_security_group_ids].nil?
        data['Packages'] = Strings.build(input[:packages]) unless input[:packages].nil?
        data['VolumeConfigurations'] = VolumeConfigurations.build(input[:volume_configurations]) unless input[:volume_configurations].nil?
        ...
        data['CustomRecipes'] = Recipes.build(input[:custom_recipes]) unless input[:custom_recipes].nil?
        data['InstallUpdatesOnBoot'] = input[:install_updates_on_boot] unless input[:install_updates_on_boot].nil?
        data['UseEbsOptimizedInstances'] = input[:use_ebs_optimized_instances] unless input[:use_ebs_optimized_instances].nil?
        data['LifecycleEventConfiguration'] = LifecycleEventConfiguration.build(input[:lifecycle_event_configuration]) unless input[:lifecycle_event_configuration].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class LifecycleEventConfiguration
      def self.build(input)
        data = {}
        data['Shutdown'] = ShutdownEventConfiguration.build(input[:shutdown]) unless input[:shutdown].nil?
        data
      end
    end
    ...
    class Recipes
      def self.build(input)
        data = {}
        data['Setup'] = Strings.build(input[:setup]) unless input[:setup].nil?
        data['Configure'] = Strings.build(input[:configure]) unless input[:configure].nil?
        data['Deploy'] = Strings.build(input[:deploy]) unless input[:deploy].nil?
        data['Undeploy'] = Strings.build(input[:undeploy]) unless input[:undeploy].nil?
        data['Shutdown'] = Strings.build(input[:shutdown]) unless input[:shutdown].nil?
        data
      end
    end
    ...
    class VolumeConfigurations
      def self.build(input)
        data = []
        input.each do |element|
          data << VolumeConfiguration.build(element) unless element.nil?
        end
        data
      end
    end
    ...
    class CloudWatchLogsConfiguration
      def self.build(input)
        ...
        data['LogStreams'] = CloudWatchLogsLogStreams.build(input[:log_streams]) unless input[:log_streams].nil?
        data
      end
    end
    ...
    class CloudWatchLogsLogStreams
      def self.build(input)
        data = []
        input.each do |element|
          data << CloudWatchLogsLogStream.build(element) unless element.nil?
        end
        data
      end
    end
    ...
    class DescribeApps
      def self.build(http_req, input:)
        ...
        data = {}
        data['StackId'] = input[:stack_id] unless input[:stack_id].nil?
        data['AppIds'] = Strings.build(input[:app_ids]) unless input[:app_ids].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeCommands
      def self.build(http_req, input:)
        ...
        data['InstanceId'] = input[:instance_id] unless input[:instance_id].nil?
        data['CommandIds'] = Strings.build(input[:command_ids]) unless input[:command_ids].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeDeployments
      def self.build(http_req, input:)
        ...
        data['StackId'] = input[:stack_id] unless input[:stack_id].nil?
        data['AppId'] = input[:app_id] unless input[:app_id].nil?
        data['DeploymentIds'] = Strings.build(input[:deployment_ids]) unless input[:deployment_ids].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeEcsClusters
      def self.build(http_req, input:)
        ...
        data = {}
        data['EcsClusterArns'] = Strings.build(input[:ecs_cluster_arns]) unless input[:ecs_cluster_arns].nil?
        data['StackId'] = input[:stack_id] unless input[:stack_id].nil?
    ...
    class DescribeElasticIps
      def self.build(http_req, input:)
        ...
        data['InstanceId'] = input[:instance_id] unless input[:instance_id].nil?
        data['StackId'] = input[:stack_id] unless input[:stack_id].nil?
        data['Ips'] = Strings.build(input[:ips]) unless input[:ips].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeRaidArrays
      def self.build(http_req, input:)
        ...
        data['InstanceId'] = input[:instance_id] unless input[:instance_id].nil?
        data['StackId'] = input[:stack_id] unless input[:stack_id].nil?
        data['RaidArrayIds'] = Strings.build(input[:raid_array_ids]) unless input[:raid_array_ids].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeRdsDbInstances
      def self.build(http_req, input:)
        ...
        data = {}
        data['StackId'] = input[:stack_id] unless input[:stack_id].nil?
        data['RdsDbInstanceArns'] = Strings.build(input[:rds_db_instance_arns]) unless input[:rds_db_instance_arns].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeServiceErrors
      def self.build(http_req, input:)
        ...
        data['StackId'] = input[:stack_id] unless input[:stack_id].nil?
        data['InstanceId'] = input[:instance_id] unless input[:instance_id].nil?
        data['ServiceErrorIds'] = Strings.build(input[:service_error_ids]) unless input[:service_error_ids].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeStacks
      def self.build(http_req, input:)
        ...
        data = {}
        data['StackIds'] = Strings.build(input[:stack_ids]) unless input[:stack_ids].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeUserProfiles
      def self.build(http_req, input:)
        ...
        data = {}
        data['IamUserArns'] = Strings.build(input[:iam_user_arns]) unless input[:iam_user_arns].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeVolumes
      def self.build(http_req, input:)
        ...
        data['VolumeIds'] = Strings.build(input[:volume_ids]) unless input[:volume_ids].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class SetLoadBasedAutoScaling
      def self.build(http_req, input:)
        ...
        data['UpScaling'] = AutoScalingThresholds.build(input[:up_scaling]) unless input[:up_scaling].nil?
        data['DownScaling'] = AutoScalingThresholds.build(input[:down_scaling]) unless input[:down_scaling].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class AutoScalingThresholds
      def self.build(input)
        ...
        data['Alarms'] = Strings.build(input[:alarms]) unless input[:alarms].nil?
        data
      end
    end
    ...
    class SetTimeBasedAutoScaling
      def self.build(http_req, input:)
        ...
        data = {}
        data['InstanceId'] = input[:instance_id] unless input[:instance_id].nil?
        data['AutoScalingSchedule'] = WeeklyAutoScalingSchedule.build(input[:auto_scaling_schedule]) unless input[:auto_scaling_schedule].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class WeeklyAutoScalingSchedule
      def self.build(input)
        data = {}
        data['Monday'] = DailyAutoScalingSchedule.build(input[:monday]) unless input[:monday].nil?
        data['Tuesday'] = DailyAutoScalingSchedule.build(input[:tuesday]) unless input[:tuesday].nil?
        data['Wednesday'] = DailyAutoScalingSchedule.build(input[:wednesday]) unless input[:wednesday].nil?
        data['Thursday'] = DailyAutoScalingSchedule.build(input[:thursday]) unless input[:thursday].nil?
        data['Friday'] = DailyAutoScalingSchedule.build(input[:friday]) unless input[:friday].nil?
        data['Saturday'] = DailyAutoScalingSchedule.build(input[:saturday]) unless input[:saturday].nil?
        data['Sunday'] = DailyAutoScalingSchedule.build(input[:sunday]) unless input[:sunday].nil?
        data
      end
    end
