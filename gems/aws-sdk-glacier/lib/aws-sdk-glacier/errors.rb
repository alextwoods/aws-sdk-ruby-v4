...
module AWS::SDK::Glacier
  module Errors
    ...
    class InsufficientCapacityException < ApiClientError
    ...
    class MissingParameterValueException < ApiClientError
      ...
      # @return [Types::MissingParameterValueException]
      #
      attr_reader :data
    end

    class PolicyEnforcedException < ApiClientError
      def initialize(http_resp:, **kwargs)
        @data = Parsers::PolicyEnforcedException.parse(http_resp)
        kwargs[:message] = @data.message if @data.respond_to?(:message)

        super(http_resp: http_resp, **kwargs)
      end

      # @return [Types::PolicyEnforcedException]
      #
      attr_reader :data
    end
