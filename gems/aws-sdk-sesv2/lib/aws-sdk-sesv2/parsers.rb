...
module AWS::SDK::SESv2
  module Parsers
    ...
    # Operation Parser for CreateContactList
    class CreateContactList
      def self.parse(http_resp)
        data = Types::CreateContactListOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data
      end
    end
    ...
    class DkimAttributes
      def self.parse(map)
        ...
        data.last_key_generation_timestamp = Time.at(map['LastKeyGenerationTimestamp'].to_i) if map['LastKeyGenerationTimestamp']
        return data
      end
    end
    ...
    # Operation Parser for CreateEmailIdentityPolicy
    class CreateEmailIdentityPolicy
      def self.parse(http_resp)
        data = Types::CreateEmailIdentityPolicyOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data
      end
    end
    ...
    # Operation Parser for DeleteContactList
    class DeleteContactList
      def self.parse(http_resp)
        data = Types::DeleteContactListOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data
      end
    end
    ...
    # Operation Parser for DeleteEmailIdentityPolicy
    class DeleteEmailIdentityPolicy
      def self.parse(http_resp)
        data = Types::DeleteEmailIdentityPolicyOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data
      end
    end
    ...
    # Operation Parser for DeleteSuppressedDestination
    class DeleteSuppressedDestination
      def self.parse(http_resp)
        data = Types::DeleteSuppressedDestinationOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data
      end
    end
    ...
    class AccountDetails
      def self.parse(map)
        data = Types::AccountDetails.new
        data.mail_type = map['MailType']
    ...
    class TopicPreference
      def self.parse(map)
        data = Types::TopicPreference.new
        data.topic_name = map['TopicName']
        data.subscription_status = map['SubscriptionStatus']
        return data
      end
    end

    # Operation Parser for GetContactList
    ...
    class Topic
      def self.parse(map)
        ...
        data.description = map['Description']
        data.default_subscription_status = map['DefaultSubscriptionStatus']
        return data
      end
    end
    ...
    class GetCustomVerificationEmailTemplate
      def self.parse(http_resp)
        ...
        data.template_subject = map['TemplateSubject']
        data.template_content = map['TemplateContent']
        data.success_redirection_url = map['SuccessRedirectionURL']
        data.failure_redirection_url = map['FailureRedirectionURL']
        data
      end
    end
    ...
    # Operation Parser for GetEmailIdentityPolicies
    ...
    class EmailTemplateContent
      def self.parse(map)
        data = Types::EmailTemplateContent.new
        data.subject = map['Subject']
        data.text = map['Text']
        data.html = map['Html']
        return data
    ...
    class FailureInfo
      def self.parse(map)
        ...
        data.failed_records_s3_url = map['FailedRecordsS3Url']
    ...
    class ContactListDestination
      def self.parse(map)
        data = Types::ContactListDestination.new
        data.contact_list_name = map['ContactListName']
        data.contact_list_import_action = map['ContactListImportAction']
        return data
      end
    end
    ...
    class SuppressionListDestination
      def self.parse(map)
        data = Types::SuppressionListDestination.new
        data.suppression_list_import_action = map['SuppressionListImportAction']
        return data
      end
    end

    # Operation Parser for GetSuppressedDestination
    ...
    class SuppressedDestination
      def self.parse(map)
        data = Types::SuppressedDestination.new
        data.email_address = map['EmailAddress']
    ...
    class SuppressedDestinationAttributes
      def self.parse(map)
        data = Types::SuppressedDestinationAttributes.new
        data.message_id = map['MessageId']
        data.feedback_id = map['FeedbackId']
        return data
      end
    end
    ...
    # Operation Parser for ListContactLists
    ...
    class CustomVerificationEmailTemplateMetadata
      def self.parse(map)
        data = Types::CustomVerificationEmailTemplateMetadata.new
        data.template_name = map['TemplateName']
        data.from_email_address = map['FromEmailAddress']
        data.template_subject = map['TemplateSubject']
        data.success_redirection_url = map['SuccessRedirectionURL']
    ...
    # Operation Parser for ListEmailTemplates
    ...
    class EmailTemplateMetadata
      def self.parse(map)
        data = Types::EmailTemplateMetadata.new
        data.template_name = map['TemplateName']
        data.created_timestamp = Time.at(map['CreatedTimestamp'].to_i) if map['CreatedTimestamp']
        return data
      end
    ...
    # Operation Parser for ListImportJobs
    ...
    # Operation Parser for ListSuppressedDestinations
    ...
    class SuppressedDestinationSummary
      def self.parse(map)
        data = Types::SuppressedDestinationSummary.new
        data.email_address = map['EmailAddress']
        data.reason = map['Reason']
        data.last_update_time = Time.at(map['LastUpdateTime'].to_i) if map['LastUpdateTime']
        return data
    ...
    # Operation Parser for PutAccountDetails
    class PutAccountDetails
      def self.parse(http_resp)
        data = Types::PutAccountDetailsOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data
      end
    end
    ...
    # Operation Parser for PutAccountSuppressionAttributes
    class PutAccountSuppressionAttributes
      def self.parse(http_resp)
        data = Types::PutAccountSuppressionAttributesOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data
      end
    end
    ...
    # Operation Parser for PutConfigurationSetSuppressionOptions
    class PutConfigurationSetSuppressionOptions
      def self.parse(http_resp)
        data = Types::PutConfigurationSetSuppressionOptionsOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data
      end
    end
    ...
    # Operation Parser for PutEmailIdentityConfigurationSetAttributes
    class PutEmailIdentityConfigurationSetAttributes
      def self.parse(http_resp)
        data = Types::PutEmailIdentityConfigurationSetAttributesOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data
      end
    end
    ...
    # Operation Parser for PutEmailIdentityDkimSigningAttributes
    ...
    # Operation Parser for PutSuppressedDestination
    class PutSuppressedDestination
      def self.parse(http_resp)
        data = Types::PutSuppressedDestinationOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data
      end
    end

    # Operation Parser for SendBulkEmail
    class SendBulkEmail
      def self.parse(http_resp)
    ...
    class BulkEmailEntryResult
      def self.parse(map)
        data = Types::BulkEmailEntryResult.new
        data.status = map['Status']
    ...
    # Operation Parser for TestRenderEmailTemplate
    class TestRenderEmailTemplate
      def self.parse(http_resp)
        data = Types::TestRenderEmailTemplateOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data.rendered_template = map['RenderedTemplate']
        data
      end
    end
    ...
    # Operation Parser for UpdateContactList
    class UpdateContactList
      def self.parse(http_resp)
        data = Types::UpdateContactListOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data
      end
    end
    ...
    # Operation Parser for UpdateEmailIdentityPolicy
    class UpdateEmailIdentityPolicy
      def self.parse(http_resp)
        data = Types::UpdateEmailIdentityPolicyOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data
      end
    end
