...
module AWS::SDK::ACM
  module Errors
    ...
    class InvalidDomainValidationOptionsException < ApiClientError
      def initialize(http_resp:, **kwargs)
        @data = Parsers::InvalidDomainValidationOptionsException.parse(http_resp)
        kwargs[:message] = @data.message if @data.respond_to?(:message)

        super(http_resp: http_resp, **kwargs)
      end

      # @return [Types::InvalidDomainValidationOptionsException]
      #
      attr_reader :data
    end
