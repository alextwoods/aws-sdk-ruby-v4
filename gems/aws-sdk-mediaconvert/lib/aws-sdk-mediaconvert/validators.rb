  ...
  module Validators
    ...
    class AudioCodecSettings
      def self.validate!(input, context:)
        ...
        Validators::AiffSettings.validate!(input[:aiff_settings], context: "#{context}[:aiff_settings]") unless input[:aiff_settings].nil?
        Hearth::Validator.validate!(input[:codec], ::String, context: "#{context}[:codec]")
        Validators::Eac3AtmosSettings.validate!(input[:eac3_atmos_settings], context: "#{context}[:eac3_atmos_settings]") unless input[:eac3_atmos_settings].nil?
        ...
        Validators::Mp3Settings.validate!(input[:mp3_settings], context: "#{context}[:mp3_settings]") unless input[:mp3_settings].nil?
        Validators::OpusSettings.validate!(input[:opus_settings], context: "#{context}[:opus_settings]") unless input[:opus_settings].nil?
        Validators::VorbisSettings.validate!(input[:vorbis_settings], context: "#{context}[:vorbis_settings]") unless input[:vorbis_settings].nil?
    ...
    class AudioDescription
      def self.validate!(input, context:)
        ...
        Validators::AudioChannelTaggingSettings.validate!(input[:audio_channel_tagging_settings], context: "#{context}[:audio_channel_tagging_settings]") unless input[:audio_channel_tagging_settings].nil?
    ...
    class AudioSelector
      def self.validate!(input, context:)
        ...
        Validators::HlsRenditionGroupSettings.validate!(input[:hls_rendition_group_settings], context: "#{context}[:hls_rendition_group_settings]") unless input[:hls_rendition_group_settings].nil?
        Hearth::Validator.validate!(input[:language_code], ::String, context: "#{context}[:language_code]")
        Hearth::Validator.validate!(input[:offset], ::Integer, context: "#{context}[:offset]")
        Validators::List____listOf__integerMin1Max2147483647.validate!(input[:pids], context: "#{context}[:pids]") unless input[:pids].nil?
        ...
        Validators::List____listOf__integerMin1Max2147483647.validate!(input[:tracks], context: "#{context}[:tracks]") unless input[:tracks].nil?
      end
    end
    ...
    class AudioSelectorGroup
      def self.validate!(input, context:)
        ...
        Validators::List____listOf__stringMin1.validate!(input[:audio_selector_names], context: "#{context}[:audio_selector_names]") unless input[:audio_selector_names].nil?
      end
    end
    ...
    class AutomatedAbrRule
      def self.validate!(input, context:)
        ...
        Validators::List____listOfAllowedRenditionSize.validate!(input[:allowed_renditions], context: "#{context}[:allowed_renditions]") unless input[:allowed_renditions].nil?
        Validators::List____listOfForceIncludeRenditionSize.validate!(input[:force_include_renditions], context: "#{context}[:force_include_renditions]") unless input[:force_include_renditions].nil?
        Validators::MinBottomRenditionSize.validate!(input[:min_bottom_rendition_size], context: "#{context}[:min_bottom_rendition_size]") unless input[:min_bottom_rendition_size].nil?
        Validators::MinTopRenditionSize.validate!(input[:min_top_rendition_size], context: "#{context}[:min_top_rendition_size]") unless input[:min_top_rendition_size].nil?
    ...
    class AutomatedAbrSettings
      def self.validate!(input, context:)
        ...
        Validators::List____listOfAutomatedAbrRule.validate!(input[:rules], context: "#{context}[:rules]") unless input[:rules].nil?
      end
    end
    ...
    class AutomatedEncodingSettings
      def self.validate!(input, context:)
        ...
        Validators::AutomatedAbrSettings.validate!(input[:abr_settings], context: "#{context}[:abr_settings]") unless input[:abr_settings].nil?
      end
    end
    ...
    class Av1Settings
      def self.validate!(input, context:)
        ...
        Validators::Av1QvbrSettings.validate!(input[:qvbr_settings], context: "#{context}[:qvbr_settings]") unless input[:qvbr_settings].nil?
        Hearth::Validator.validate!(input[:rate_control_mode], ::String, context: "#{context}[:rate_control_mode]")
    ...
    class AvcIntraSettings
      def self.validate!(input, context:)
        ...
        Validators::AvcIntraUhdSettings.validate!(input[:avc_intra_uhd_settings], context: "#{context}[:avc_intra_uhd_settings]") unless input[:avc_intra_uhd_settings].nil?
        Hearth::Validator.validate!(input[:framerate_control], ::String, context: "#{context}[:framerate_control]")
        Hearth::Validator.validate!(input[:framerate_conversion_algorithm], ::String, context: "#{context}[:framerate_conversion_algorithm]")
        Hearth::Validator.validate!(input[:framerate_denominator], ::Integer, context: "#{context}[:framerate_denominator]")
        Hearth::Validator.validate!(input[:framerate_numerator], ::Integer, context: "#{context}[:framerate_numerator]")
    ...
    class CaptionDestinationSettings
      def self.validate!(input, context:)
        ...
        Validators::BurninDestinationSettings.validate!(input[:burnin_destination_settings], context: "#{context}[:burnin_destination_settings]") unless input[:burnin_destination_settings].nil?
        ...
        Validators::ImscDestinationSettings.validate!(input[:imsc_destination_settings], context: "#{context}[:imsc_destination_settings]") unless input[:imsc_destination_settings].nil?
        Validators::SccDestinationSettings.validate!(input[:scc_destination_settings], context: "#{context}[:scc_destination_settings]") unless input[:scc_destination_settings].nil?
        Validators::SrtDestinationSettings.validate!(input[:srt_destination_settings], context: "#{context}[:srt_destination_settings]") unless input[:srt_destination_settings].nil?
    ...
    class CaptionSelector
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:custom_language_code], ::String, context: "#{context}[:custom_language_code]")
        Hearth::Validator.validate!(input[:language_code], ::String, context: "#{context}[:language_code]")
        Validators::CaptionSourceSettings.validate!(input[:source_settings], context: "#{context}[:source_settings]") unless input[:source_settings].nil?
      end
    end
    ...
    class CaptionSourceSettings
      def self.validate!(input, context:)
        ...
        Validators::FileSourceSettings.validate!(input[:file_source_settings], context: "#{context}[:file_source_settings]") unless input[:file_source_settings].nil?
        ...
        Validators::TrackSourceSettings.validate!(input[:track_source_settings], context: "#{context}[:track_source_settings]") unless input[:track_source_settings].nil?
        Validators::WebvttHlsSourceSettings.validate!(input[:webvtt_hls_source_settings], context: "#{context}[:webvtt_hls_source_settings]") unless input[:webvtt_hls_source_settings].nil?
      end
    end
    ...
    class ChannelMapping
      def self.validate!(input, context:)
        ...
        Validators::List____listOfOutputChannelMapping.validate!(input[:output_channels], context: "#{context}[:output_channels]") unless input[:output_channels].nil?
      end
    end
    ...
    class CmafAdditionalManifest
      def self.validate!(input, context:)
        ...
        Validators::List____listOf__stringMin1.validate!(input[:selected_outputs], context: "#{context}[:selected_outputs]") unless input[:selected_outputs].nil?
      end
    end
    ...
    class CmafEncryptionSettings
      def self.validate!(input, context:)
        ...
        Validators::SpekeKeyProviderCmaf.validate!(input[:speke_key_provider], context: "#{context}[:speke_key_provider]") unless input[:speke_key_provider].nil?
        Validators::StaticKeyProvider.validate!(input[:static_key_provider], context: "#{context}[:static_key_provider]") unless input[:static_key_provider].nil?
        Hearth::Validator.validate!(input[:type], ::String, context: "#{context}[:type]")
      end
    end
    ...
    class CmafGroupSettings
      def self.validate!(input, context:)
        ...
        Validators::List____listOfCmafAdditionalManifest.validate!(input[:additional_manifests], context: "#{context}[:additional_manifests]") unless input[:additional_manifests].nil?
        ...
        Validators::DestinationSettings.validate!(input[:destination_settings], context: "#{context}[:destination_settings]") unless input[:destination_settings].nil?
        Validators::CmafEncryptionSettings.validate!(input[:encryption], context: "#{context}[:encryption]") unless input[:encryption].nil?
        ...
        Validators::CmafImageBasedTrickPlaySettings.validate!(input[:image_based_trick_play_settings], context: "#{context}[:image_based_trick_play_settings]") unless input[:image_based_trick_play_settings].nil?
    ...
    class ColorCorrector
      def self.validate!(input, context:)
        ...
        Validators::Hdr10Metadata.validate!(input[:hdr10_metadata], context: "#{context}[:hdr10_metadata]") unless input[:hdr10_metadata].nil?
    ...
    class ContainerSettings
      def self.validate!(input, context:)
        ...
        Validators::CmfcSettings.validate!(input[:cmfc_settings], context: "#{context}[:cmfc_settings]") unless input[:cmfc_settings].nil?
        Hearth::Validator.validate!(input[:container], ::String, context: "#{context}[:container]")
        Validators::F4vSettings.validate!(input[:f4v_settings], context: "#{context}[:f4v_settings]") unless input[:f4v_settings].nil?
        ...
        Validators::MovSettings.validate!(input[:mov_settings], context: "#{context}[:mov_settings]") unless input[:mov_settings].nil?
        Validators::Mp4Settings.validate!(input[:mp4_settings], context: "#{context}[:mp4_settings]") unless input[:mp4_settings].nil?
        Validators::MpdSettings.validate!(input[:mpd_settings], context: "#{context}[:mpd_settings]") unless input[:mpd_settings].nil?
        Validators::MxfSettings.validate!(input[:mxf_settings], context: "#{context}[:mxf_settings]") unless input[:mxf_settings].nil?
      end
    end
    ...
    class CreateJobInput
      def self.validate!(input, context:)
        ...
        Validators::AccelerationSettings.validate!(input[:acceleration_settings], context: "#{context}[:acceleration_settings]") unless input[:acceleration_settings].nil?
        ...
        Validators::List____listOfHopDestination.validate!(input[:hop_destinations], context: "#{context}[:hop_destinations]") unless input[:hop_destinations].nil?
        ...
        Validators::JobSettings.validate!(input[:settings], context: "#{context}[:settings]") unless input[:settings].nil?
        ...
        Validators::Map____mapOf__string.validate!(input[:user_metadata], context: "#{context}[:user_metadata]") unless input[:user_metadata].nil?
      end
    end
    ...
    class CreateJobTemplateInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:priority], ::Integer, context: "#{context}[:priority]")
        Hearth::Validator.validate!(input[:queue], ::String, context: "#{context}[:queue]")
        Validators::JobTemplateSettings.validate!(input[:settings], context: "#{context}[:settings]") unless input[:settings].nil?
        Hearth::Validator.validate!(input[:status_update_interval], ::String, context: "#{context}[:status_update_interval]")
        Validators::Map____mapOf__string.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
      end
    end
    ...
    class CreateJobTemplateOutput
      def self.validate!(input, context:)
        ...
        Validators::JobTemplate.validate!(input[:job_template], context: "#{context}[:job_template]") unless input[:job_template].nil?
      end
    end
    ...
    class CreatePresetInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:description], ::String, context: "#{context}[:description]")
        Hearth::Validator.validate!(input[:name], ::String, context: "#{context}[:name]")
        Validators::PresetSettings.validate!(input[:settings], context: "#{context}[:settings]") unless input[:settings].nil?
        Validators::Map____mapOf__string.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
      end
    end
    ...
    class CreateQueueInput
      def self.validate!(input, context:)
        ...
        Validators::ReservationPlanSettings.validate!(input[:reservation_plan_settings], context: "#{context}[:reservation_plan_settings]") unless input[:reservation_plan_settings].nil?
    ...
    class DashIsoGroupSettings
      def self.validate!(input, context:)
        ...
        Validators::List____listOfDashAdditionalManifest.validate!(input[:additional_manifests], context: "#{context}[:additional_manifests]") unless input[:additional_manifests].nil?
        ...
        Hearth::Validator.validate!(input[:destination], ::String, context: "#{context}[:destination]")
        Validators::DestinationSettings.validate!(input[:destination_settings], context: "#{context}[:destination_settings]") unless input[:destination_settings].nil?
        Validators::DashIsoEncryptionSettings.validate!(input[:encryption], context: "#{context}[:encryption]") unless input[:encryption].nil?
        Hearth::Validator.validate!(input[:fragment_length], ::Integer, context: "#{context}[:fragment_length]")
        Hearth::Validator.validate!(input[:hbbtv_compliance], ::String, context: "#{context}[:hbbtv_compliance]")
        Hearth::Validator.validate!(input[:image_based_trick_play], ::String, context: "#{context}[:image_based_trick_play]")
        Validators::DashIsoImageBasedTrickPlaySettings.validate!(input[:image_based_trick_play_settings], context: "#{context}[:image_based_trick_play_settings]") unless input[:image_based_trick_play_settings].nil?
        Hearth::Validator.validate!(input[:min_buffer_time], ::Integer, context: "#{context}[:min_buffer_time]")
        Hearth::Validator.validate!(input[:min_final_segment_length], ::Float, context: "#{context}[:min_final_segment_length]")
        Hearth::Validator.validate!(input[:mpd_profile], ::String, context: "#{context}[:mpd_profile]")
        Hearth::Validator.validate!(input[:pts_offset_handling_for_b_frames], ::String, context: "#{context}[:pts_offset_handling_for_b_frames]")
    ...
    class DescribeEndpointsOutput
      def self.validate!(input, context:)
        ...
        Validators::List____listOfEndpoint.validate!(input[:endpoints], context: "#{context}[:endpoints]") unless input[:endpoints].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class DestinationSettings
      def self.validate!(input, context:)
        ...
        Validators::S3DestinationSettings.validate!(input[:s3_settings], context: "#{context}[:s3_settings]") unless input[:s3_settings].nil?
      end
    end
    ...
    class DolbyVision
      def self.validate!(input, context:)
        ...
        Validators::DolbyVisionLevel6Metadata.validate!(input[:l6_metadata], context: "#{context}[:l6_metadata]") unless input[:l6_metadata].nil?
    ...
    class EsamSettings
      def self.validate!(input, context:)
        ...
        Validators::EsamManifestConfirmConditionNotification.validate!(input[:manifest_confirm_condition_notification], context: "#{context}[:manifest_confirm_condition_notification]") unless input[:manifest_confirm_condition_notification].nil?
        Hearth::Validator.validate!(input[:response_signal_preroll], ::Integer, context: "#{context}[:response_signal_preroll]")
        Validators::EsamSignalProcessingNotification.validate!(input[:signal_processing_notification], context: "#{context}[:signal_processing_notification]") unless input[:signal_processing_notification].nil?
      end
    end
    ...
    class FileSourceSettings
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:convert608_to708], ::String, context: "#{context}[:convert608_to708]")
        Validators::CaptionSourceFramerate.validate!(input[:framerate], context: "#{context}[:framerate]") unless input[:framerate].nil?
    ...
    class H264Settings
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:quality_tuning_level], ::String, context: "#{context}[:quality_tuning_level]")
        Validators::H264QvbrSettings.validate!(input[:qvbr_settings], context: "#{context}[:qvbr_settings]") unless input[:qvbr_settings].nil?
        Hearth::Validator.validate!(input[:rate_control_mode], ::String, context: "#{context}[:rate_control_mode]")
    ...
    class H265Settings
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:par_numerator], ::Integer, context: "#{context}[:par_numerator]")
        Hearth::Validator.validate!(input[:quality_tuning_level], ::String, context: "#{context}[:quality_tuning_level]")
        Validators::H265QvbrSettings.validate!(input[:qvbr_settings], context: "#{context}[:qvbr_settings]") unless input[:qvbr_settings].nil?
        Hearth::Validator.validate!(input[:rate_control_mode], ::String, context: "#{context}[:rate_control_mode]")
    ...
    class HlsGroupSettings
      def self.validate!(input, context:)
        ...
        Validators::List____listOfHlsAdditionalManifest.validate!(input[:additional_manifests], context: "#{context}[:additional_manifests]") unless input[:additional_manifests].nil?
        Hearth::Validator.validate!(input[:audio_only_header], ::String, context: "#{context}[:audio_only_header]")
        Hearth::Validator.validate!(input[:base_url], ::String, context: "#{context}[:base_url]")
        Validators::List____listOfHlsCaptionLanguageMapping.validate!(input[:caption_language_mappings], context: "#{context}[:caption_language_mappings]") unless input[:caption_language_mappings].nil?
        ...
        Validators::HlsEncryptionSettings.validate!(input[:encryption], context: "#{context}[:encryption]") unless input[:encryption].nil?
        Hearth::Validator.validate!(input[:image_based_trick_play], ::String, context: "#{context}[:image_based_trick_play]")
        Validators::HlsImageBasedTrickPlaySettings.validate!(input[:image_based_trick_play_settings], context: "#{context}[:image_based_trick_play_settings]") unless input[:image_based_trick_play_settings].nil?
        Hearth::Validator.validate!(input[:manifest_compression], ::String, context: "#{context}[:manifest_compression]")
        Hearth::Validator.validate!(input[:manifest_duration_format], ::String, context: "#{context}[:manifest_duration_format]")
        Hearth::Validator.validate!(input[:min_final_segment_length], ::Float, context: "#{context}[:min_final_segment_length]")
    ...
    class ImageInserter
      def self.validate!(input, context:)
        ...
        Validators::List____listOfInsertableImage.validate!(input[:insertable_images], context: "#{context}[:insertable_images]") unless input[:insertable_images].nil?
      end
    end
    ...
    class Input
      def self.validate!(input, context:)
        ...
        Validators::Map____mapOfAudioSelectorGroup.validate!(input[:audio_selector_groups], context: "#{context}[:audio_selector_groups]") unless input[:audio_selector_groups].nil?
        Validators::Map____mapOfAudioSelector.validate!(input[:audio_selectors], context: "#{context}[:audio_selectors]") unless input[:audio_selectors].nil?
        Validators::Map____mapOfCaptionSelector.validate!(input[:caption_selectors], context: "#{context}[:caption_selectors]") unless input[:caption_selectors].nil?
        Validators::Rectangle.validate!(input[:crop], context: "#{context}[:crop]") unless input[:crop].nil?
        Hearth::Validator.validate!(input[:deblock_filter], ::String, context: "#{context}[:deblock_filter]")
        Validators::InputDecryptionSettings.validate!(input[:decryption_settings], context: "#{context}[:decryption_settings]") unless input[:decryption_settings].nil?
        ...
        Validators::ImageInserter.validate!(input[:image_inserter], context: "#{context}[:image_inserter]") unless input[:image_inserter].nil?
        Validators::List____listOfInputClipping.validate!(input[:input_clippings], context: "#{context}[:input_clippings]") unless input[:input_clippings].nil?
        Hearth::Validator.validate!(input[:input_scan_type], ::String, context: "#{context}[:input_scan_type]")
        Validators::Rectangle.validate!(input[:position], context: "#{context}[:position]") unless input[:position].nil?
        ...
        Validators::List____listOf__stringPatternS3ASSETMAPXml.validate!(input[:supplemental_imps], context: "#{context}[:supplemental_imps]") unless input[:supplemental_imps].nil?
        ...
        Validators::InputVideoGenerator.validate!(input[:video_generator], context: "#{context}[:video_generator]") unless input[:video_generator].nil?
    ...
    class Job
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:job_template], ::String, context: "#{context}[:job_template]")
        Validators::JobMessages.validate!(input[:messages], context: "#{context}[:messages]") unless input[:messages].nil?
        Validators::List____listOfOutputGroupDetail.validate!(input[:output_group_details], context: "#{context}[:output_group_details]") unless input[:output_group_details].nil?
        Hearth::Validator.validate!(input[:priority], ::Integer, context: "#{context}[:priority]")
        Hearth::Validator.validate!(input[:queue], ::String, context: "#{context}[:queue]")
        Validators::List____listOfQueueTransition.validate!(input[:queue_transitions], context: "#{context}[:queue_transitions]") unless input[:queue_transitions].nil?
    ...
    class JobMessages
      def self.validate!(input, context:)
        ...
        Validators::List____listOf__string.validate!(input[:info], context: "#{context}[:info]") unless input[:info].nil?
        Validators::List____listOf__string.validate!(input[:warning], context: "#{context}[:warning]") unless input[:warning].nil?
      end
    end
    ...
    class JobSettings
      def self.validate!(input, context:)
        ...
        Validators::EsamSettings.validate!(input[:esam], context: "#{context}[:esam]") unless input[:esam].nil?
        Validators::ExtendedDataServices.validate!(input[:extended_data_services], context: "#{context}[:extended_data_services]") unless input[:extended_data_services].nil?
        Validators::List____listOfInput.validate!(input[:inputs], context: "#{context}[:inputs]") unless input[:inputs].nil?
        Validators::KantarWatermarkSettings.validate!(input[:kantar_watermark], context: "#{context}[:kantar_watermark]") unless input[:kantar_watermark].nil?
        Validators::MotionImageInserter.validate!(input[:motion_image_inserter], context: "#{context}[:motion_image_inserter]") unless input[:motion_image_inserter].nil?
        ...
        Validators::NielsenNonLinearWatermarkSettings.validate!(input[:nielsen_non_linear_watermark], context: "#{context}[:nielsen_non_linear_watermark]") unless input[:nielsen_non_linear_watermark].nil?
        ...
        Validators::TimedMetadataInsertion.validate!(input[:timed_metadata_insertion], context: "#{context}[:timed_metadata_insertion]") unless input[:timed_metadata_insertion].nil?
      end
    end
    ...
    class JobTemplateSettings
      def self.validate!(input, context:)
        ...
        Validators::EsamSettings.validate!(input[:esam], context: "#{context}[:esam]") unless input[:esam].nil?
        Validators::ExtendedDataServices.validate!(input[:extended_data_services], context: "#{context}[:extended_data_services]") unless input[:extended_data_services].nil?
        Validators::List____listOfInputTemplate.validate!(input[:inputs], context: "#{context}[:inputs]") unless input[:inputs].nil?
        Validators::KantarWatermarkSettings.validate!(input[:kantar_watermark], context: "#{context}[:kantar_watermark]") unless input[:kantar_watermark].nil?
        Validators::MotionImageInserter.validate!(input[:motion_image_inserter], context: "#{context}[:motion_image_inserter]") unless input[:motion_image_inserter].nil?
        Validators::NielsenConfiguration.validate!(input[:nielsen_configuration], context: "#{context}[:nielsen_configuration]") unless input[:nielsen_configuration].nil?
        Validators::NielsenNonLinearWatermarkSettings.validate!(input[:nielsen_non_linear_watermark], context: "#{context}[:nielsen_non_linear_watermark]") unless input[:nielsen_non_linear_watermark].nil?
    ...
    class ListJobTemplatesOutput
      def self.validate!(input, context:)
        ...
        Validators::List____listOfJobTemplate.validate!(input[:job_templates], context: "#{context}[:job_templates]") unless input[:job_templates].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListJobsOutput
      def self.validate!(input, context:)
        ...
        Validators::List____listOfJob.validate!(input[:jobs], context: "#{context}[:jobs]") unless input[:jobs].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListPresetsOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Validators::List____listOfPreset.validate!(input[:presets], context: "#{context}[:presets]") unless input[:presets].nil?
      end
    end
    ...
    class ListQueuesOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Validators::List____listOfQueue.validate!(input[:queues], context: "#{context}[:queues]") unless input[:queues].nil?
      end
    end
    ...
    class M2tsSettings
      def self.validate!(input, context:)
        ...
        Validators::List____listOf__integerMin32Max8182.validate!(input[:audio_pids], context: "#{context}[:audio_pids]") unless input[:audio_pids].nil?
        Hearth::Validator.validate!(input[:bitrate], ::Integer, context: "#{context}[:bitrate]")
        ...
        Validators::List____listOf__integerMin32Max8182.validate!(input[:dvb_sub_pids], context: "#{context}[:dvb_sub_pids]") unless input[:dvb_sub_pids].nil?
        ...
        Validators::M2tsScte35Esam.validate!(input[:scte35_esam], context: "#{context}[:scte35_esam]") unless input[:scte35_esam].nil?
    ...
    class MotionImageInserter
      def self.validate!(input, context:)
        ...
        Validators::MotionImageInsertionFramerate.validate!(input[:framerate], context: "#{context}[:framerate]") unless input[:framerate].nil?
        ...
        Validators::MotionImageInsertionOffset.validate!(input[:offset], context: "#{context}[:offset]") unless input[:offset].nil?
    ...
    class MsSmoothGroupSettings
      def self.validate!(input, context:)
        ...
        Validators::List____listOfMsSmoothAdditionalManifest.validate!(input[:additional_manifests], context: "#{context}[:additional_manifests]") unless input[:additional_manifests].nil?
        Hearth::Validator.validate!(input[:audio_deduplication], ::String, context: "#{context}[:audio_deduplication]")
        Hearth::Validator.validate!(input[:destination], ::String, context: "#{context}[:destination]")
        Validators::DestinationSettings.validate!(input[:destination_settings], context: "#{context}[:destination_settings]") unless input[:destination_settings].nil?
        Validators::MsSmoothEncryptionSettings.validate!(input[:encryption], context: "#{context}[:encryption]") unless input[:encryption].nil?
        Hearth::Validator.validate!(input[:fragment_length], ::Integer, context: "#{context}[:fragment_length]")
    ...
    class MxfSettings
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:profile], ::String, context: "#{context}[:profile]")
        Validators::MxfXavcProfileSettings.validate!(input[:xavc_profile_settings], context: "#{context}[:xavc_profile_settings]") unless input[:xavc_profile_settings].nil?
      end
    end
    ...
    class NoiseReducer
      def self.validate!(input, context:)
        ...
        Validators::NoiseReducerFilterSettings.validate!(input[:filter_settings], context: "#{context}[:filter_settings]") unless input[:filter_settings].nil?
        Validators::NoiseReducerSpatialFilterSettings.validate!(input[:spatial_filter_settings], context: "#{context}[:spatial_filter_settings]") unless input[:spatial_filter_settings].nil?
        Validators::NoiseReducerTemporalFilterSettings.validate!(input[:temporal_filter_settings], context: "#{context}[:temporal_filter_settings]") unless input[:temporal_filter_settings].nil?
      end
    end
    ...
    class Output
      def self.validate!(input, context:)
        ...
        Validators::ContainerSettings.validate!(input[:container_settings], context: "#{context}[:container_settings]") unless input[:container_settings].nil?
        ...
        Hearth::Validator.validate!(input[:preset], ::String, context: "#{context}[:preset]")
        Validators::VideoDescription.validate!(input[:video_description], context: "#{context}[:video_description]") unless input[:video_description].nil?
      end
    end
    ...
    class OutputChannelMapping
      def self.validate!(input, context:)
        ...
        Validators::List____listOf__integerMinNegative60Max6.validate!(input[:input_channels], context: "#{context}[:input_channels]") unless input[:input_channels].nil?
        Validators::List____listOf__doubleMinNegative60Max6.validate!(input[:input_channels_fine_tune], context: "#{context}[:input_channels_fine_tune]") unless input[:input_channels_fine_tune].nil?
      end
    end
    ...
    class OutputDetail
      def self.validate!(input, context:)
        ...
        Validators::VideoDetail.validate!(input[:video_details], context: "#{context}[:video_details]") unless input[:video_details].nil?
      end
    end
    ...
    class OutputGroup
      def self.validate!(input, context:)
        ...
        Validators::AutomatedEncodingSettings.validate!(input[:automated_encoding_settings], context: "#{context}[:automated_encoding_settings]") unless input[:automated_encoding_settings].nil?
    ...
    class OutputGroupDetail
      def self.validate!(input, context:)
        ...
        Validators::List____listOfOutputDetail.validate!(input[:output_details], context: "#{context}[:output_details]") unless input[:output_details].nil?
      end
    end
    ...
    class OutputGroupSettings
      def self.validate!(input, context:)
        ...
        Validators::CmafGroupSettings.validate!(input[:cmaf_group_settings], context: "#{context}[:cmaf_group_settings]") unless input[:cmaf_group_settings].nil?
        Validators::DashIsoGroupSettings.validate!(input[:dash_iso_group_settings], context: "#{context}[:dash_iso_group_settings]") unless input[:dash_iso_group_settings].nil?
        Validators::FileGroupSettings.validate!(input[:file_group_settings], context: "#{context}[:file_group_settings]") unless input[:file_group_settings].nil?
    ...
    class PartnerWatermarking
      def self.validate!(input, context:)
        ...
        Validators::NexGuardFileMarkerSettings.validate!(input[:nexguard_file_marker_settings], context: "#{context}[:nexguard_file_marker_settings]") unless input[:nexguard_file_marker_settings].nil?
      end
    end
    ...
    class PresetSettings
      def self.validate!(input, context:)
        ...
        Validators::List____listOfAudioDescription.validate!(input[:audio_descriptions], context: "#{context}[:audio_descriptions]") unless input[:audio_descriptions].nil?
        Validators::List____listOfCaptionDescriptionPreset.validate!(input[:caption_descriptions], context: "#{context}[:caption_descriptions]") unless input[:caption_descriptions].nil?
        Validators::ContainerSettings.validate!(input[:container_settings], context: "#{context}[:container_settings]") unless input[:container_settings].nil?
        Validators::VideoDescription.validate!(input[:video_description], context: "#{context}[:video_description]") unless input[:video_description].nil?
      end
    end
    ...
    class Queue
      def self.validate!(input, context:)
        ...
        Validators::ReservationPlan.validate!(input[:reservation_plan], context: "#{context}[:reservation_plan]") unless input[:reservation_plan].nil?
        Hearth::Validator.validate!(input[:status], ::String, context: "#{context}[:status]")
    ...
    class RemixSettings
      def self.validate!(input, context:)
        ...
        Validators::ChannelMapping.validate!(input[:channel_mapping], context: "#{context}[:channel_mapping]") unless input[:channel_mapping].nil?
    ...
    class S3DestinationSettings
      def self.validate!(input, context:)
        ...
        Validators::S3DestinationAccessControl.validate!(input[:access_control], context: "#{context}[:access_control]") unless input[:access_control].nil?
        Validators::S3EncryptionSettings.validate!(input[:encryption], context: "#{context}[:encryption]") unless input[:encryption].nil?
      end
    end
    ...
    class SpekeKeyProvider
      def self.validate!(input, context:)
        ...
        Validators::List____listOf__stringPattern09aFAF809aFAF409aFAF409aFAF409aFAF12.validate!(input[:system_ids], context: "#{context}[:system_ids]") unless input[:system_ids].nil?
        Hearth::Validator.validate!(input[:url], ::String, context: "#{context}[:url]")
      end
    end
    ...
    class SpekeKeyProviderCmaf
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:certificate_arn], ::String, context: "#{context}[:certificate_arn]")
        Validators::List____listOf__stringMin36Max36Pattern09aFAF809aFAF409aFAF409aFAF409aFAF12.validate!(input[:dash_signaled_system_ids], context: "#{context}[:dash_signaled_system_ids]") unless input[:dash_signaled_system_ids].nil?
        Validators::List____listOf__stringMin36Max36Pattern09aFAF809aFAF409aFAF409aFAF409aFAF12.validate!(input[:hls_signaled_system_ids], context: "#{context}[:hls_signaled_system_ids]") unless input[:hls_signaled_system_ids].nil?
        Hearth::Validator.validate!(input[:resource_id], ::String, context: "#{context}[:resource_id]")
        Hearth::Validator.validate!(input[:url], ::String, context: "#{context}[:url]")
      end
    end
    ...
    class TeletextDestinationSettings
      def self.validate!(input, context:)
        ...
        Validators::List____listOfTeletextPageType.validate!(input[:page_types], context: "#{context}[:page_types]") unless input[:page_types].nil?
      end
    end
    ...
    class TimedMetadataInsertion
      def self.validate!(input, context:)
        ...
        Validators::List____listOfId3Insertion.validate!(input[:id3_insertions], context: "#{context}[:id3_insertions]") unless input[:id3_insertions].nil?
      end
    end
    ...
    class VideoCodecSettings
      def self.validate!(input, context:)
        ...
        Validators::Av1Settings.validate!(input[:av1_settings], context: "#{context}[:av1_settings]") unless input[:av1_settings].nil?
        Validators::AvcIntraSettings.validate!(input[:avc_intra_settings], context: "#{context}[:avc_intra_settings]") unless input[:avc_intra_settings].nil?
        Hearth::Validator.validate!(input[:codec], ::String, context: "#{context}[:codec]")
        ...
        Validators::ProresSettings.validate!(input[:prores_settings], context: "#{context}[:prores_settings]") unless input[:prores_settings].nil?
        Validators::Vc3Settings.validate!(input[:vc3_settings], context: "#{context}[:vc3_settings]") unless input[:vc3_settings].nil?
        Validators::Vp8Settings.validate!(input[:vp8_settings], context: "#{context}[:vp8_settings]") unless input[:vp8_settings].nil?
        Validators::Vp9Settings.validate!(input[:vp9_settings], context: "#{context}[:vp9_settings]") unless input[:vp9_settings].nil?
        Validators::XavcSettings.validate!(input[:xavc_settings], context: "#{context}[:xavc_settings]") unless input[:xavc_settings].nil?
      end
    end
    ...
    class VideoDescription
      def self.validate!(input, context:)
        ...
        Validators::VideoPreprocessor.validate!(input[:video_preprocessors], context: "#{context}[:video_preprocessors]") unless input[:video_preprocessors].nil?
        Hearth::Validator.validate!(input[:width], ::Integer, context: "#{context}[:width]")
      end
    end
    ...
    class VideoPreprocessor
      def self.validate!(input, context:)
        ...
        Validators::ColorCorrector.validate!(input[:color_corrector], context: "#{context}[:color_corrector]") unless input[:color_corrector].nil?
        Validators::Deinterlacer.validate!(input[:deinterlacer], context: "#{context}[:deinterlacer]") unless input[:deinterlacer].nil?
        Validators::DolbyVision.validate!(input[:dolby_vision], context: "#{context}[:dolby_vision]") unless input[:dolby_vision].nil?
        Validators::Hdr10Plus.validate!(input[:hdr10_plus], context: "#{context}[:hdr10_plus]") unless input[:hdr10_plus].nil?
        Validators::ImageInserter.validate!(input[:image_inserter], context: "#{context}[:image_inserter]") unless input[:image_inserter].nil?
        Validators::NoiseReducer.validate!(input[:noise_reducer], context: "#{context}[:noise_reducer]") unless input[:noise_reducer].nil?
        Validators::PartnerWatermarking.validate!(input[:partner_watermarking], context: "#{context}[:partner_watermarking]") unless input[:partner_watermarking].nil?
        Validators::TimecodeBurnin.validate!(input[:timecode_burnin], context: "#{context}[:timecode_burnin]") unless input[:timecode_burnin].nil?
      end
    end
    ...
    class XavcSettings
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:spatial_adaptive_quantization], ::String, context: "#{context}[:spatial_adaptive_quantization]")
        Hearth::Validator.validate!(input[:temporal_adaptive_quantization], ::String, context: "#{context}[:temporal_adaptive_quantization]")
        Validators::Xavc4kIntraCbgProfileSettings.validate!(input[:xavc4k_intra_cbg_profile_settings], context: "#{context}[:xavc4k_intra_cbg_profile_settings]") unless input[:xavc4k_intra_cbg_profile_settings].nil?
        Validators::Xavc4kIntraVbrProfileSettings.validate!(input[:xavc4k_intra_vbr_profile_settings], context: "#{context}[:xavc4k_intra_vbr_profile_settings]") unless input[:xavc4k_intra_vbr_profile_settings].nil?
        Validators::Xavc4kProfileSettings.validate!(input[:xavc4k_profile_settings], context: "#{context}[:xavc4k_profile_settings]") unless input[:xavc4k_profile_settings].nil?
        Validators::XavcHdIntraCbgProfileSettings.validate!(input[:xavc_hd_intra_cbg_profile_settings], context: "#{context}[:xavc_hd_intra_cbg_profile_settings]") unless input[:xavc_hd_intra_cbg_profile_settings].nil?
        Validators::XavcHdProfileSettings.validate!(input[:xavc_hd_profile_settings], context: "#{context}[:xavc_hd_profile_settings]") unless input[:xavc_hd_profile_settings].nil?
      end
    end
    ...
    class List____listOfAllowedRenditionSize
      def self.validate!(input, context:)
        ...
        input.each_with_index do |element, index|
          Validators::AllowedRenditionSize.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfAutomatedAbrRule
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::AutomatedAbrRule.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfCaptionDescriptionPreset
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::CaptionDescriptionPreset.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfCmafAdditionalManifest
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::CmafAdditionalManifest.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfDashAdditionalManifest
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::DashAdditionalManifest.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfForceIncludeRenditionSize
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::ForceIncludeRenditionSize.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfHlsAdditionalManifest
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::HlsAdditionalManifest.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfHlsCaptionLanguageMapping
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::HlsCaptionLanguageMapping.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfHopDestination
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::HopDestination.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfId3Insertion
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::Id3Insertion.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfInputClipping
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::InputClipping.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfInputTemplate
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::InputTemplate.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfInsertableImage
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::InsertableImage.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfJobTemplate
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::JobTemplate.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfMsSmoothAdditionalManifest
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::MsSmoothAdditionalManifest.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfOutputChannelMapping
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::OutputChannelMapping.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfOutputDetail
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::OutputDetail.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfOutputGroupDetail
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::OutputGroupDetail.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfQueueTransition
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::QueueTransition.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class Map____mapOfAudioSelector
      def self.validate!(input, context:)
        ...
        input.each do |key, value|
          ...
          Validators::AudioSelector.validate!(value, context: "#{context}[:#{key}]") unless value.nil?
        end
      end
    end
    ...
    class Map____mapOfAudioSelectorGroup
      def self.validate!(input, context:)
        ...
        input.each do |key, value|
          Hearth::Validator.validate!(key, ::String, ::Symbol, context: "#{context}.keys")
          Validators::AudioSelectorGroup.validate!(value, context: "#{context}[:#{key}]") unless value.nil?
        end
      end
    end
    ...
    class Map____mapOfCaptionSelector
      def self.validate!(input, context:)
        ...
        input.each do |key, value|
          Hearth::Validator.validate!(key, ::String, ::Symbol, context: "#{context}.keys")
          Validators::CaptionSelector.validate!(value, context: "#{context}[:#{key}]") unless value.nil?
        end
      end
    end
