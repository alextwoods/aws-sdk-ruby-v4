...
module AWS::SDK::ChimeSDKIdentity
  describe Client do
    ...
    describe '#deregister_app_instance_user_endpoint' do
    ...
    describe '#describe_app_instance_user_endpoint' do
    ...
    describe '#list_app_instance_user_endpoints' do
    ...
    describe '#register_app_instance_user_endpoint' do
    ...
    describe '#update_app_instance_user_endpoint' do
