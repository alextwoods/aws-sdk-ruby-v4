...
module AWS::SDK::CloudSearchDomain
  module Types
    ...
    #   @return [String]
    #
    DocumentServiceException = ::Struct.new(
      :status,
      :message,
      keyword_init: true
    ) do
    ...
    #   @return [String]
    #
    DocumentServiceWarning = ::Struct.new(
      :message,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #         </ul>
    #
    #   Enum, one of: ["simple", "structured", "lucene", "dismax"]
    #
    #   @return [String]
    #
    # @!attribute return
    ...
    #
    #   @return [Hash<String, BucketInfo>]
    #
    # @!attribute stats
    #   <p>The requested field statistics information.</p>
    #
    #   @return [Hash<String, FieldStats>]
    #
    SearchOutput = ::Struct.new(
      :status,
      :hits,
      :facets,
      :stats,
    ...
    #
    #   @return [Array<SuggestionMatch>]
    #
    SuggestModel = ::Struct.new(
      :query,
      :found,
      :suggestions,
      keyword_init: true
    ...
    #         </ul>
    #
    #   Enum, one of: ["application/json", "application/xml"]
    #
    #   @return [String]
    #
    UploadDocumentsInput = ::Struct.new(
      :documents,
      :content_type,
      keyword_init: true
    ) do
    ...
    #
    #   @return [Array<DocumentServiceWarning>]
    #
    UploadDocumentsOutput = ::Struct.new(
      :status,
      :adds,
      :deletes,
      :warnings,
