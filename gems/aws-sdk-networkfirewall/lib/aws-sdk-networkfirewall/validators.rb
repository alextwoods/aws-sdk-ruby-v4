  ...
  module Validators
    ...
    class ActionDefinition
      def self.validate!(input, context:)
        ...
        PublishMetricAction.validate!(input[:publish_metric_action], context: "#{context}[:publish_metric_action]") unless input[:publish_metric_action].nil?
      end
    end
    ...
    class AssociateSubnetsInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:firewall_arn], ::String, context: "#{context}[:firewall_arn]")
        Hearth::Validator.validate!(input[:firewall_name], ::String, context: "#{context}[:firewall_name]")
        SubnetMappings.validate!(input[:subnet_mappings], context: "#{context}[:subnet_mappings]") unless input[:subnet_mappings].nil?
      end
    end
    ...
    class CreateFirewallOutput
      def self.validate!(input, context:)
        ...
        Firewall.validate!(input[:firewall], context: "#{context}[:firewall]") unless input[:firewall].nil?
        FirewallStatus.validate!(input[:firewall_status], context: "#{context}[:firewall_status]") unless input[:firewall_status].nil?
      end
    end
    ...
    class CreateFirewallPolicyInput
      def self.validate!(input, context:)
        ...
        FirewallPolicy.validate!(input[:firewall_policy], context: "#{context}[:firewall_policy]") unless input[:firewall_policy].nil?
        Hearth::Validator.validate!(input[:description], ::String, context: "#{context}[:description]")
        TagList.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
    ...
    class CreateFirewallPolicyOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:update_token], ::String, context: "#{context}[:update_token]")
        FirewallPolicyResponse.validate!(input[:firewall_policy_response], context: "#{context}[:firewall_policy_response]") unless input[:firewall_policy_response].nil?
      end
    end
    ...
    class CreateRuleGroupInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:dry_run], ::TrueClass, ::FalseClass, context: "#{context}[:dry_run]")
        EncryptionConfiguration.validate!(input[:encryption_configuration], context: "#{context}[:encryption_configuration]") unless input[:encryption_configuration].nil?
        SourceMetadata.validate!(input[:source_metadata], context: "#{context}[:source_metadata]") unless input[:source_metadata].nil?
      end
    end
    ...
    class CreateRuleGroupOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:update_token], ::String, context: "#{context}[:update_token]")
        RuleGroupResponse.validate!(input[:rule_group_response], context: "#{context}[:rule_group_response]") unless input[:rule_group_response].nil?
      end
    end
    ...
    class CustomAction
      def self.validate!(input, context:)
        ...
        ActionDefinition.validate!(input[:action_definition], context: "#{context}[:action_definition]") unless input[:action_definition].nil?
      end
    end
    ...
    class CustomActions
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          CustomAction.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class DescribeRuleGroupMetadataOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:type], ::String, context: "#{context}[:type]")
        Hearth::Validator.validate!(input[:capacity], ::Integer, context: "#{context}[:capacity]")
        StatefulRuleOptions.validate!(input[:stateful_rule_options], context: "#{context}[:stateful_rule_options]") unless input[:stateful_rule_options].nil?
    ...
    class DisassociateSubnetsInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:firewall_arn], ::String, context: "#{context}[:firewall_arn]")
        Hearth::Validator.validate!(input[:firewall_name], ::String, context: "#{context}[:firewall_name]")
        AzSubnets.validate!(input[:subnet_ids], context: "#{context}[:subnet_ids]") unless input[:subnet_ids].nil?
      end
    end
    ...
    class FirewallPolicies
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          FirewallPolicyMetadata.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class FirewallPolicy
      def self.validate!(input, context:)
        ...
        StatelessRuleGroupReferences.validate!(input[:stateless_rule_group_references], context: "#{context}[:stateless_rule_group_references]") unless input[:stateless_rule_group_references].nil?
        StatelessActions.validate!(input[:stateless_default_actions], context: "#{context}[:stateless_default_actions]") unless input[:stateless_default_actions].nil?
        StatelessActions.validate!(input[:stateless_fragment_default_actions], context: "#{context}[:stateless_fragment_default_actions]") unless input[:stateless_fragment_default_actions].nil?
        CustomActions.validate!(input[:stateless_custom_actions], context: "#{context}[:stateless_custom_actions]") unless input[:stateless_custom_actions].nil?
        StatefulRuleGroupReferences.validate!(input[:stateful_rule_group_references], context: "#{context}[:stateful_rule_group_references]") unless input[:stateful_rule_group_references].nil?
        StatefulActions.validate!(input[:stateful_default_actions], context: "#{context}[:stateful_default_actions]") unless input[:stateful_default_actions].nil?
        StatefulEngineOptions.validate!(input[:stateful_engine_options], context: "#{context}[:stateful_engine_options]") unless input[:stateful_engine_options].nil?
      end
    end
    ...
    class FirewallStatus
      def self.validate!(input, context:)
        ...
        SyncStates.validate!(input[:sync_states], context: "#{context}[:sync_states]") unless input[:sync_states].nil?
      end
    end
    ...
    class Firewalls
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          FirewallMetadata.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class IPSet
      def self.validate!(input, context:)
        ...
        VariableDefinitionList.validate!(input[:definition], context: "#{context}[:definition]") unless input[:definition].nil?
      end
    end
    ...
    class IPSets
      def self.validate!(input, context:)
        ...
        input.each do |key, value|
          ...
          IPSet.validate!(value, context: "#{context}[:#{key}]") unless value.nil?
        end
      end
    end
    ...
    class ListFirewallPoliciesOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        FirewallPolicies.validate!(input[:firewall_policies], context: "#{context}[:firewall_policies]") unless input[:firewall_policies].nil?
      end
    end
    ...
    class ListFirewallsInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        VpcIds.validate!(input[:vpc_ids], context: "#{context}[:vpc_ids]") unless input[:vpc_ids].nil?
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    end
    ...
    class ListFirewallsOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Firewalls.validate!(input[:firewalls], context: "#{context}[:firewalls]") unless input[:firewalls].nil?
      end
    end
    ...
    class ListRuleGroupsOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        RuleGroups.validate!(input[:rule_groups], context: "#{context}[:rule_groups]") unless input[:rule_groups].nil?
      end
    end
    ...
    class LogDestinationConfig
      def self.validate!(input, context:)
        ...
        LogDestinationMap.validate!(input[:log_destination], context: "#{context}[:log_destination]") unless input[:log_destination].nil?
      end
    end
    ...
    class LogDestinationConfigs
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          LogDestinationConfig.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class MatchAttributes
      def self.validate!(input, context:)
        ...
        Addresses.validate!(input[:sources], context: "#{context}[:sources]") unless input[:sources].nil?
        Addresses.validate!(input[:destinations], context: "#{context}[:destinations]") unless input[:destinations].nil?
        PortRanges.validate!(input[:source_ports], context: "#{context}[:source_ports]") unless input[:source_ports].nil?
        PortRanges.validate!(input[:destination_ports], context: "#{context}[:destination_ports]") unless input[:destination_ports].nil?
        ProtocolNumbers.validate!(input[:protocols], context: "#{context}[:protocols]") unless input[:protocols].nil?
        TCPFlags.validate!(input[:tcp_flags], context: "#{context}[:tcp_flags]") unless input[:tcp_flags].nil?
      end
    end
    ...
    class PortSets
      def self.validate!(input, context:)
        ...
        input.each do |key, value|
          Hearth::Validator.validate!(key, ::String, ::Symbol, context: "#{context}.keys")
          PortSet.validate!(value, context: "#{context}[:#{key}]") unless value.nil?
        end
      end
    end
    ...
    class RuleDefinition
      def self.validate!(input, context:)
        ...
        MatchAttributes.validate!(input[:match_attributes], context: "#{context}[:match_attributes]") unless input[:match_attributes].nil?
        StatelessActions.validate!(input[:actions], context: "#{context}[:actions]") unless input[:actions].nil?
      end
    end
    ...
    class RuleGroup
      def self.validate!(input, context:)
        ...
        RuleVariables.validate!(input[:rule_variables], context: "#{context}[:rule_variables]") unless input[:rule_variables].nil?
        RulesSource.validate!(input[:rules_source], context: "#{context}[:rules_source]") unless input[:rules_source].nil?
        StatefulRuleOptions.validate!(input[:stateful_rule_options], context: "#{context}[:stateful_rule_options]") unless input[:stateful_rule_options].nil?
      end
    end
    ...
    class RuleGroups
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          RuleGroupMetadata.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class RuleOptions
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          RuleOption.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class RuleVariables
      def self.validate!(input, context:)
        ...
        PortSets.validate!(input[:port_sets], context: "#{context}[:port_sets]") unless input[:port_sets].nil?
      end
    end
    ...
    class RulesSource
      def self.validate!(input, context:)
        ...
        RulesSourceList.validate!(input[:rules_source_list], context: "#{context}[:rules_source_list]") unless input[:rules_source_list].nil?
        StatefulRules.validate!(input[:stateful_rules], context: "#{context}[:stateful_rules]") unless input[:stateful_rules].nil?
        StatelessRulesAndCustomActions.validate!(input[:stateless_rules_and_custom_actions], context: "#{context}[:stateless_rules_and_custom_actions]") unless input[:stateless_rules_and_custom_actions].nil?
      end
    end
    ...
    class RulesSourceList
      def self.validate!(input, context:)
        ...
        RuleTargets.validate!(input[:targets], context: "#{context}[:targets]") unless input[:targets].nil?
        TargetTypes.validate!(input[:target_types], context: "#{context}[:target_types]") unless input[:target_types].nil?
    ...
    class StatefulRule
      def self.validate!(input, context:)
        ...
        Header.validate!(input[:header], context: "#{context}[:header]") unless input[:header].nil?
        RuleOptions.validate!(input[:rule_options], context: "#{context}[:rule_options]") unless input[:rule_options].nil?
      end
    end
    ...
    class StatefulRuleGroupReference
      def self.validate!(input, context:)
        ...
        StatefulRuleGroupOverride.validate!(input[:override], context: "#{context}[:override]") unless input[:override].nil?
      end
    end
    ...
    class StatefulRuleGroupReferences
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          StatefulRuleGroupReference.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class StatefulRules
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          StatefulRule.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class StatelessRule
      def self.validate!(input, context:)
        ...
        RuleDefinition.validate!(input[:rule_definition], context: "#{context}[:rule_definition]") unless input[:rule_definition].nil?
        Hearth::Validator.validate!(input[:priority], ::Integer, context: "#{context}[:priority]")
      end
    end
    ...
    class StatelessRuleGroupReferences
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          StatelessRuleGroupReference.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class StatelessRules
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          StatelessRule.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class StatelessRulesAndCustomActions
      def self.validate!(input, context:)
        ...
        StatelessRules.validate!(input[:stateless_rules], context: "#{context}[:stateless_rules]") unless input[:stateless_rules].nil?
        CustomActions.validate!(input[:custom_actions], context: "#{context}[:custom_actions]") unless input[:custom_actions].nil?
      end
    end
    ...
    class SubnetMappings
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          SubnetMapping.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class SyncState
      def self.validate!(input, context:)
        ...
        SyncStateConfig.validate!(input[:config], context: "#{context}[:config]") unless input[:config].nil?
      end
    end
    ...
    class SyncStateConfig
      def self.validate!(input, context:)
        ...
        input.each do |key, value|
          Hearth::Validator.validate!(key, ::String, ::Symbol, context: "#{context}.keys")
          PerObjectStatus.validate!(value, context: "#{context}[:#{key}]") unless value.nil?
        end
      end
    end
    ...
    class SyncStates
      def self.validate!(input, context:)
        ...
        input.each do |key, value|
          Hearth::Validator.validate!(key, ::String, ::Symbol, context: "#{context}.keys")
          SyncState.validate!(value, context: "#{context}[:#{key}]") unless value.nil?
        end
      end
    end
    ...
    class TCPFlagField
      def self.validate!(input, context:)
        ...
        Flags.validate!(input[:flags], context: "#{context}[:flags]") unless input[:flags].nil?
        Flags.validate!(input[:masks], context: "#{context}[:masks]") unless input[:masks].nil?
      end
    end
    ...
    class TCPFlags
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          TCPFlagField.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
