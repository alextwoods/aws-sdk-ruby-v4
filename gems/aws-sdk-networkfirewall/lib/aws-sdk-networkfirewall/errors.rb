...
module AWS::SDK::NetworkFirewall
  module Errors
    ...
    class InsufficientCapacityException < ApiServerError
      def initialize(http_resp:, **kwargs)
        @data = Parsers::InsufficientCapacityException.parse(http_resp)
        kwargs[:message] = @data.message if @data.respond_to?(:message)

        super(http_resp: http_resp, **kwargs)
      end

      # @return [Types::InsufficientCapacityException]
      #
      attr_reader :data
    end
    ...
    class InvalidResourcePolicyException < ApiClientError
      def initialize(http_resp:, **kwargs)
        @data = Parsers::InvalidResourcePolicyException.parse(http_resp)
        kwargs[:message] = @data.message if @data.respond_to?(:message)

        super(http_resp: http_resp, **kwargs)
      end

      # @return [Types::InvalidResourcePolicyException]
      #
      attr_reader :data
    end
    ...
    class LogDestinationPermissionException < ApiClientError
      def initialize(http_resp:, **kwargs)
        @data = Parsers::LogDestinationPermissionException.parse(http_resp)
        kwargs[:message] = @data.message if @data.respond_to?(:message)

        super(http_resp: http_resp, **kwargs)
      end

      # @return [Types::LogDestinationPermissionException]
      #
      attr_reader :data
    end
    ...
    class ResourceOwnerCheckException < ApiClientError
      def initialize(http_resp:, **kwargs)
        @data = Parsers::ResourceOwnerCheckException.parse(http_resp)
        kwargs[:message] = @data.message if @data.respond_to?(:message)

        super(http_resp: http_resp, **kwargs)
      end

      # @return [Types::ResourceOwnerCheckException]
      #
      attr_reader :data
    end
