  ...
  module Builders
    ...
    class ConfigureLogs
      def self.build(http_req, input:)
        ...
        data['ingressAccessLogs'] = IngressAccessLogs.build(input[:ingress_access_logs]) unless input[:ingress_access_logs].nil?
    ...
    class CreateOriginEndpoint
      def self.build(http_req, input:)
        ...
        data['cmafPackage'] = CmafPackageCreateOrUpdateParameters.build(input[:cmaf_package]) unless input[:cmaf_package].nil?
        ...
        data['whitelist'] = List____listOf__string.build(input[:whitelist]) unless input[:whitelist].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class SpekeKeyProvider
      def self.build(input)
        ...
        data['encryptionContractConfiguration'] = EncryptionContractConfiguration.build(input[:encryption_contract_configuration]) unless input[:encryption_contract_configuration].nil?
    ...
    class HlsPackage
      def self.build(input)
        ...
        data['adTriggers'] = AdTriggers.build(input[:ad_triggers]) unless input[:ad_triggers].nil?
    ...
    class CmafPackageCreateOrUpdateParameters
      def self.build(input)
        ...
        data['hlsManifests'] = List____listOfHlsManifestCreateOrUpdateParameters.build(input[:hls_manifests]) unless input[:hls_manifests].nil?
        data['segmentDurationSeconds'] = input[:segment_duration_seconds] unless input[:segment_duration_seconds].nil?
    ...
    class List____listOfHlsManifestCreateOrUpdateParameters
      def self.build(input)
        data = []
        input.each do |element|
          data << HlsManifestCreateOrUpdateParameters.build(element) unless element.nil?
        end
        data
      end
    end
