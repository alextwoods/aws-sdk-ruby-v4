  ...
  module Validators
    ...
    class ChangeServerLifeCycleStateInput
      def self.validate!(input, context:)
        ...
        ChangeServerLifeCycleStateSourceServerLifecycle.validate!(input[:life_cycle], context: "#{context}[:life_cycle]") unless input[:life_cycle].nil?
      end
    end
    ...
    class ChangeServerLifeCycleStateOutput
      def self.validate!(input, context:)
        ...
        LaunchedInstance.validate!(input[:launched_instance], context: "#{context}[:launched_instance]") unless input[:launched_instance].nil?
    ...
    class DescribeSourceServersRequestFilters
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:is_archived], ::TrueClass, ::FalseClass, context: "#{context}[:is_archived]")
        ReplicationTypes.validate!(input[:replication_types], context: "#{context}[:replication_types]") unless input[:replication_types].nil?
        LifeCycleStates.validate!(input[:life_cycle_states], context: "#{context}[:life_cycle_states]") unless input[:life_cycle_states].nil?
      end
    end
    ...
    class DescribeVcenterClientsOutput
      def self.validate!(input, context:)
        ...
        VcenterClientList.validate!(input[:items], context: "#{context}[:items]") unless input[:items].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class LifeCycle
      def self.validate!(input, context:)
        ...
        LifeCycleLastTest.validate!(input[:last_test], context: "#{context}[:last_test]") unless input[:last_test].nil?
        LifeCycleLastCutover.validate!(input[:last_cutover], context: "#{context}[:last_cutover]") unless input[:last_cutover].nil?
        Hearth::Validator.validate!(input[:state], ::String, context: "#{context}[:state]")
      end
    end
    ...
    class LifeCycleLastCutover
      def self.validate!(input, context:)
        ...
        LifeCycleLastCutoverInitiated.validate!(input[:initiated], context: "#{context}[:initiated]") unless input[:initiated].nil?
        LifeCycleLastCutoverReverted.validate!(input[:reverted], context: "#{context}[:reverted]") unless input[:reverted].nil?
        LifeCycleLastCutoverFinalized.validate!(input[:finalized], context: "#{context}[:finalized]") unless input[:finalized].nil?
      end
    end
    ...
    class LifeCycleLastTest
      def self.validate!(input, context:)
        ...
        LifeCycleLastTestInitiated.validate!(input[:initiated], context: "#{context}[:initiated]") unless input[:initiated].nil?
        LifeCycleLastTestReverted.validate!(input[:reverted], context: "#{context}[:reverted]") unless input[:reverted].nil?
        LifeCycleLastTestFinalized.validate!(input[:finalized], context: "#{context}[:finalized]") unless input[:finalized].nil?
      end
    end
    ...
    class StartCutoverInput
      def self.validate!(input, context:)
        ...
        StartCutoverRequestSourceServerIDs.validate!(input[:source_server_i_ds], context: "#{context}[:source_server_i_ds]") unless input[:source_server_i_ds].nil?
        TagsMap.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
      end
    end
    ...
    class StartTestInput
      def self.validate!(input, context:)
        ...
        StartTestRequestSourceServerIDs.validate!(input[:source_server_i_ds], context: "#{context}[:source_server_i_ds]") unless input[:source_server_i_ds].nil?
        TagsMap.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
      end
    end
    ...
    class TerminateTargetInstancesInput
      def self.validate!(input, context:)
        ...
        TerminateTargetInstancesRequestSourceServerIDs.validate!(input[:source_server_i_ds], context: "#{context}[:source_server_i_ds]") unless input[:source_server_i_ds].nil?
        TagsMap.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
      end
    end
    ...
    class VcenterClient
      def self.validate!(input, context:)
        ...
        TagsMap.validate!(input[:source_server_tags], context: "#{context}[:source_server_tags]") unless input[:source_server_tags].nil?
        TagsMap.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
      end
    end
    ...
    class VcenterClientList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          VcenterClient.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
