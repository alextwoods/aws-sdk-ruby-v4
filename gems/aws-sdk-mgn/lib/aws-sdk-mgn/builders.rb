  ...
  module Builders
    ...
    class ChangeServerLifeCycleState
      def self.build(http_req, input:)
        ...
        data['lifeCycle'] = Builders::ChangeServerLifeCycleStateSourceServerLifecycle.build(input[:life_cycle]) unless input[:life_cycle].nil?
    ...
    class DescribeSourceServersRequestFilters
      def self.build(input)
        ...
        data['replicationTypes'] = Builders::ReplicationTypes.build(input[:replication_types]) unless input[:replication_types].nil?
        data['lifeCycleStates'] = Builders::LifeCycleStates.build(input[:life_cycle_states]) unless input[:life_cycle_states].nil?
        data
      end
    end
    ...
    class StartCutover
      def self.build(http_req, input:)
        ...
        http_req.headers['Content-Type'] = 'application/json'
        data = {}
        data['sourceServerIDs'] = Builders::StartCutoverRequestSourceServerIDs.build(input[:source_server_i_ds]) unless input[:source_server_i_ds].nil?
        data['tags'] = Builders::TagsMap.build(input[:tags]) unless input[:tags].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class StartTest
      def self.build(http_req, input:)
        ...
        http_req.headers['Content-Type'] = 'application/json'
        data = {}
        data['sourceServerIDs'] = Builders::StartTestRequestSourceServerIDs.build(input[:source_server_i_ds]) unless input[:source_server_i_ds].nil?
        data['tags'] = Builders::TagsMap.build(input[:tags]) unless input[:tags].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class TerminateTargetInstances
      def self.build(http_req, input:)
        ...
        http_req.headers['Content-Type'] = 'application/json'
        data = {}
        data['sourceServerIDs'] = Builders::TerminateTargetInstancesRequestSourceServerIDs.build(input[:source_server_i_ds]) unless input[:source_server_i_ds].nil?
        data['tags'] = Builders::TagsMap.build(input[:tags]) unless input[:tags].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
