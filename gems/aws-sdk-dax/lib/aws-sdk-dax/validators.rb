  ...
  module Validators
    ...
    class Cluster
      def self.validate!(input, context:)
        ...
        Endpoint.validate!(input[:cluster_discovery_endpoint], context: "#{context}[:cluster_discovery_endpoint]") unless input[:cluster_discovery_endpoint].nil?
        NodeIdentifierList.validate!(input[:node_ids_to_remove], context: "#{context}[:node_ids_to_remove]") unless input[:node_ids_to_remove].nil?
        ...
        ParameterGroupStatus.validate!(input[:parameter_group], context: "#{context}[:parameter_group]") unless input[:parameter_group].nil?
    ...
    class CreateClusterInput
      def self.validate!(input, context:)
        ...
        SecurityGroupIdentifierList.validate!(input[:security_group_ids], context: "#{context}[:security_group_ids]") unless input[:security_group_ids].nil?
        Hearth::Validator.validate!(input[:preferred_maintenance_window], ::String, context: "#{context}[:preferred_maintenance_window]")
    ...
    class DescribeParameterGroupsInput
      def self.validate!(input, context:)
        ...
        ParameterGroupNameList.validate!(input[:parameter_group_names], context: "#{context}[:parameter_group_names]") unless input[:parameter_group_names].nil?
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class DescribeSubnetGroupsInput
      def self.validate!(input, context:)
        ...
        SubnetGroupNameList.validate!(input[:subnet_group_names], context: "#{context}[:subnet_group_names]") unless input[:subnet_group_names].nil?
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class NodeTypeSpecificValueList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          NodeTypeSpecificValue.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class Parameter
      def self.validate!(input, context:)
        ...
        NodeTypeSpecificValueList.validate!(input[:node_type_specific_values], context: "#{context}[:node_type_specific_values]") unless input[:node_type_specific_values].nil?
        Hearth::Validator.validate!(input[:description], ::String, context: "#{context}[:description]")
        Hearth::Validator.validate!(input[:source], ::String, context: "#{context}[:source]")
    ...
    class ParameterGroupStatus
      def self.validate!(input, context:)
        ...
        NodeIdentifierList.validate!(input[:node_ids_to_reboot], context: "#{context}[:node_ids_to_reboot]") unless input[:node_ids_to_reboot].nil?
      end
    end
