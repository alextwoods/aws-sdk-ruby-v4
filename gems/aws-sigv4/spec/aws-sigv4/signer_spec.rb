...
module AWS
  module SigV4
    ...
    describe Signer do
      ...
      subject { Signer.new(client_options) }
      ...
      describe '#initialize' do
        ...
        it 'sets defaults' do
          ...
          expect(signer.unsigned_headers).to eq(unsigned_headers)
...
#           signature = Signer.new(options).sign_request(request: request)
#
...
#             }
#           )
#           expect(signature.headers['x-amz-date'])
...
#         end
#
#         context 'credentials has session token' do
#           let(:credentials) do
#             Credentials.new(
#               access_key_id: 'akid',
#               secret_access_key: 'secret',
...
#         end
#
#         it 'adds the X-Amz-Content-Sha256 header if '\
#            ':apply_checksum_header is true' do
...
#         end
#
#         it 'can omit the X-Amz-Content-Sha256 header if '\
#            ':apply_checksum_header is false' do
...
#             .to eq('AWS4-HMAC-SHA256 Credential=akid/20120101/us-peccy-1'\
#                    '/peccy-service/aws4_request, SignedHeaders=bar;bar2;foo;'\
#                    'host;x-amz-content-sha256;x-amz-date, Signature=dd8a95be'\
#                    '0e53f9886f9b37ed7195a8691644882646cea60c138fc7ada0314b5e')
#         end
#
...
#         end
#
#         it 'escapes path for the canonical request '\
#            'if :uri_escape_path is true' do
#           skip("CRT does not provide canonical request") if Signer.use_crt?
#
...
#         end
#
#         it 'does not escape path for the canonical request '\
#            'if :uri_escape_path is false' do
#           skip("CRT does not provide canonical request") if Signer.use_crt?
#
