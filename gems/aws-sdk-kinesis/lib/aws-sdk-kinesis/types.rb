...
module AWS::SDK::Kinesis
  module Types
    ...
    # Includes enum constants for ConsumerStatus
    #
    ...
    # Includes enum constants for MetricsName
    #
    module MetricsName
      # No documentation available.
      #
    ...
    # Includes enum constants for ShardFilterType
    #
    ...
    # Includes enum constants for StreamMode
    #
    module StreamMode
      # No documentation available.
      #
