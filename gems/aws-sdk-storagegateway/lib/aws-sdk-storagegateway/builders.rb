  ...
  module Builders
    ...
    class AddCache
      def self.build(http_req, input:)
        ...
        data['DiskIds'] = Builders::DiskIds.build(input[:disk_ids]) unless input[:disk_ids].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class AssociateFileSystem
      def self.build(http_req, input:)
        ...
        data['CacheAttributes'] = Builders::CacheAttributes.build(input[:cache_attributes]) unless input[:cache_attributes].nil?
        data['EndpointNetworkConfiguration'] = Builders::EndpointNetworkConfiguration.build(input[:endpoint_network_configuration]) unless input[:endpoint_network_configuration].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class EndpointNetworkConfiguration
      def self.build(input)
        data = {}
        data['IpAddresses'] = Builders::IpAddressList.build(input[:ip_addresses]) unless input[:ip_addresses].nil?
        data
      end
    end
    ...
    class CreateNFSFileShare
      def self.build(http_req, input:)
        ...
        data = {}
        data['ClientToken'] = input[:client_token] unless input[:client_token].nil?
        data['NFSFileShareDefaults'] = Builders::NFSFileShareDefaults.build(input[:nfs_file_share_defaults]) unless input[:nfs_file_share_defaults].nil?
        data['GatewayARN'] = input[:gateway_arn] unless input[:gateway_arn].nil?
        data['KMSEncrypted'] = input[:kms_encrypted] unless input[:kms_encrypted].nil?
        data['KMSKey'] = input[:kms_key] unless input[:kms_key].nil?
        ...
        data['ClientList'] = Builders::FileShareClientList.build(input[:client_list]) unless input[:client_list].nil?
    ...
    class CreateSMBFileShare
      def self.build(http_req, input:)
        ...
        data['AdminUserList'] = Builders::UserList.build(input[:admin_user_list]) unless input[:admin_user_list].nil?
        data['ValidUserList'] = Builders::UserList.build(input[:valid_user_list]) unless input[:valid_user_list].nil?
        data['InvalidUserList'] = Builders::UserList.build(input[:invalid_user_list]) unless input[:invalid_user_list].nil?
        data['AuditDestinationARN'] = input[:audit_destination_arn] unless input[:audit_destination_arn].nil?
    ...
    class DescribeCachediSCSIVolumes
      def self.build(http_req, input:)
        ...
        data = {}
        data['VolumeARNs'] = Builders::VolumeARNs.build(input[:volume_ar_ns]) unless input[:volume_ar_ns].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeFileSystemAssociations
      def self.build(http_req, input:)
        ...
        data = {}
        data['FileSystemAssociationARNList'] = Builders::FileSystemAssociationARNList.build(input[:file_system_association_arn_list]) unless input[:file_system_association_arn_list].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeNFSFileShares
      def self.build(http_req, input:)
        ...
        data = {}
        data['FileShareARNList'] = Builders::FileShareARNList.build(input[:file_share_arn_list]) unless input[:file_share_arn_list].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeTapeArchives
      def self.build(http_req, input:)
        ...
        data = {}
        data['TapeARNs'] = Builders::TapeARNs.build(input[:tape_ar_ns]) unless input[:tape_ar_ns].nil?
    ...
    class DescribeVTLDevices
      def self.build(http_req, input:)
        ...
        data = {}
        data['GatewayARN'] = input[:gateway_arn] unless input[:gateway_arn].nil?
        data['VTLDeviceARNs'] = Builders::VTLDeviceARNs.build(input[:vtl_device_ar_ns]) unless input[:vtl_device_ar_ns].nil?
        data['Marker'] = input[:marker] unless input[:marker].nil?
        data['Limit'] = input[:limit] unless input[:limit].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    ...
    class JoinDomain
      def self.build(http_req, input:)
        ...
        data['DomainControllers'] = Builders::Hosts.build(input[:domain_controllers]) unless input[:domain_controllers].nil?
    ...
    class ListTapePools
      def self.build(http_req, input:)
        ...
        data = {}
        data['PoolARNs'] = Builders::PoolARNs.build(input[:pool_ar_ns]) unless input[:pool_ar_ns].nil?
        data['Marker'] = input[:marker] unless input[:marker].nil?
        data['Limit'] = input[:limit] unless input[:limit].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    ...
    class RefreshCache
      def self.build(http_req, input:)
        ...
        data = {}
        data['FileShareARN'] = input[:file_share_arn] unless input[:file_share_arn].nil?
        data['FolderList'] = Builders::FolderList.build(input[:folder_list]) unless input[:folder_list].nil?
    ...
    class UpdateAutomaticTapeCreationPolicy
      def self.build(http_req, input:)
        ...
        data = {}
        data['AutomaticTapeCreationRules'] = Builders::AutomaticTapeCreationRules.build(input[:automatic_tape_creation_rules]) unless input[:automatic_tape_creation_rules].nil?
        data['GatewayARN'] = input[:gateway_arn] unless input[:gateway_arn].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class AutomaticTapeCreationRules
      def self.build(input)
        data = []
        input.each do |element|
          data << Builders::AutomaticTapeCreationRule.build(element) unless element.nil?
        end
        data
      end
    end
    ...
    class UpdateBandwidthRateLimitSchedule
      def self.build(http_req, input:)
        ...
        data = {}
        data['GatewayARN'] = input[:gateway_arn] unless input[:gateway_arn].nil?
        data['BandwidthRateLimitIntervals'] = Builders::BandwidthRateLimitIntervals.build(input[:bandwidth_rate_limit_intervals]) unless input[:bandwidth_rate_limit_intervals].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class BandwidthRateLimitIntervals
      def self.build(input)
        data = []
        input.each do |element|
          data << Builders::BandwidthRateLimitInterval.build(element) unless element.nil?
        end
        data
      end
    end
    ...
    class BandwidthRateLimitInterval
      def self.build(input)
        ...
        data['DaysOfWeek'] = Builders::DaysOfWeek.build(input[:days_of_week]) unless input[:days_of_week].nil?
        data['AverageUploadRateLimitInBitsPerSec'] = input[:average_upload_rate_limit_in_bits_per_sec] unless input[:average_upload_rate_limit_in_bits_per_sec].nil?
        data['AverageDownloadRateLimitInBitsPerSec'] = input[:average_download_rate_limit_in_bits_per_sec] unless input[:average_download_rate_limit_in_bits_per_sec].nil?
        data
      end
    ...
    class UpdateSMBLocalGroups
      def self.build(http_req, input:)
        ...
        data = {}
        data['GatewayARN'] = input[:gateway_arn] unless input[:gateway_arn].nil?
        data['SMBLocalGroups'] = Builders::SMBLocalGroups.build(input[:smb_local_groups]) unless input[:smb_local_groups].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class SMBLocalGroups
      def self.build(input)
        data = {}
        data['GatewayAdmins'] = Builders::UserList.build(input[:gateway_admins]) unless input[:gateway_admins].nil?
        data
      end
    end
