...
module AWS::SDK::ApplicationAutoScaling
  module Errors
    ...
    class FailedResourceAccessException < ApiClientError
      def initialize(http_resp:, **kwargs)
        @data = Parsers::FailedResourceAccessException.parse(http_resp)
        kwargs[:message] = @data.message if @data.respond_to?(:message)

        super(http_resp: http_resp, **kwargs)
      end

      # @return [Types::FailedResourceAccessException]
      #
      attr_reader :data
    end
