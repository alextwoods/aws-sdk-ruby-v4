  ...
  module Builders
    ...
    class AddAttachmentsToSet
      def self.build(http_req, input:)
        ...
        data['attachments'] = Attachments.build(input[:attachments]) unless input[:attachments].nil?
    ...
    class Attachments
      def self.build(input)
        ...
        input.each do |element|
          data << Attachment.build(element) unless element.nil?
        end
        data
      end
    end
    ...
    class AddCommunicationToCase
      def self.build(http_req, input:)
        ...
        data['ccEmailAddresses'] = CcEmailAddressList.build(input[:cc_email_addresses]) unless input[:cc_email_addresses].nil?
        data['attachmentSetId'] = input[:attachment_set_id] unless input[:attachment_set_id].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeCases
      def self.build(http_req, input:)
        ...
        data = {}
        data['caseIdList'] = CaseIdList.build(input[:case_id_list]) unless input[:case_id_list].nil?
    ...
    class DescribeServices
      def self.build(http_req, input:)
        ...
        data = {}
        data['serviceCodeList'] = ServiceCodeList.build(input[:service_code_list]) unless input[:service_code_list].nil?
        data['language'] = input[:language] unless input[:language].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DescribeTrustedAdvisorCheckRefreshStatuses
      def self.build(http_req, input:)
        ...
        data = {}
        data['checkIds'] = StringList.build(input[:check_ids]) unless input[:check_ids].nil?
        http_req.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
