...
module AWS::SDK::SQS
  module Types
    ...
    #
    BatchEntryIdsNotDistinct = ::Struct.new(
      nil,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #
    BatchRequestTooLong = ::Struct.new(
      nil,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #
    #   @return [Array<ChangeMessageVisibilityBatchRequestEntry>]
    #
    ChangeMessageVisibilityBatchInput = ::Struct.new(
      :queue_url,
      :entries,
      keyword_init: true
    ) do
    ...
    #               </code> items.</p>
    #
    #   @return [Array<ChangeMessageVisibilityBatchResultEntry>]
    #
    # @!attribute failed
    #   <p>A list of <code>
    #                  <a>BatchResultErrorEntry</a>
    ...
    #
    ChangeMessageVisibilityBatchOutput = ::Struct.new(
      :successful,
      :failed,
      keyword_init: true
    ) do
    ...
    #   @return [Integer]
    #
    ChangeMessageVisibilityBatchRequestEntry = ::Struct.new(
      :id,
      :receipt_handle,
      :visibility_timeout,
      keyword_init: true
    ...
    #   @return [String]
    #
    ChangeMessageVisibilityBatchResultEntry = ::Struct.new(
      :id,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #   @return [Integer]
    #
    ChangeMessageVisibilityInput = ::Struct.new(
      :queue_url,
      :receipt_handle,
      :visibility_timeout,
      keyword_init: true
    ...
    #
    #   @return [Array<DeleteMessageBatchRequestEntry>]
    #
    DeleteMessageBatchInput = ::Struct.new(
      :queue_url,
      :entries,
      keyword_init: true
    ) do
    ...
    #               </code> items.</p>
    #
    #   @return [Array<DeleteMessageBatchResultEntry>]
    #
    # @!attribute failed
    #   <p>A list of <code>
    #                  <a>BatchResultErrorEntry</a>
    ...
    #   @return [Array<BatchResultErrorEntry>]
    #
    DeleteMessageBatchOutput = ::Struct.new(
      :successful,
      :failed,
      keyword_init: true
    ) do
    ...
    #   @return [String]
    #
    DeleteMessageBatchRequestEntry = ::Struct.new(
      :id,
      :receipt_handle,
      keyword_init: true
    ) do
    ...
    #   @return [String]
    #
    DeleteMessageBatchResultEntry = ::Struct.new(
      :id,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #   @return [Array<String>]
    #
    GetQueueAttributesInput = ::Struct.new(
      :queue_url,
      :attribute_names,
      keyword_init: true
    ) do
    ...
    #   @return [Hash<String, String>]
    #
    GetQueueAttributesOutput = ::Struct.new(
      :attributes,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #
    InvalidAttributeName = ::Struct.new(
      nil,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #
    InvalidBatchEntryId = ::Struct.new(
      nil,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #
    InvalidMessageContents = ::Struct.new(
      nil,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #   @return [Integer]
    #
    ListDeadLetterSourceQueuesInput = ::Struct.new(
      :queue_url,
      :next_token,
      :max_results,
      keyword_init: true
    ...
    #   @return [String]
    #
    ListDeadLetterSourceQueuesOutput = ::Struct.new(
      :queue_urls,
      :next_token,
      keyword_init: true
    ) do
    ...
    #   @return [Hash<String, String>]
    #
    ListQueueTagsOutput = ::Struct.new(
      :tags,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #   @return [Hash<String, String>]
    #
    # @!attribute md5_of_message_attributes
    ...
    #   @return [String]
    #
    # @!attribute string_list_values
    #   <p>Not implemented. Reserved for future use.</p>
    #
    #   @return [Array<String>]
    #
    # @!attribute binary_list_values
    #   <p>Not implemented. Reserved for future use.</p>
    #
    #   @return [Array<String>]
    #
    ...
    # Includes enum constants for MessageSystemAttributeName
    #
    ...
    # Includes enum constants for MessageSystemAttributeNameForSends
    #
    ...
    #   @return [String]
    #
    MessageSystemAttributeValue = ::Struct.new(
      :string_value,
      :binary_value,
      :string_list_values,
      :binary_list_values,
    ...
    #
    PurgeQueueInProgress = ::Struct.new(
      nil,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    # Includes enum constants for QueueAttributeName
    #
    ...
    #
    QueueDeletedRecently = ::Struct.new(
      nil,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #
    ReceiptHandleIsInvalid = ::Struct.new(
      nil,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #   @return [Array<String>]
    #
    # @!attribute message_attribute_names
    ...
    #   @return [Array<String>]
    #
    # @!attribute max_number_of_messages
    ...
    #   @return [Integer]
    #
    # @!attribute receive_request_attempt_id
    ...
    #   @return [String]
    #
    ReceiveMessageInput = ::Struct.new(
      :queue_url,
      :attribute_names,
    ...
    #
    ReceiveMessageOutput = ::Struct.new(
      :messages,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #               </code> items.</p>
    #
    #   @return [Array<SendMessageBatchRequestEntry>]
    #
    SendMessageBatchInput = ::Struct.new(
      :queue_url,
      :entries,
      keyword_init: true
    ) do
    ...
    #               </code> items.</p>
    #
    #   @return [Array<SendMessageBatchResultEntry>]
    #
    # @!attribute failed
    #   <p>A list of <code>
    #                  <a>BatchResultErrorEntry</a>
    ...
    #   @return [Array<BatchResultErrorEntry>]
    #
    SendMessageBatchOutput = ::Struct.new(
      :successful,
      :failed,
      keyword_init: true
    ) do
    ...
    #   @return [Hash<String, MessageAttributeValue>]
    #
    # @!attribute message_system_attributes
    ...
    #            </important>
    #
    #   @return [Hash<String, MessageSystemAttributeValue>]
    #
    ...
    #   @return [String]
    #
    SendMessageBatchRequestEntry = ::Struct.new(
      :id,
      :message_body,
      :delay_seconds,
      :message_attributes,
    ...
    #   @return [String]
    #
    # @!attribute md5_of_message_system_attributes
    ...
    #   @return [String]
    #
    SendMessageBatchResultEntry = ::Struct.new(
      :id,
      :message_id,
      :md5_of_message_body,
      :md5_of_message_attributes,
    ...
    #   @return [Hash<String, String>]
    #
    SetQueueAttributesInput = ::Struct.new(
      :queue_url,
      :attributes,
      keyword_init: true
    ) do
    ...
    SetQueueAttributesOutput = ::Struct.new(
      nil,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #
    TooManyEntriesInBatchRequest = ::Struct.new(
      nil,
      keyword_init: true
    ) do
      include Hearth::Structure
