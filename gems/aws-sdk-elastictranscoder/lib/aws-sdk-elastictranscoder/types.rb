...
module AWS::SDK::ElasticTranscoder
  module Types
    ...
    #                   <code>Output</code> syntax. </p>
    #
    #   @return [Array<CreateJobOutput>]
    #
    # @!attribute output_key_prefix
    ...
    #
    #   @return [Array<CreateJobPlaylist>]
    #
    ...
    #   @return [Job]
    #
    CreateJobOperationOutput = ::Struct.new(
      :job,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #   @return [String]
    #
    # @!attribute thumbnail_encryption
    ...
    #   @return [Array<String>]
    #
    # @!attribute hls_content_protection
    ...
    #   @return [String]
    #
    # @!attribute license_acquisition_url
    ...
    #   @return [String]
    #
    HlsContentProtection = ::Struct.new(
      :member_method,
      :key,
      :key_md5,
      :initialization_vector,
    ...
    #   @return [String]
    #
    IncompatibleVersionException = ::Struct.new(
      :message,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #   @return [Encryption]
    #
    # @!attribute applied_color_space_conversion
    ...
    #   @return [String]
    #
    ListJobsByPipelineInput = ::Struct.new(
      :pipeline_id,
      :ascending,
      :page_token,
      keyword_init: true
    ...
    #   @return [String]
    #
    ListJobsByPipelineOutput = ::Struct.new(
      :jobs,
      :next_page_token,
      keyword_init: true
    ) do
    ...
    #   @return [String]
    #
    ListJobsByStatusInput = ::Struct.new(
      :status,
      :ascending,
      :page_token,
      keyword_init: true
    ...
    #   @return [String]
    #
    ListJobsByStatusOutput = ::Struct.new(
      :jobs,
      :next_page_token,
      keyword_init: true
    ) do
    ...
    #
    PipelineOutputConfig = ::Struct.new(
      :bucket,
      :storage_class,
      :permissions,
      keyword_init: true
    ...
    #   @return [Notifications]
    #
    UpdatePipelineNotificationsInput = ::Struct.new(
      :id,
      :notifications,
      keyword_init: true
    ) do
    ...
    #   @return [Pipeline]
    #
    UpdatePipelineNotificationsOutput = ::Struct.new(
      :pipeline,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #   @return [String]
    #
    UpdatePipelineStatusInput = ::Struct.new(
      :id,
      :status,
      keyword_init: true
    ) do
    ...
    #   @return [Pipeline]
    #
    UpdatePipelineStatusOutput = ::Struct.new(
      :pipeline,
      keyword_init: true
    ) do
      include Hearth::Structure
    ...
    #
    #   @return [Array<PresetWatermark>]
    #
    VideoParameters = ::Struct.new(
      :codec,
      :codec_options,
      :keyframes_max_dist,
      :fixed_gop,
