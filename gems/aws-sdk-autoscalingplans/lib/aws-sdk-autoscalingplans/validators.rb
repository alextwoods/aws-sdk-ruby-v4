  ...
  module Validators
    ...
    class ApplicationSource
      def self.validate!(input, context:)
        ...
        TagFilters.validate!(input[:tag_filters], context: "#{context}[:tag_filters]") unless input[:tag_filters].nil?
      end
    end
    ...
    class ApplicationSources
      def self.validate!(input, context:)
        ...
        input.each_with_index do |element, index|
          ApplicationSource.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class CreateScalingPlanInput
      def self.validate!(input, context:)
        ...
        ApplicationSource.validate!(input[:application_source], context: "#{context}[:application_source]") unless input[:application_source].nil?
        ScalingInstructions.validate!(input[:scaling_instructions], context: "#{context}[:scaling_instructions]") unless input[:scaling_instructions].nil?
      end
    end
    ...
    class DescribeScalingPlanResourcesOutput
      def self.validate!(input, context:)
        ...
        ScalingPlanResources.validate!(input[:scaling_plan_resources], context: "#{context}[:scaling_plan_resources]") unless input[:scaling_plan_resources].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class DescribeScalingPlansInput
      def self.validate!(input, context:)
        ...
        ScalingPlanNames.validate!(input[:scaling_plan_names], context: "#{context}[:scaling_plan_names]") unless input[:scaling_plan_names].nil?
        Hearth::Validator.validate!(input[:scaling_plan_version], ::Integer, context: "#{context}[:scaling_plan_version]")
        ApplicationSources.validate!(input[:application_sources], context: "#{context}[:application_sources]") unless input[:application_sources].nil?
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class DescribeScalingPlansOutput
      def self.validate!(input, context:)
        ...
        ScalingPlans.validate!(input[:scaling_plans], context: "#{context}[:scaling_plans]") unless input[:scaling_plans].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ScalingInstruction
      def self.validate!(input, context:)
        ...
        TargetTrackingConfigurations.validate!(input[:target_tracking_configurations], context: "#{context}[:target_tracking_configurations]") unless input[:target_tracking_configurations].nil?
        PredefinedLoadMetricSpecification.validate!(input[:predefined_load_metric_specification], context: "#{context}[:predefined_load_metric_specification]") unless input[:predefined_load_metric_specification].nil?
        CustomizedLoadMetricSpecification.validate!(input[:customized_load_metric_specification], context: "#{context}[:customized_load_metric_specification]") unless input[:customized_load_metric_specification].nil?
    ...
    class ScalingInstructions
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          ScalingInstruction.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ScalingPlanResources
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          ScalingPlanResource.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ScalingPlans
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          ScalingPlan.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class TagFilter
      def self.validate!(input, context:)
        ...
        TagValues.validate!(input[:values], context: "#{context}[:values]") unless input[:values].nil?
      end
    end
    ...
    class TargetTrackingConfiguration
      def self.validate!(input, context:)
        ...
        PredefinedScalingMetricSpecification.validate!(input[:predefined_scaling_metric_specification], context: "#{context}[:predefined_scaling_metric_specification]") unless input[:predefined_scaling_metric_specification].nil?
        CustomizedScalingMetricSpecification.validate!(input[:customized_scaling_metric_specification], context: "#{context}[:customized_scaling_metric_specification]") unless input[:customized_scaling_metric_specification].nil?
    ...
    class TargetTrackingConfigurations
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          TargetTrackingConfiguration.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
