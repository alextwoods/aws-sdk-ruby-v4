  ...
  module Validators
    ...
    class BatchAssociateScramSecretInput
      def self.validate!(input, context:)
        ...
        List____listOf__string.validate!(input[:secret_arn_list], context: "#{context}[:secret_arn_list]") unless input[:secret_arn_list].nil?
      end
    end
    ...
    class BatchAssociateScramSecretOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:cluster_arn], ::String, context: "#{context}[:cluster_arn]")
        List____listOfUnprocessedScramSecret.validate!(input[:unprocessed_scram_secrets], context: "#{context}[:unprocessed_scram_secrets]") unless input[:unprocessed_scram_secrets].nil?
      end
    end
    ...
    class BrokerLogs
      def self.validate!(input, context:)
        ...
        CloudWatchLogs.validate!(input[:cloud_watch_logs], context: "#{context}[:cloud_watch_logs]") unless input[:cloud_watch_logs].nil?
        Firehose.validate!(input[:firehose], context: "#{context}[:firehose]") unless input[:firehose].nil?
        S3.validate!(input[:s3], context: "#{context}[:s3]") unless input[:s3].nil?
      end
    end
    ...
    class BrokerNodeGroupInfo
      def self.validate!(input, context:)
        ...
        List____listOf__string.validate!(input[:client_subnets], context: "#{context}[:client_subnets]") unless input[:client_subnets].nil?
        ...
        StorageInfo.validate!(input[:storage_info], context: "#{context}[:storage_info]") unless input[:storage_info].nil?
        ConnectivityInfo.validate!(input[:connectivity_info], context: "#{context}[:connectivity_info]") unless input[:connectivity_info].nil?
      end
    end
    ...
    class BrokerNodeInfo
      def self.validate!(input, context:)
        ...
        BrokerSoftwareInfo.validate!(input[:current_broker_software_info], context: "#{context}[:current_broker_software_info]") unless input[:current_broker_software_info].nil?
    ...
    class ClientAuthentication
      def self.validate!(input, context:)
        ...
        Sasl.validate!(input[:sasl], context: "#{context}[:sasl]") unless input[:sasl].nil?
        Tls.validate!(input[:tls], context: "#{context}[:tls]") unless input[:tls].nil?
        Unauthenticated.validate!(input[:unauthenticated], context: "#{context}[:unauthenticated]") unless input[:unauthenticated].nil?
      end
    end
    ...
    class Cluster
      def self.validate!(input, context:)
        ...
        StateInfo.validate!(input[:state_info], context: "#{context}[:state_info]") unless input[:state_info].nil?
        Map____mapOf__string.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
        Provisioned.validate!(input[:provisioned], context: "#{context}[:provisioned]") unless input[:provisioned].nil?
        Serverless.validate!(input[:serverless], context: "#{context}[:serverless]") unless input[:serverless].nil?
      end
    end
    ...
    class ClusterInfo
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:active_operation_arn], ::String, context: "#{context}[:active_operation_arn]")
        BrokerNodeGroupInfo.validate!(input[:broker_node_group_info], context: "#{context}[:broker_node_group_info]") unless input[:broker_node_group_info].nil?
        ClientAuthentication.validate!(input[:client_authentication], context: "#{context}[:client_authentication]") unless input[:client_authentication].nil?
        Hearth::Validator.validate!(input[:cluster_arn], ::String, context: "#{context}[:cluster_arn]")
        Hearth::Validator.validate!(input[:cluster_name], ::String, context: "#{context}[:cluster_name]")
        Hearth::Validator.validate!(input[:creation_time], ::Time, context: "#{context}[:creation_time]")
        BrokerSoftwareInfo.validate!(input[:current_broker_software_info], context: "#{context}[:current_broker_software_info]") unless input[:current_broker_software_info].nil?
        Hearth::Validator.validate!(input[:current_version], ::String, context: "#{context}[:current_version]")
        EncryptionInfo.validate!(input[:encryption_info], context: "#{context}[:encryption_info]") unless input[:encryption_info].nil?
        Hearth::Validator.validate!(input[:enhanced_monitoring], ::String, context: "#{context}[:enhanced_monitoring]")
        OpenMonitoring.validate!(input[:open_monitoring], context: "#{context}[:open_monitoring]") unless input[:open_monitoring].nil?
    ...
    class ClusterOperationInfo
      def self.validate!(input, context:)
        ...
        List____listOfClusterOperationStep.validate!(input[:operation_steps], context: "#{context}[:operation_steps]") unless input[:operation_steps].nil?
        Hearth::Validator.validate!(input[:operation_type], ::String, context: "#{context}[:operation_type]")
        MutableClusterInfo.validate!(input[:source_cluster_info], context: "#{context}[:source_cluster_info]") unless input[:source_cluster_info].nil?
        MutableClusterInfo.validate!(input[:target_cluster_info], context: "#{context}[:target_cluster_info]") unless input[:target_cluster_info].nil?
      end
    end
    ...
    class ClusterOperationStep
      def self.validate!(input, context:)
        ...
        ClusterOperationStepInfo.validate!(input[:step_info], context: "#{context}[:step_info]") unless input[:step_info].nil?
    ...
    class CompatibleKafkaVersion
      def self.validate!(input, context:)
        ...
        List____listOf__string.validate!(input[:target_versions], context: "#{context}[:target_versions]") unless input[:target_versions].nil?
      end
    end
    ...
    class Configuration
      def self.validate!(input, context:)
        ...
        List____listOf__string.validate!(input[:kafka_versions], context: "#{context}[:kafka_versions]") unless input[:kafka_versions].nil?
    ...
    class CreateClusterInput
      def self.validate!(input, context:)
        ...
        ClientAuthentication.validate!(input[:client_authentication], context: "#{context}[:client_authentication]") unless input[:client_authentication].nil?
        Hearth::Validator.validate!(input[:cluster_name], ::String, context: "#{context}[:cluster_name]")
        ConfigurationInfo.validate!(input[:configuration_info], context: "#{context}[:configuration_info]") unless input[:configuration_info].nil?
        EncryptionInfo.validate!(input[:encryption_info], context: "#{context}[:encryption_info]") unless input[:encryption_info].nil?
        Hearth::Validator.validate!(input[:enhanced_monitoring], ::String, context: "#{context}[:enhanced_monitoring]")
        OpenMonitoringInfo.validate!(input[:open_monitoring], context: "#{context}[:open_monitoring]") unless input[:open_monitoring].nil?
        Hearth::Validator.validate!(input[:kafka_version], ::String, context: "#{context}[:kafka_version]")
        LoggingInfo.validate!(input[:logging_info], context: "#{context}[:logging_info]") unless input[:logging_info].nil?
        Hearth::Validator.validate!(input[:number_of_broker_nodes], ::Integer, context: "#{context}[:number_of_broker_nodes]")
        Map____mapOf__string.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
    ...
    class CreateClusterV2Input
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:cluster_name], ::String, context: "#{context}[:cluster_name]")
        Map____mapOf__string.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
        ProvisionedRequest.validate!(input[:provisioned], context: "#{context}[:provisioned]") unless input[:provisioned].nil?
        ServerlessRequest.validate!(input[:serverless], context: "#{context}[:serverless]") unless input[:serverless].nil?
      end
    end
    ...
    class DescribeClusterOperationOutput
      def self.validate!(input, context:)
        ...
        ClusterOperationInfo.validate!(input[:cluster_operation_info], context: "#{context}[:cluster_operation_info]") unless input[:cluster_operation_info].nil?
      end
    end
    ...
    class DescribeClusterOutput
      def self.validate!(input, context:)
        ...
        ClusterInfo.validate!(input[:cluster_info], context: "#{context}[:cluster_info]") unless input[:cluster_info].nil?
      end
    end
    ...
    class DescribeClusterV2Output
      def self.validate!(input, context:)
        ...
        Cluster.validate!(input[:cluster_info], context: "#{context}[:cluster_info]") unless input[:cluster_info].nil?
      end
    end
    ...
    class EncryptionInfo
      def self.validate!(input, context:)
        ...
        EncryptionInTransit.validate!(input[:encryption_in_transit], context: "#{context}[:encryption_in_transit]") unless input[:encryption_in_transit].nil?
      end
    end
    ...
    class GetCompatibleKafkaVersionsOutput
      def self.validate!(input, context:)
        ...
        List____listOfCompatibleKafkaVersion.validate!(input[:compatible_kafka_versions], context: "#{context}[:compatible_kafka_versions]") unless input[:compatible_kafka_versions].nil?
      end
    end
    ...
    class ListClusterOperationsOutput
      def self.validate!(input, context:)
        ...
        List____listOfClusterOperationInfo.validate!(input[:cluster_operation_info_list], context: "#{context}[:cluster_operation_info_list]") unless input[:cluster_operation_info_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListClustersOutput
      def self.validate!(input, context:)
        ...
        List____listOfClusterInfo.validate!(input[:cluster_info_list], context: "#{context}[:cluster_info_list]") unless input[:cluster_info_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListClustersV2Output
      def self.validate!(input, context:)
        ...
        List____listOfCluster.validate!(input[:cluster_info_list], context: "#{context}[:cluster_info_list]") unless input[:cluster_info_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListKafkaVersionsOutput
      def self.validate!(input, context:)
        ...
        List____listOfKafkaVersion.validate!(input[:kafka_versions], context: "#{context}[:kafka_versions]") unless input[:kafka_versions].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListNodesOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        List____listOfNodeInfo.validate!(input[:node_info_list], context: "#{context}[:node_info_list]") unless input[:node_info_list].nil?
      end
    end
    ...
    class LoggingInfo
      def self.validate!(input, context:)
        ...
        BrokerLogs.validate!(input[:broker_logs], context: "#{context}[:broker_logs]") unless input[:broker_logs].nil?
      end
    end
    ...
    class MutableClusterInfo
      def self.validate!(input, context:)
        ...
        List____listOfBrokerEBSVolumeInfo.validate!(input[:broker_ebs_volume_info], context: "#{context}[:broker_ebs_volume_info]") unless input[:broker_ebs_volume_info].nil?
        ConfigurationInfo.validate!(input[:configuration_info], context: "#{context}[:configuration_info]") unless input[:configuration_info].nil?
        Hearth::Validator.validate!(input[:number_of_broker_nodes], ::Integer, context: "#{context}[:number_of_broker_nodes]")
        Hearth::Validator.validate!(input[:enhanced_monitoring], ::String, context: "#{context}[:enhanced_monitoring]")
        OpenMonitoring.validate!(input[:open_monitoring], context: "#{context}[:open_monitoring]") unless input[:open_monitoring].nil?
    ...
    class NodeInfo
      def self.validate!(input, context:)
        ...
        BrokerNodeInfo.validate!(input[:broker_node_info], context: "#{context}[:broker_node_info]") unless input[:broker_node_info].nil?
        Hearth::Validator.validate!(input[:instance_type], ::String, context: "#{context}[:instance_type]")
        ...
        ZookeeperNodeInfo.validate!(input[:zookeeper_node_info], context: "#{context}[:zookeeper_node_info]") unless input[:zookeeper_node_info].nil?
      end
    end
    ...
    class OpenMonitoring
      def self.validate!(input, context:)
        ...
        Prometheus.validate!(input[:prometheus], context: "#{context}[:prometheus]") unless input[:prometheus].nil?
      end
    end
    ...
    class OpenMonitoringInfo
      def self.validate!(input, context:)
        ...
        PrometheusInfo.validate!(input[:prometheus], context: "#{context}[:prometheus]") unless input[:prometheus].nil?
      end
    end
    ...
    class Prometheus
      def self.validate!(input, context:)
        ...
        JmxExporter.validate!(input[:jmx_exporter], context: "#{context}[:jmx_exporter]") unless input[:jmx_exporter].nil?
        NodeExporter.validate!(input[:node_exporter], context: "#{context}[:node_exporter]") unless input[:node_exporter].nil?
      end
    end
    ...
    class PrometheusInfo
      def self.validate!(input, context:)
        ...
        JmxExporterInfo.validate!(input[:jmx_exporter], context: "#{context}[:jmx_exporter]") unless input[:jmx_exporter].nil?
        NodeExporterInfo.validate!(input[:node_exporter], context: "#{context}[:node_exporter]") unless input[:node_exporter].nil?
      end
    end
    ...
    class RebootBrokerInput
      def self.validate!(input, context:)
        ...
        List____listOf__string.validate!(input[:broker_ids], context: "#{context}[:broker_ids]") unless input[:broker_ids].nil?
        Hearth::Validator.validate!(input[:cluster_arn], ::String, context: "#{context}[:cluster_arn]")
      end
    end
    ...
    class Sasl
      def self.validate!(input, context:)
        ...
        Scram.validate!(input[:scram], context: "#{context}[:scram]") unless input[:scram].nil?
        Iam.validate!(input[:iam], context: "#{context}[:iam]") unless input[:iam].nil?
      end
    end
    ...
    class Serverless
      def self.validate!(input, context:)
        ...
        List____listOfVpcConfig.validate!(input[:vpc_configs], context: "#{context}[:vpc_configs]") unless input[:vpc_configs].nil?
        ServerlessClientAuthentication.validate!(input[:client_authentication], context: "#{context}[:client_authentication]") unless input[:client_authentication].nil?
      end
    end
    ...
    class ServerlessClientAuthentication
      def self.validate!(input, context:)
        ...
        ServerlessSasl.validate!(input[:sasl], context: "#{context}[:sasl]") unless input[:sasl].nil?
      end
    end
    ...
    class StorageInfo
      def self.validate!(input, context:)
        ...
        EBSStorageInfo.validate!(input[:ebs_storage_info], context: "#{context}[:ebs_storage_info]") unless input[:ebs_storage_info].nil?
      end
    end
    ...
    class Tls
      def self.validate!(input, context:)
        ...
        List____listOf__string.validate!(input[:certificate_authority_arn_list], context: "#{context}[:certificate_authority_arn_list]") unless input[:certificate_authority_arn_list].nil?
        Hearth::Validator.validate!(input[:enabled], ::TrueClass, ::FalseClass, context: "#{context}[:enabled]")
      end
    end
    ...
    class UpdateBrokerStorageInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:cluster_arn], ::String, context: "#{context}[:cluster_arn]")
        Hearth::Validator.validate!(input[:current_version], ::String, context: "#{context}[:current_version]")
        List____listOfBrokerEBSVolumeInfo.validate!(input[:target_broker_ebs_volume_info], context: "#{context}[:target_broker_ebs_volume_info]") unless input[:target_broker_ebs_volume_info].nil?
      end
    end
    ...
    class List____listOfBrokerEBSVolumeInfo
      def self.validate!(input, context:)
        ...
        input.each_with_index do |element, index|
          BrokerEBSVolumeInfo.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfClusterInfo
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          ClusterInfo.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfClusterOperationInfo
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          ClusterOperationInfo.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfClusterOperationStep
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          ClusterOperationStep.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfCompatibleKafkaVersion
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          CompatibleKafkaVersion.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfKafkaVersion
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          KafkaVersion.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfNodeInfo
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          NodeInfo.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfUnprocessedScramSecret
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          UnprocessedScramSecret.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class List____listOfVpcConfig
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          VpcConfig.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
