    ...
    class AnalyticsFilter
      def self.validate!(input, context:)
        ...
        when Types::AnalyticsFilter::And
          ...
          raise ArgumentError, "Expected #{context} to be a union member of Types::AnalyticsFilter, got #{input.class}."
        end
      end
    ...
    class LifecycleRuleFilter
      def self.validate!(input, context:)
        ...
        when Types::LifecycleRuleFilter::And
          ...
          raise ArgumentError, "Expected #{context} to be a union member of Types::LifecycleRuleFilter, got #{input.class}."
        end
      end
    ...
    class MetricsFilter
      def self.validate!(input, context:)
        ...
        when Types::MetricsFilter::And
          ...
          raise ArgumentError, "Expected #{context} to be a union member of Types::MetricsFilter, got #{input.class}."
        end
      end
    ...
    class ReplicationRuleFilter
      def self.validate!(input, context:)
        ...
        when Types::ReplicationRuleFilter::And
          ...
          raise ArgumentError, "Expected #{context} to be a union member of Types::ReplicationRuleFilter, got #{input.class}."
        end
      end
    ...
    class SelectObjectContentEventStream
      def self.validate!(input, context:)
        ...
        when Types::SelectObjectContentEventStream::End
          ...
          raise ArgumentError, "Expected #{context} to be a union member of Types::SelectObjectContentEventStream, got #{input.class}."
        end
      end
