...
module AWS::SDK::RoboMaker
  module Errors
    ...
    class ConcurrentDeploymentException < ApiClientError
      def initialize(http_resp:, **kwargs)
        @data = Parsers::ConcurrentDeploymentException.parse(http_resp)
        kwargs[:message] = @data.message if @data.respond_to?(:message)

        super(http_resp: http_resp, **kwargs)
      end

      # @return [Types::ConcurrentDeploymentException]
      #
      attr_reader :data
    end
