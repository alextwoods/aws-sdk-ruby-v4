...
module AWS::SDK::Lambda
  ...
  module Parsers
    ...
    class AmazonManagedKafkaEventSourceConfig
      def self.parse(map)
        data = Types::AmazonManagedKafkaEventSourceConfig.new
        data.consumer_group_id = map['ConsumerGroupId']
        return data
      end
    end
    ...
    class DocumentDBEventSourceConfig
      def self.parse(map)
        data = Types::DocumentDBEventSourceConfig.new
        data.database_name = map['DatabaseName']
        data.collection_name = map['CollectionName']
        data.full_document = map['FullDocument']
        return data
      end
    end
    ...
    # Operation Parser for GetRuntimeManagementConfig
    class GetRuntimeManagementConfig
      def self.parse(http_resp)
        data = Types::GetRuntimeManagementConfigOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data.update_runtime_on = map['UpdateRuntimeOn']
    ...
    # Operation Parser for PutRuntimeManagementConfig
    class PutRuntimeManagementConfig
      def self.parse(http_resp)
        data = Types::PutRuntimeManagementConfigOutput.new
        map = Hearth::JSON.load(http_resp.body)
        data.update_runtime_on = map['UpdateRuntimeOn']
        data.function_arn = map['FunctionArn']
        data.runtime_version_arn = map['RuntimeVersionArn']
    ...
    class RuntimeVersionError
      def self.parse(map)
        data = Types::RuntimeVersionError.new
        data.error_code = map['ErrorCode']
        data.message = map['Message']
        return data
      end
    ...
    class ScalingConfig
      def self.parse(map)
        data = Types::ScalingConfig.new
        data.maximum_concurrency = map['MaximumConcurrency']
        return data
      end
    end
    ...
    class SelfManagedKafkaEventSourceConfig
      def self.parse(map)
        data = Types::SelfManagedKafkaEventSourceConfig.new
        data.consumer_group_id = map['ConsumerGroupId']
        return data
      end
    end
    ...
    # Error Parser for SnapStartException
    class SnapStartException
      def self.parse(http_resp)
        data = Types::SnapStartException.new
        map = Hearth::JSON.load(http_resp.body)
        data.type = map['Type']
        data.message = map['Message']
        data
    ...
    # Error Parser for SnapStartNotReadyException
    class SnapStartNotReadyException
      def self.parse(http_resp)
        data = Types::SnapStartNotReadyException.new
        map = Hearth::JSON.load(http_resp.body)
        data.type = map['Type']
        data.message = map['Message']
        data
    ...
    class SnapStartResponse
      def self.parse(map)
        data = Types::SnapStartResponse.new
        data.apply_on = map['ApplyOn']
        data.optimization_status = map['OptimizationStatus']
        return data
      end
    end

    # Error Parser for SnapStartTimeoutException
    class SnapStartTimeoutException
      def self.parse(http_resp)
        data = Types::SnapStartTimeoutException.new
        map = Hearth::JSON.load(http_resp.body)
        data.type = map['Type']
        data.message = map['Message']
        data
