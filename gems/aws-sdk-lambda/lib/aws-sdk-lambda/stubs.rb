...
module AWS::SDK::Lambda
  ...
  module Stubs
    ...
    # Structure Stubber for AmazonManagedKafkaEventSourceConfig
    class AmazonManagedKafkaEventSourceConfig
      def self.default(visited=[])
        return nil if visited.include?('AmazonManagedKafkaEventSourceConfig')
        visited = visited + ['AmazonManagedKafkaEventSourceConfig']
        {
      ...
      def self.stub(stub)
        stub ||= Types::AmazonManagedKafkaEventSourceConfig.new
        data = {}
        data['ConsumerGroupId'] = stub[:consumer_group_id] unless stub[:consumer_group_id].nil?
        data
      end
    end
      ...
      def self.default(visited=[])
        {
          ...
          amazon_managed_kafka_event_source_config: AmazonManagedKafkaEventSourceConfig.default(visited),
          self_managed_kafka_event_source_config: SelfManagedKafkaEventSourceConfig.default(visited),
          scaling_config: ScalingConfig.default(visited),
          document_db_event_source_config: DocumentDBEventSourceConfig.default(visited),
        }
      end
      ...
      def self.default(visited=[])
        {
          ...
          snap_start: SnapStartResponse.default(visited),
          runtime_version_config: RuntimeVersionConfig.default(visited),
        }
      end
    ...
    # Structure Stubber for DocumentDBEventSourceConfig
    class DocumentDBEventSourceConfig
      def self.default(visited=[])
        return nil if visited.include?('DocumentDBEventSourceConfig')
        visited = visited + ['DocumentDBEventSourceConfig']
        {
      ...
      def self.stub(stub)
        stub ||= Types::DocumentDBEventSourceConfig.new
        data = {}
        ...
        data['FullDocument'] = stub[:full_document] unless stub[:full_document].nil?
        data
      end
    end
    ...
    # Operation Stubber for GetRuntimeManagementConfig
    class GetRuntimeManagementConfig
      ...
      def self.stub(http_resp, stub:)
        ...
        http_resp.status = 200
        http_resp.headers['Content-Type'] = 'application/json'
        data['UpdateRuntimeOn'] = stub[:update_runtime_on] unless stub[:update_runtime_on].nil?
    ...
    # Structure Stubber for InvokeResponseStreamUpdate
    class InvokeResponseStreamUpdate
      def self.default(visited=[])
        return nil if visited.include?('InvokeResponseStreamUpdate')
        visited = visited + ['InvokeResponseStreamUpdate']
        {
          payload: 'payload',
        }
      end
      ...
      def self.stub(stub)
        stub ||= Types::InvokeResponseStreamUpdate.new
        data = {}
    ...
    # Operation Stubber for InvokeWithResponseStream
    class InvokeWithResponseStream
      def self.default(visited=[])
        {
          status_code: 1,
          executed_version: 'executed_version',
          event_stream: InvokeWithResponseStreamResponseEvent.default(visited),
          response_stream_content_type: 'response_stream_content_type',
        }
      end
      ...
      def self.stub(http_resp, stub:)
        ...
        http_resp.status = 200
        http_resp.headers['X-Amz-Executed-Version'] = stub[:executed_version] unless stub[:executed_version].nil? || stub[:executed_version].empty?
        http_resp.headers['Content-Type'] = stub[:response_stream_content_type] unless stub[:response_stream_content_type].nil? || stub[:response_stream_content_type].empty?
        http_resp.status = stub[:status_code]
        IO.copy_stream(stub[:event_stream], http_resp.body)
      end
    end

    # Structure Stubber for InvokeWithResponseStreamCompleteEvent
    class InvokeWithResponseStreamCompleteEvent
      def self.default(visited=[])
        return nil if visited.include?('InvokeWithResponseStreamCompleteEvent')
        visited = visited + ['InvokeWithResponseStreamCompleteEvent']
        {
          error_code: 'error_code',
      ...
      def self.stub(stub)
        stub ||= Types::InvokeWithResponseStreamCompleteEvent.new
        data = {}
        data['ErrorCode'] = stub[:error_code] unless stub[:error_code].nil?
    ...
    # Union Stubber for InvokeWithResponseStreamResponseEvent
    class InvokeWithResponseStreamResponseEvent
      def self.default(visited=[])
        return nil if visited.include?('InvokeWithResponseStreamResponseEvent')
        visited = visited + ['InvokeWithResponseStreamResponseEvent']
        {
          payload_chunk: InvokeResponseStreamUpdate.default(visited),
        }
      end
    ...
    # Operation Stubber for PutRuntimeManagementConfig
    ...
    # Structure Stubber for RuntimeVersionConfig
    class RuntimeVersionConfig
      def self.default(visited=[])
        return nil if visited.include?('RuntimeVersionConfig')
        visited = visited + ['RuntimeVersionConfig']
        {
          runtime_version_arn: 'runtime_version_arn',
          error: RuntimeVersionError.default(visited),
        }
      end
    ...
    # Structure Stubber for RuntimeVersionError
    class RuntimeVersionError
      def self.default(visited=[])
        return nil if visited.include?('RuntimeVersionError')
        visited = visited + ['RuntimeVersionError']
        {
          error_code: 'error_code',
          message: 'message',
        }
      ...
      def self.stub(stub)
        stub ||= Types::RuntimeVersionError.new
        data = {}
        data['ErrorCode'] = stub[:error_code] unless stub[:error_code].nil?
        data['Message'] = stub[:message] unless stub[:message].nil?
        data
    ...
    # Structure Stubber for ScalingConfig
    class ScalingConfig
      def self.default(visited=[])
        return nil if visited.include?('ScalingConfig')
        visited = visited + ['ScalingConfig']
        {
      ...
      def self.stub(stub)
        stub ||= Types::ScalingConfig.new
        data = {}
        data['MaximumConcurrency'] = stub[:maximum_concurrency] unless stub[:maximum_concurrency].nil?
        data
      end
    end
    ...
    # Structure Stubber for SelfManagedKafkaEventSourceConfig
    class SelfManagedKafkaEventSourceConfig
      def self.default(visited=[])
        return nil if visited.include?('SelfManagedKafkaEventSourceConfig')
        visited = visited + ['SelfManagedKafkaEventSourceConfig']
        {
          consumer_group_id: 'consumer_group_id',
        }
      end
      ...
      def self.stub(stub)
        stub ||= Types::SelfManagedKafkaEventSourceConfig.new
        data = {}
        data['ConsumerGroupId'] = stub[:consumer_group_id] unless stub[:consumer_group_id].nil?
        data
      end
    ...
    # Structure Stubber for SnapStartResponse
    class SnapStartResponse
      def self.default(visited=[])
        return nil if visited.include?('SnapStartResponse')
        visited = visited + ['SnapStartResponse']
        {
          apply_on: 'apply_on',
      ...
      def self.stub(stub)
        stub ||= Types::SnapStartResponse.new
        data = {}
        data['ApplyOn'] = stub[:apply_on] unless stub[:apply_on].nil?
        data['OptimizationStatus'] = stub[:optimization_status] unless stub[:optimization_status].nil?
        data
      end
    end
