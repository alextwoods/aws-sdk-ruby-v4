...
module AWS::SDK::EventBridge
  module Types
    ...
    #
    #   Enum, one of: ["ACTIVE", "CREATING", "UPDATING", "DELETING", "CREATE_FAILED", "UPDATE_FAILED", "DELETE_FAILED"]
    #
    #   @return [String]
    #
    ...
    # Includes enum constants for ReplicationState
    #
