  ...
  module Builders
    ...
    class CreateEndpoint
      def self.build(http_req, input:)
        ...
        http_req.append_path('/')
        http_req.headers['Content-Type'] = 'application/x-amz-json-1.1'
        http_req.headers['X-Amz-Target'] = 'AWSEvents.CreateEndpoint'
        data = {}
        data['Name'] = input[:name] unless input[:name].nil?
        data['Description'] = input[:description] unless input[:description].nil?
    ...
    # List Builder for EndpointEventBusList
    ...
    # Structure Builder for EndpointEventBus
    class EndpointEventBus
      def self.build(input)
        data = {}
        data['EventBusArn'] = input[:event_bus_arn] unless input[:event_bus_arn].nil?
        data
      end
    end

    # Structure Builder for ReplicationConfig
    ...
    # Structure Builder for RoutingConfig
    class RoutingConfig
      def self.build(input)
        data = {}
    ...
    # Structure Builder for Secondary
    class Secondary
      def self.build(input)
        data = {}
        data['Route'] = input[:route] unless input[:route].nil?
        data
      end
    end

    # Structure Builder for Primary
    class Primary
      def self.build(input)
        data = {}
    ...
    class DescribeEndpoint
      def self.build(http_req, input:)
        ...
        http_req.append_path('/')
        http_req.headers['Content-Type'] = 'application/x-amz-json-1.1'
        http_req.headers['X-Amz-Target'] = 'AWSEvents.DescribeEndpoint'
        data = {}
        data['Name'] = input[:name] unless input[:name].nil?
    ...
    class ListEndpoints
      def self.build(http_req, input:)
        ...
        http_req.append_path('/')
        http_req.headers['Content-Type'] = 'application/x-amz-json-1.1'
        http_req.headers['X-Amz-Target'] = 'AWSEvents.ListEndpoints'
        data = {}
        data['NamePrefix'] = input[:name_prefix] unless input[:name_prefix].nil?
        data['HomeRegion'] = input[:home_region] unless input[:home_region].nil?
        data['NextToken'] = input[:next_token] unless input[:next_token].nil?
    ...
    class UpdateEndpoint
      def self.build(http_req, input:)
        ...
        http_req.append_path('/')
        http_req.headers['Content-Type'] = 'application/x-amz-json-1.1'
        http_req.headers['X-Amz-Target'] = 'AWSEvents.UpdateEndpoint'
        data = {}
        data['Name'] = input[:name] unless input[:name].nil?
        data['Description'] = input[:description] unless input[:description].nil?
        data['RoutingConfig'] = RoutingConfig.build(input[:routing_config]) unless input[:routing_config].nil?
