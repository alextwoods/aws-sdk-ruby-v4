  ...
  module Params
    ...
    module CreateEndpointInput
      def self.build(params, context: '')
        ...
        type.name = params[:name]
        type.description = params[:description]
        type.routing_config = RoutingConfig.build(params[:routing_config], context: "#{context}[:routing_config]") unless params[:routing_config].nil?
        type.replication_config = ReplicationConfig.build(params[:replication_config], context: "#{context}[:replication_config]") unless params[:replication_config].nil?
        type.event_buses = EndpointEventBusList.build(params[:event_buses], context: "#{context}[:event_buses]") unless params[:event_buses].nil?
    ...
    module EndpointEventBus
      def self.build(params, context: '')
        Hearth::Validator.validate!(params, ::Hash, Types::EndpointEventBus, context: context)
        type = Types::EndpointEventBus.new
        type.event_bus_arn = params[:event_bus_arn]
        type
      end
    end
    ...
    module EndpointEventBusList
      def self.build(params, context: '')
        ...
        data = []
        params.each_with_index do |element, index|
          data << EndpointEventBus.build(element, context: "#{context}[#{index}]") unless element.nil?
        end
        data
      end
    end
    ...
    module FailoverConfig
      def self.build(params, context: '')
        ...
        type.primary = Primary.build(params[:primary], context: "#{context}[:primary]") unless params[:primary].nil?
        type.secondary = Secondary.build(params[:secondary], context: "#{context}[:secondary]") unless params[:secondary].nil?
        type
      end
    end
    ...
    module Primary
      def self.build(params, context: '')
        Hearth::Validator.validate!(params, ::Hash, Types::Primary, context: context)
        type = Types::Primary.new
    ...
    module ReplicationConfig
      def self.build(params, context: '')
        Hearth::Validator.validate!(params, ::Hash, Types::ReplicationConfig, context: context)
        type = Types::ReplicationConfig.new
        type.state = params[:state]
        type
      end
    end
    ...
    module RoutingConfig
      def self.build(params, context: '')
        Hearth::Validator.validate!(params, ::Hash, Types::RoutingConfig, context: context)
        type = Types::RoutingConfig.new
        type.failover_config = FailoverConfig.build(params[:failover_config], context: "#{context}[:failover_config]") unless params[:failover_config].nil?
        type
      end
    end
    ...
    module Secondary
      def self.build(params, context: '')
        Hearth::Validator.validate!(params, ::Hash, Types::Secondary, context: context)
        type = Types::Secondary.new
