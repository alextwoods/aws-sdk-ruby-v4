  ...
  module Validators
    ...
    class DescribeDimensionKeysInput
      def self.validate!(input, context:)
        ...
        DimensionGroup.validate!(input[:group_by], context: "#{context}[:group_by]") unless input[:group_by].nil?
        AdditionalMetricsList.validate!(input[:additional_metrics], context: "#{context}[:additional_metrics]") unless input[:additional_metrics].nil?
        DimensionGroup.validate!(input[:partition_by], context: "#{context}[:partition_by]") unless input[:partition_by].nil?
        MetricQueryFilterMap.validate!(input[:filter], context: "#{context}[:filter]") unless input[:filter].nil?
    ...
    class DescribeDimensionKeysOutput
      def self.validate!(input, context:)
        ...
        ResponsePartitionKeyList.validate!(input[:partition_keys], context: "#{context}[:partition_keys]") unless input[:partition_keys].nil?
        DimensionKeyDescriptionList.validate!(input[:keys], context: "#{context}[:keys]") unless input[:keys].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class DimensionDetailList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          DimensionDetail.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class DimensionGroup
      def self.validate!(input, context:)
        ...
        RequestStringList.validate!(input[:dimensions], context: "#{context}[:dimensions]") unless input[:dimensions].nil?
    ...
    class DimensionGroupDetail
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:group], ::String, context: "#{context}[:group]")
        DimensionDetailList.validate!(input[:dimensions], context: "#{context}[:dimensions]") unless input[:dimensions].nil?
      end
    end
    ...
    class DimensionGroupDetailList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          DimensionGroupDetail.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class DimensionKeyDescription
      def self.validate!(input, context:)
        ...
        DimensionMap.validate!(input[:dimensions], context: "#{context}[:dimensions]") unless input[:dimensions].nil?
        Hearth::Validator.validate!(input[:total], ::Float, context: "#{context}[:total]")
        AdditionalMetricsMap.validate!(input[:additional_metrics], context: "#{context}[:additional_metrics]") unless input[:additional_metrics].nil?
        MetricValuesList.validate!(input[:partitions], context: "#{context}[:partitions]") unless input[:partitions].nil?
      end
    end
    ...
    class DimensionKeyDescriptionList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          DimensionKeyDescription.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class DimensionKeyDetailList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          DimensionKeyDetail.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class FeatureMetadataMap
      def self.validate!(input, context:)
        ...
        input.each do |key, value|
          Hearth::Validator.validate!(key, ::String, ::Symbol, context: "#{context}.keys")
          FeatureMetadata.validate!(value, context: "#{context}[:#{key}]") unless value.nil?
        end
      end
    end
    ...
    class GetDimensionKeyDetailsInput
      def self.validate!(input, context:)
        ...
        RequestedDimensionList.validate!(input[:requested_dimensions], context: "#{context}[:requested_dimensions]") unless input[:requested_dimensions].nil?
      end
    end
    ...
    class GetDimensionKeyDetailsOutput
      def self.validate!(input, context:)
        ...
        DimensionKeyDetailList.validate!(input[:dimensions], context: "#{context}[:dimensions]") unless input[:dimensions].nil?
      end
    end
    ...
    class GetResourceMetadataOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:identifier], ::String, context: "#{context}[:identifier]")
        FeatureMetadataMap.validate!(input[:features], context: "#{context}[:features]") unless input[:features].nil?
      end
    end
    ...
    class GetResourceMetricsInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:service_type], ::String, context: "#{context}[:service_type]")
        Hearth::Validator.validate!(input[:identifier], ::String, context: "#{context}[:identifier]")
        MetricQueryList.validate!(input[:metric_queries], context: "#{context}[:metric_queries]") unless input[:metric_queries].nil?
        Hearth::Validator.validate!(input[:start_time], ::Time, context: "#{context}[:start_time]")
        Hearth::Validator.validate!(input[:end_time], ::Time, context: "#{context}[:end_time]")
        Hearth::Validator.validate!(input[:period_in_seconds], ::Integer, context: "#{context}[:period_in_seconds]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
    ...
    class GetResourceMetricsOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:aligned_end_time], ::Time, context: "#{context}[:aligned_end_time]")
        Hearth::Validator.validate!(input[:identifier], ::String, context: "#{context}[:identifier]")
        MetricKeyDataPointsList.validate!(input[:metric_list], context: "#{context}[:metric_list]") unless input[:metric_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListAvailableResourceDimensionsInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:service_type], ::String, context: "#{context}[:service_type]")
        Hearth::Validator.validate!(input[:identifier], ::String, context: "#{context}[:identifier]")
        DimensionsMetricList.validate!(input[:metrics], context: "#{context}[:metrics]") unless input[:metrics].nil?
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListAvailableResourceDimensionsOutput
      def self.validate!(input, context:)
        ...
        MetricDimensionsList.validate!(input[:metric_dimensions], context: "#{context}[:metric_dimensions]") unless input[:metric_dimensions].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListAvailableResourceMetricsInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:service_type], ::String, context: "#{context}[:service_type]")
        Hearth::Validator.validate!(input[:identifier], ::String, context: "#{context}[:identifier]")
        MetricTypeList.validate!(input[:metric_types], context: "#{context}[:metric_types]") unless input[:metric_types].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    end
    ...
    class ListAvailableResourceMetricsOutput
      def self.validate!(input, context:)
        ...
        ResponseResourceMetricList.validate!(input[:metrics], context: "#{context}[:metrics]") unless input[:metrics].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class MetricDimensionGroups
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:metric], ::String, context: "#{context}[:metric]")
        DimensionGroupDetailList.validate!(input[:groups], context: "#{context}[:groups]") unless input[:groups].nil?
      end
    end
    ...
    class MetricDimensionsList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          MetricDimensionGroups.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class MetricKeyDataPoints
      def self.validate!(input, context:)
        ...
        ResponseResourceMetricKey.validate!(input[:key], context: "#{context}[:key]") unless input[:key].nil?
        DataPointsList.validate!(input[:data_points], context: "#{context}[:data_points]") unless input[:data_points].nil?
      end
    end
    ...
    class MetricKeyDataPointsList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          MetricKeyDataPoints.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class MetricQueryList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          MetricQuery.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ResponsePartitionKeyList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          ResponsePartitionKey.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ResponseResourceMetricList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          ResponseResourceMetric.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
