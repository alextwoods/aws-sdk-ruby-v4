  ...
  module Builders
    ...
    class CreateDomain
      def self.build(http_req, input:)
        ...
        data['ClusterConfig'] = Builders::ClusterConfig.build(input[:cluster_config]) unless input[:cluster_config].nil?
    ...
    class CreateOutboundConnection
      def self.build(http_req, input:)
        ...
        http_req.headers['Content-Type'] = 'application/json'
        data = {}
        data['LocalDomainInfo'] = Builders::DomainInformationContainer.build(input[:local_domain_info]) unless input[:local_domain_info].nil?
        data['RemoteDomainInfo'] = Builders::DomainInformationContainer.build(input[:remote_domain_info]) unless input[:remote_domain_info].nil?
    ...
    class DomainInformationContainer
      def self.build(input)
        data = {}
        data['AWSDomainInformation'] = Builders::AWSDomainInformation.build(input[:aws_domain_information]) unless input[:aws_domain_information].nil?
        data
      end
    end
