  ...
  module Validators
    ...
    class AugmentedManifestsListItem
      def self.validate!(input, context:)
        ...
        Validators::AttributeNamesList.validate!(input[:attribute_names], context: "#{context}[:attribute_names]") unless input[:attribute_names].nil?
    ...
    class BatchDetectDominantLanguageInput
      def self.validate!(input, context:)
        ...
        Validators::CustomerInputStringList.validate!(input[:text_list], context: "#{context}[:text_list]") unless input[:text_list].nil?
      end
    end
    ...
    class BatchDetectDominantLanguageItemResult
      def self.validate!(input, context:)
        ...
        Validators::ListOfDominantLanguages.validate!(input[:languages], context: "#{context}[:languages]") unless input[:languages].nil?
      end
    end
    ...
    class BatchDetectDominantLanguageOutput
      def self.validate!(input, context:)
        ...
        Validators::ListOfDetectDominantLanguageResult.validate!(input[:result_list], context: "#{context}[:result_list]") unless input[:result_list].nil?
        Validators::BatchItemErrorList.validate!(input[:error_list], context: "#{context}[:error_list]") unless input[:error_list].nil?
      end
    end
    ...
    class BatchDetectEntitiesOutput
      def self.validate!(input, context:)
        ...
        Validators::ListOfDetectEntitiesResult.validate!(input[:result_list], context: "#{context}[:result_list]") unless input[:result_list].nil?
        Validators::BatchItemErrorList.validate!(input[:error_list], context: "#{context}[:error_list]") unless input[:error_list].nil?
      end
    end
    ...
    class BatchDetectKeyPhrasesItemResult
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:index], ::Integer, context: "#{context}[:index]")
        Validators::ListOfKeyPhrases.validate!(input[:key_phrases], context: "#{context}[:key_phrases]") unless input[:key_phrases].nil?
      end
    end
    ...
    class BatchDetectKeyPhrasesOutput
      def self.validate!(input, context:)
        ...
        Validators::ListOfDetectKeyPhrasesResult.validate!(input[:result_list], context: "#{context}[:result_list]") unless input[:result_list].nil?
        Validators::BatchItemErrorList.validate!(input[:error_list], context: "#{context}[:error_list]") unless input[:error_list].nil?
      end
    end
    ...
    class BatchDetectSentimentOutput
      def self.validate!(input, context:)
        ...
        Validators::ListOfDetectSentimentResult.validate!(input[:result_list], context: "#{context}[:result_list]") unless input[:result_list].nil?
        Validators::BatchItemErrorList.validate!(input[:error_list], context: "#{context}[:error_list]") unless input[:error_list].nil?
      end
    end
    ...
    class BatchDetectSyntaxItemResult
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:index], ::Integer, context: "#{context}[:index]")
        Validators::ListOfSyntaxTokens.validate!(input[:syntax_tokens], context: "#{context}[:syntax_tokens]") unless input[:syntax_tokens].nil?
      end
    end
    ...
    class BatchDetectSyntaxOutput
      def self.validate!(input, context:)
        ...
        Validators::ListOfDetectSyntaxResult.validate!(input[:result_list], context: "#{context}[:result_list]") unless input[:result_list].nil?
        Validators::BatchItemErrorList.validate!(input[:error_list], context: "#{context}[:error_list]") unless input[:error_list].nil?
      end
    end
    ...
    class BatchItemErrorList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::BatchItemError.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ClassifierMetadata
      def self.validate!(input, context:)
        ...
        Validators::ClassifierEvaluationMetrics.validate!(input[:evaluation_metrics], context: "#{context}[:evaluation_metrics]") unless input[:evaluation_metrics].nil?
      end
    end
    ...
    class ClassifyDocumentOutput
      def self.validate!(input, context:)
        ...
        Validators::ListOfClasses.validate!(input[:classes], context: "#{context}[:classes]") unless input[:classes].nil?
        Validators::ListOfLabels.validate!(input[:labels], context: "#{context}[:labels]") unless input[:labels].nil?
      end
    end
    ...
    class ContainsPiiEntitiesOutput
      def self.validate!(input, context:)
        ...
        Validators::ListOfEntityLabels.validate!(input[:labels], context: "#{context}[:labels]") unless input[:labels].nil?
      end
    end
    ...
    class CreateDocumentClassifierInput
      def self.validate!(input, context:)
        ...
        Validators::DocumentClassifierInputDataConfig.validate!(input[:input_data_config], context: "#{context}[:input_data_config]") unless input[:input_data_config].nil?
        Validators::DocumentClassifierOutputDataConfig.validate!(input[:output_data_config], context: "#{context}[:output_data_config]") unless input[:output_data_config].nil?
    ...
    class CreateEntityRecognizerInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:data_access_role_arn], ::String, context: "#{context}[:data_access_role_arn]")
        Validators::TagList.validate!(input[:tags], context: "#{context}[:tags]") unless input[:tags].nil?
        Validators::EntityRecognizerInputDataConfig.validate!(input[:input_data_config], context: "#{context}[:input_data_config]") unless input[:input_data_config].nil?
        Hearth::Validator.validate!(input[:client_request_token], ::String, context: "#{context}[:client_request_token]")
        Hearth::Validator.validate!(input[:language_code], ::String, context: "#{context}[:language_code]")
        Hearth::Validator.validate!(input[:volume_kms_key_id], ::String, context: "#{context}[:volume_kms_key_id]")
        Validators::VpcConfig.validate!(input[:vpc_config], context: "#{context}[:vpc_config]") unless input[:vpc_config].nil?
    ...
    class DescribeDocumentClassificationJobOutput
      def self.validate!(input, context:)
        ...
        Validators::DocumentClassificationJobProperties.validate!(input[:document_classification_job_properties], context: "#{context}[:document_classification_job_properties]") unless input[:document_classification_job_properties].nil?
      end
    end
    ...
    class DescribeDocumentClassifierOutput
      def self.validate!(input, context:)
        ...
        Validators::DocumentClassifierProperties.validate!(input[:document_classifier_properties], context: "#{context}[:document_classifier_properties]") unless input[:document_classifier_properties].nil?
      end
    end
    ...
    class DescribeDominantLanguageDetectionJobOutput
      def self.validate!(input, context:)
        ...
        Validators::DominantLanguageDetectionJobProperties.validate!(input[:dominant_language_detection_job_properties], context: "#{context}[:dominant_language_detection_job_properties]") unless input[:dominant_language_detection_job_properties].nil?
      end
    end
    ...
    class DescribeEndpointOutput
      def self.validate!(input, context:)
        ...
        Validators::EndpointProperties.validate!(input[:endpoint_properties], context: "#{context}[:endpoint_properties]") unless input[:endpoint_properties].nil?
      end
    end
    ...
    class DescribeEntitiesDetectionJobOutput
      def self.validate!(input, context:)
        ...
        Validators::EntitiesDetectionJobProperties.validate!(input[:entities_detection_job_properties], context: "#{context}[:entities_detection_job_properties]") unless input[:entities_detection_job_properties].nil?
      end
    end
    ...
    class DescribeEntityRecognizerOutput
      def self.validate!(input, context:)
        ...
        Validators::EntityRecognizerProperties.validate!(input[:entity_recognizer_properties], context: "#{context}[:entity_recognizer_properties]") unless input[:entity_recognizer_properties].nil?
      end
    end
    ...
    class DescribeEventsDetectionJobOutput
      def self.validate!(input, context:)
        ...
        Validators::EventsDetectionJobProperties.validate!(input[:events_detection_job_properties], context: "#{context}[:events_detection_job_properties]") unless input[:events_detection_job_properties].nil?
      end
    end
    ...
    class DescribeKeyPhrasesDetectionJobOutput
      def self.validate!(input, context:)
        ...
        Validators::KeyPhrasesDetectionJobProperties.validate!(input[:key_phrases_detection_job_properties], context: "#{context}[:key_phrases_detection_job_properties]") unless input[:key_phrases_detection_job_properties].nil?
      end
    end
    ...
    class DescribePiiEntitiesDetectionJobOutput
      def self.validate!(input, context:)
        ...
        Validators::PiiEntitiesDetectionJobProperties.validate!(input[:pii_entities_detection_job_properties], context: "#{context}[:pii_entities_detection_job_properties]") unless input[:pii_entities_detection_job_properties].nil?
      end
    end
    ...
    class DescribeSentimentDetectionJobOutput
      def self.validate!(input, context:)
        ...
        Validators::SentimentDetectionJobProperties.validate!(input[:sentiment_detection_job_properties], context: "#{context}[:sentiment_detection_job_properties]") unless input[:sentiment_detection_job_properties].nil?
      end
    end
    ...
    class DescribeTargetedSentimentDetectionJobOutput
      def self.validate!(input, context:)
        ...
        Validators::TargetedSentimentDetectionJobProperties.validate!(input[:targeted_sentiment_detection_job_properties], context: "#{context}[:targeted_sentiment_detection_job_properties]") unless input[:targeted_sentiment_detection_job_properties].nil?
      end
    end
    ...
    class DescribeTopicsDetectionJobOutput
      def self.validate!(input, context:)
        ...
        Validators::TopicsDetectionJobProperties.validate!(input[:topics_detection_job_properties], context: "#{context}[:topics_detection_job_properties]") unless input[:topics_detection_job_properties].nil?
      end
    end
    ...
    class DetectPiiEntitiesOutput
      def self.validate!(input, context:)
        ...
        Validators::ListOfPiiEntities.validate!(input[:entities], context: "#{context}[:entities]") unless input[:entities].nil?
      end
    end
    ...
    class DocumentClassificationJobPropertiesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::DocumentClassificationJobProperties.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class DocumentClassifierAugmentedManifestsList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::AugmentedManifestsListItem.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class DocumentClassifierInputDataConfig
      def self.validate!(input, context:)
        ...
        Validators::DocumentClassifierAugmentedManifestsList.validate!(input[:augmented_manifests], context: "#{context}[:augmented_manifests]") unless input[:augmented_manifests].nil?
      end
    end
    ...
    class DocumentClassifierProperties
      def self.validate!(input, context:)
        ...
        Validators::DocumentClassifierInputDataConfig.validate!(input[:input_data_config], context: "#{context}[:input_data_config]") unless input[:input_data_config].nil?
        Validators::DocumentClassifierOutputDataConfig.validate!(input[:output_data_config], context: "#{context}[:output_data_config]") unless input[:output_data_config].nil?
        Validators::ClassifierMetadata.validate!(input[:classifier_metadata], context: "#{context}[:classifier_metadata]") unless input[:classifier_metadata].nil?
        Hearth::Validator.validate!(input[:data_access_role_arn], ::String, context: "#{context}[:data_access_role_arn]")
        Hearth::Validator.validate!(input[:volume_kms_key_id], ::String, context: "#{context}[:volume_kms_key_id]")
        Validators::VpcConfig.validate!(input[:vpc_config], context: "#{context}[:vpc_config]") unless input[:vpc_config].nil?
        Hearth::Validator.validate!(input[:mode], ::String, context: "#{context}[:mode]")
    ...
    class DocumentClassifierPropertiesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::DocumentClassifierProperties.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class DocumentClassifierSummariesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::DocumentClassifierSummary.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class DocumentReaderConfig
      def self.validate!(input, context:)
        ...
        Validators::ListOfDocumentReadFeatureTypes.validate!(input[:feature_types], context: "#{context}[:feature_types]") unless input[:feature_types].nil?
      end
    end
    ...
    class DominantLanguageDetectionJobPropertiesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::DominantLanguageDetectionJobProperties.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class EndpointPropertiesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::EndpointProperties.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class EntitiesDetectionJobPropertiesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::EntitiesDetectionJobProperties.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class EntityRecognizerInputDataConfig
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:data_format], ::String, context: "#{context}[:data_format]")
        Validators::EntityTypesList.validate!(input[:entity_types], context: "#{context}[:entity_types]") unless input[:entity_types].nil?
        Validators::EntityRecognizerDocuments.validate!(input[:documents], context: "#{context}[:documents]") unless input[:documents].nil?
        Validators::EntityRecognizerAnnotations.validate!(input[:annotations], context: "#{context}[:annotations]") unless input[:annotations].nil?
        Validators::EntityRecognizerEntityList.validate!(input[:entity_list], context: "#{context}[:entity_list]") unless input[:entity_list].nil?
        Validators::EntityRecognizerAugmentedManifestsList.validate!(input[:augmented_manifests], context: "#{context}[:augmented_manifests]") unless input[:augmented_manifests].nil?
      end
    end
    ...
    class EntityRecognizerMetadata
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:number_of_trained_documents], ::Integer, context: "#{context}[:number_of_trained_documents]")
        Hearth::Validator.validate!(input[:number_of_test_documents], ::Integer, context: "#{context}[:number_of_test_documents]")
        Validators::EntityRecognizerEvaluationMetrics.validate!(input[:evaluation_metrics], context: "#{context}[:evaluation_metrics]") unless input[:evaluation_metrics].nil?
        Validators::EntityRecognizerMetadataEntityTypesList.validate!(input[:entity_types], context: "#{context}[:entity_types]") unless input[:entity_types].nil?
      end
    end
    ...
    class EntityRecognizerMetadataEntityTypesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::EntityRecognizerMetadataEntityTypesListItem.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class EntityRecognizerMetadataEntityTypesListItem
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:type], ::String, context: "#{context}[:type]")
        Validators::EntityTypesEvaluationMetrics.validate!(input[:evaluation_metrics], context: "#{context}[:evaluation_metrics]") unless input[:evaluation_metrics].nil?
    ...
    class EntityRecognizerProperties
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:training_end_time], ::Time, context: "#{context}[:training_end_time]")
        Validators::EntityRecognizerInputDataConfig.validate!(input[:input_data_config], context: "#{context}[:input_data_config]") unless input[:input_data_config].nil?
        Validators::EntityRecognizerMetadata.validate!(input[:recognizer_metadata], context: "#{context}[:recognizer_metadata]") unless input[:recognizer_metadata].nil?
        Hearth::Validator.validate!(input[:data_access_role_arn], ::String, context: "#{context}[:data_access_role_arn]")
        Hearth::Validator.validate!(input[:volume_kms_key_id], ::String, context: "#{context}[:volume_kms_key_id]")
        Validators::VpcConfig.validate!(input[:vpc_config], context: "#{context}[:vpc_config]") unless input[:vpc_config].nil?
        Hearth::Validator.validate!(input[:model_kms_key_id], ::String, context: "#{context}[:model_kms_key_id]")
    ...
    class EntityRecognizerPropertiesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::EntityRecognizerProperties.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class EntityRecognizerSummariesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::EntityRecognizerSummary.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class EntityTypesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::EntityTypesListItem.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class EventsDetectionJobProperties
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:language_code], ::String, context: "#{context}[:language_code]")
        Hearth::Validator.validate!(input[:data_access_role_arn], ::String, context: "#{context}[:data_access_role_arn]")
        Validators::TargetEventTypes.validate!(input[:target_event_types], context: "#{context}[:target_event_types]") unless input[:target_event_types].nil?
      end
    end
    ...
    class EventsDetectionJobPropertiesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::EventsDetectionJobProperties.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class InputDataConfig
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:s3_uri], ::String, context: "#{context}[:s3_uri]")
        Hearth::Validator.validate!(input[:input_format], ::String, context: "#{context}[:input_format]")
        Validators::DocumentReaderConfig.validate!(input[:document_reader_config], context: "#{context}[:document_reader_config]") unless input[:document_reader_config].nil?
      end
    end
    ...
    class KeyPhrasesDetectionJobPropertiesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::KeyPhrasesDetectionJobProperties.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListDocumentClassificationJobsInput
      def self.validate!(input, context:)
        ...
        Validators::DocumentClassificationJobFilter.validate!(input[:filter], context: "#{context}[:filter]") unless input[:filter].nil?
    ...
    class ListDocumentClassificationJobsOutput
      def self.validate!(input, context:)
        ...
        Validators::DocumentClassificationJobPropertiesList.validate!(input[:document_classification_job_properties_list], context: "#{context}[:document_classification_job_properties_list]") unless input[:document_classification_job_properties_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListDocumentClassifierSummariesOutput
      def self.validate!(input, context:)
        ...
        Validators::DocumentClassifierSummariesList.validate!(input[:document_classifier_summaries_list], context: "#{context}[:document_classifier_summaries_list]") unless input[:document_classifier_summaries_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListDocumentClassifiersInput
      def self.validate!(input, context:)
        ...
        Validators::DocumentClassifierFilter.validate!(input[:filter], context: "#{context}[:filter]") unless input[:filter].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    end
    ...
    class ListDocumentClassifiersOutput
      def self.validate!(input, context:)
        ...
        Validators::DocumentClassifierPropertiesList.validate!(input[:document_classifier_properties_list], context: "#{context}[:document_classifier_properties_list]") unless input[:document_classifier_properties_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListDominantLanguageDetectionJobsInput
      def self.validate!(input, context:)
        ...
        Validators::DominantLanguageDetectionJobFilter.validate!(input[:filter], context: "#{context}[:filter]") unless input[:filter].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    end
    ...
    class ListDominantLanguageDetectionJobsOutput
      def self.validate!(input, context:)
        ...
        Validators::DominantLanguageDetectionJobPropertiesList.validate!(input[:dominant_language_detection_job_properties_list], context: "#{context}[:dominant_language_detection_job_properties_list]") unless input[:dominant_language_detection_job_properties_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListEndpointsInput
      def self.validate!(input, context:)
        ...
        Validators::EndpointFilter.validate!(input[:filter], context: "#{context}[:filter]") unless input[:filter].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    end
    ...
    class ListEndpointsOutput
      def self.validate!(input, context:)
        ...
        Validators::EndpointPropertiesList.validate!(input[:endpoint_properties_list], context: "#{context}[:endpoint_properties_list]") unless input[:endpoint_properties_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListEntitiesDetectionJobsInput
      def self.validate!(input, context:)
        ...
        Validators::EntitiesDetectionJobFilter.validate!(input[:filter], context: "#{context}[:filter]") unless input[:filter].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    end
    ...
    class ListEntitiesDetectionJobsOutput
      def self.validate!(input, context:)
        ...
        Validators::EntitiesDetectionJobPropertiesList.validate!(input[:entities_detection_job_properties_list], context: "#{context}[:entities_detection_job_properties_list]") unless input[:entities_detection_job_properties_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListEntityRecognizerSummariesOutput
      def self.validate!(input, context:)
        ...
        Validators::EntityRecognizerSummariesList.validate!(input[:entity_recognizer_summaries_list], context: "#{context}[:entity_recognizer_summaries_list]") unless input[:entity_recognizer_summaries_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListEntityRecognizersInput
      def self.validate!(input, context:)
        ...
        Validators::EntityRecognizerFilter.validate!(input[:filter], context: "#{context}[:filter]") unless input[:filter].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    end
    ...
    class ListEntityRecognizersOutput
      def self.validate!(input, context:)
        ...
        Validators::EntityRecognizerPropertiesList.validate!(input[:entity_recognizer_properties_list], context: "#{context}[:entity_recognizer_properties_list]") unless input[:entity_recognizer_properties_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListEventsDetectionJobsInput
      def self.validate!(input, context:)
        ...
        Validators::EventsDetectionJobFilter.validate!(input[:filter], context: "#{context}[:filter]") unless input[:filter].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    end
    ...
    class ListEventsDetectionJobsOutput
      def self.validate!(input, context:)
        ...
        Validators::EventsDetectionJobPropertiesList.validate!(input[:events_detection_job_properties_list], context: "#{context}[:events_detection_job_properties_list]") unless input[:events_detection_job_properties_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListKeyPhrasesDetectionJobsInput
      def self.validate!(input, context:)
        ...
        Validators::KeyPhrasesDetectionJobFilter.validate!(input[:filter], context: "#{context}[:filter]") unless input[:filter].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    end
    ...
    class ListKeyPhrasesDetectionJobsOutput
      def self.validate!(input, context:)
        ...
        Validators::KeyPhrasesDetectionJobPropertiesList.validate!(input[:key_phrases_detection_job_properties_list], context: "#{context}[:key_phrases_detection_job_properties_list]") unless input[:key_phrases_detection_job_properties_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListOfClasses
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::DocumentClass.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListOfDetectDominantLanguageResult
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::BatchDetectDominantLanguageItemResult.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListOfDetectEntitiesResult
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::BatchDetectEntitiesItemResult.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListOfDetectKeyPhrasesResult
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::BatchDetectKeyPhrasesItemResult.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListOfDetectSentimentResult
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::BatchDetectSentimentItemResult.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListOfDetectSyntaxResult
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::BatchDetectSyntaxItemResult.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListOfDominantLanguages
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::DominantLanguage.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListOfEntityLabels
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::EntityLabel.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListOfKeyPhrases
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::KeyPhrase.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListOfLabels
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::DocumentLabel.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListOfPiiEntities
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::PiiEntity.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListOfSyntaxTokens
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::SyntaxToken.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListPiiEntitiesDetectionJobsInput
      def self.validate!(input, context:)
        ...
        Validators::PiiEntitiesDetectionJobFilter.validate!(input[:filter], context: "#{context}[:filter]") unless input[:filter].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    end
    ...
    class ListPiiEntitiesDetectionJobsOutput
      def self.validate!(input, context:)
        ...
        Validators::PiiEntitiesDetectionJobPropertiesList.validate!(input[:pii_entities_detection_job_properties_list], context: "#{context}[:pii_entities_detection_job_properties_list]") unless input[:pii_entities_detection_job_properties_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListSentimentDetectionJobsInput
      def self.validate!(input, context:)
        ...
        Validators::SentimentDetectionJobFilter.validate!(input[:filter], context: "#{context}[:filter]") unless input[:filter].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    end
    ...
    class ListSentimentDetectionJobsOutput
      def self.validate!(input, context:)
        ...
        Validators::SentimentDetectionJobPropertiesList.validate!(input[:sentiment_detection_job_properties_list], context: "#{context}[:sentiment_detection_job_properties_list]") unless input[:sentiment_detection_job_properties_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListTargetedSentimentDetectionJobsInput
      def self.validate!(input, context:)
        ...
        Validators::TargetedSentimentDetectionJobFilter.validate!(input[:filter], context: "#{context}[:filter]") unless input[:filter].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    end
    ...
    class ListTargetedSentimentDetectionJobsOutput
      def self.validate!(input, context:)
        ...
        Validators::TargetedSentimentDetectionJobPropertiesList.validate!(input[:targeted_sentiment_detection_job_properties_list], context: "#{context}[:targeted_sentiment_detection_job_properties_list]") unless input[:targeted_sentiment_detection_job_properties_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListTopicsDetectionJobsInput
      def self.validate!(input, context:)
        ...
        Validators::TopicsDetectionJobFilter.validate!(input[:filter], context: "#{context}[:filter]") unless input[:filter].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    end
    ...
    class ListTopicsDetectionJobsOutput
      def self.validate!(input, context:)
        ...
        Validators::TopicsDetectionJobPropertiesList.validate!(input[:topics_detection_job_properties_list], context: "#{context}[:topics_detection_job_properties_list]") unless input[:topics_detection_job_properties_list].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class PiiEntitiesDetectionJobProperties
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:end_time], ::Time, context: "#{context}[:end_time]")
        Validators::InputDataConfig.validate!(input[:input_data_config], context: "#{context}[:input_data_config]") unless input[:input_data_config].nil?
        Validators::PiiOutputDataConfig.validate!(input[:output_data_config], context: "#{context}[:output_data_config]") unless input[:output_data_config].nil?
        Validators::RedactionConfig.validate!(input[:redaction_config], context: "#{context}[:redaction_config]") unless input[:redaction_config].nil?
        Hearth::Validator.validate!(input[:language_code], ::String, context: "#{context}[:language_code]")
        Hearth::Validator.validate!(input[:data_access_role_arn], ::String, context: "#{context}[:data_access_role_arn]")
        Hearth::Validator.validate!(input[:mode], ::String, context: "#{context}[:mode]")
      end
    ...
    class PiiEntitiesDetectionJobPropertiesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::PiiEntitiesDetectionJobProperties.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class RedactionConfig
      def self.validate!(input, context:)
        ...
        Validators::ListOfPiiEntityTypes.validate!(input[:pii_entity_types], context: "#{context}[:pii_entity_types]") unless input[:pii_entity_types].nil?
    ...
    class SentimentDetectionJobPropertiesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::SentimentDetectionJobProperties.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class SyntaxToken
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:begin_offset], ::Integer, context: "#{context}[:begin_offset]")
        Hearth::Validator.validate!(input[:end_offset], ::Integer, context: "#{context}[:end_offset]")
        Validators::PartOfSpeechTag.validate!(input[:part_of_speech], context: "#{context}[:part_of_speech]") unless input[:part_of_speech].nil?
      end
    end
    ...
    class TargetedSentimentDetectionJobPropertiesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::TargetedSentimentDetectionJobProperties.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class TopicsDetectionJobPropertiesList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::TopicsDetectionJobProperties.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
