  ...
  module Validators
    ...
    class AcceptResourceShareInvitationOutput
      def self.validate!(input, context:)
        ...
        ResourceShareInvitation.validate!(input[:resource_share_invitation], context: "#{context}[:resource_share_invitation]") unless input[:resource_share_invitation].nil?
        Hearth::Validator.validate!(input[:client_token], ::String, context: "#{context}[:client_token]")
      end
    end
    ...
    class AssociateResourceShareInput
      def self.validate!(input, context:)
        ...
        PrincipalArnOrIdList.validate!(input[:principals], context: "#{context}[:principals]") unless input[:principals].nil?
        Hearth::Validator.validate!(input[:client_token], ::String, context: "#{context}[:client_token]")
      end
    end
    ...
    class AssociateResourceShareOutput
      def self.validate!(input, context:)
        ...
        ResourceShareAssociationList.validate!(input[:resource_share_associations], context: "#{context}[:resource_share_associations]") unless input[:resource_share_associations].nil?
        Hearth::Validator.validate!(input[:client_token], ::String, context: "#{context}[:client_token]")
      end
    end
    ...
    class CreateResourceShareInput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:client_token], ::String, context: "#{context}[:client_token]")
        PermissionArnList.validate!(input[:permission_arns], context: "#{context}[:permission_arns]") unless input[:permission_arns].nil?
      end
    end
    ...
    class CreateResourceShareOutput
      def self.validate!(input, context:)
        ...
        ResourceShare.validate!(input[:resource_share], context: "#{context}[:resource_share]") unless input[:resource_share].nil?
        Hearth::Validator.validate!(input[:client_token], ::String, context: "#{context}[:client_token]")
      end
    end
    ...
    class GetPermissionOutput
      def self.validate!(input, context:)
        ...
        ResourceSharePermissionDetail.validate!(input[:permission], context: "#{context}[:permission]") unless input[:permission].nil?
      end
    end
    ...
    class GetResourcePoliciesOutput
      def self.validate!(input, context:)
        ...
        PolicyList.validate!(input[:policies], context: "#{context}[:policies]") unless input[:policies].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class GetResourceShareAssociationsInput
      def self.validate!(input, context:)
        ...
        ResourceShareArnList.validate!(input[:resource_share_arns], context: "#{context}[:resource_share_arns]") unless input[:resource_share_arns].nil?
    ...
    class GetResourceShareInvitationsInput
      def self.validate!(input, context:)
        ...
        ResourceShareInvitationArnList.validate!(input[:resource_share_invitation_arns], context: "#{context}[:resource_share_invitation_arns]") unless input[:resource_share_invitation_arns].nil?
        ResourceShareArnList.validate!(input[:resource_share_arns], context: "#{context}[:resource_share_arns]") unless input[:resource_share_arns].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Hearth::Validator.validate!(input[:max_results], ::Integer, context: "#{context}[:max_results]")
      end
    ...
    class GetResourceShareInvitationsOutput
      def self.validate!(input, context:)
        ...
        ResourceShareInvitationList.validate!(input[:resource_share_invitations], context: "#{context}[:resource_share_invitations]") unless input[:resource_share_invitations].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class GetResourceSharesOutput
      def self.validate!(input, context:)
        ...
        ResourceShareList.validate!(input[:resource_shares], context: "#{context}[:resource_shares]") unless input[:resource_shares].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListPermissionVersionsOutput
      def self.validate!(input, context:)
        ...
        ResourceSharePermissionList.validate!(input[:permissions], context: "#{context}[:permissions]") unless input[:permissions].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListResourceTypesOutput
      def self.validate!(input, context:)
        ...
        ServiceNameAndResourceTypeList.validate!(input[:resource_types], context: "#{context}[:resource_types]") unless input[:resource_types].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ResourceShareAssociationList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          ResourceShareAssociation.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ResourceShareInvitationList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          ResourceShareInvitation.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ResourceShareList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          ResourceShare.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ResourceSharePermissionList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          ResourceSharePermissionSummary.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ServiceNameAndResourceTypeList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          ServiceNameAndResourceType.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
