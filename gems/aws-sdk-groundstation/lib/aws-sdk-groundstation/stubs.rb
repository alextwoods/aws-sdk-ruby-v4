  ...
  module Stubs
    ...
    class DescribeContact
      ...
      def self.stub(http_resp, stub:)
        ...
        data['maximumElevation'] = Elevation.stub(stub[:maximum_elevation]) unless stub[:maximum_elevation].nil?
        data['tags'] = TagsMap.stub(stub[:tags]) unless stub[:tags].nil?
        data['region'] = stub[:region] unless stub[:region].nil?
        data['dataflowList'] = DataflowList.stub(stub[:dataflow_list]) unless stub[:dataflow_list].nil?
        http_resp.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DataflowList
      ...
      def self.stub(stub)
        ...
        stub.each do |element|
          data << DataflowDetail.stub(element) unless element.nil?
        end
        data
      end
    end
    ...
    class Destination
      ...
      def self.stub(stub)
        ...
        data['configType'] = stub[:config_type] unless stub[:config_type].nil?
        data['configId'] = stub[:config_id] unless stub[:config_id].nil?
        data['configDetails'] = ConfigDetails.stub(stub[:config_details]) unless stub[:config_details].nil?
    ...
    class ConfigDetails
      ...
      def self.stub(stub)
        ...
        when Types::ConfigDetails::EndpointDetails
          data['endpointDetails'] = (EndpointDetails.stub(stub.__getobj__) unless stub.__getobj__.nil?)
        when Types::ConfigDetails::AntennaDemodDecodeDetails
          data['antennaDemodDecodeDetails'] = (AntennaDemodDecodeDetails.stub(stub.__getobj__) unless stub.__getobj__.nil?)
        when Types::ConfigDetails::S3RecordingDetails
          data['s3RecordingDetails'] = (S3RecordingDetails.stub(stub.__getobj__) unless stub.__getobj__.nil?)
        else
          raise ArgumentError,
    ...
    class EndpointDetails
      ...
      def self.stub(stub)
        ...
        data = {}
        data['securityDetails'] = SecurityDetails.stub(stub[:security_details]) unless stub[:security_details].nil?
        data['endpoint'] = DataflowEndpoint.stub(stub[:endpoint]) unless stub[:endpoint].nil?
        data
      end
    end
    ...
    class DataflowEndpoint
      ...
      def self.stub(stub)
        ...
        data['address'] = SocketAddress.stub(stub[:address]) unless stub[:address].nil?
    ...
    class GetConfig
      ...
      def self.stub(http_resp, stub:)
        ...
        data['name'] = stub[:name] unless stub[:name].nil?
        data['configType'] = stub[:config_type] unless stub[:config_type].nil?
        data['configData'] = ConfigTypeData.stub(stub[:config_data]) unless stub[:config_data].nil?
        data['tags'] = TagsMap.stub(stub[:tags]) unless stub[:tags].nil?
        http_resp.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class ConfigTypeData
      ...
      def self.stub(stub)
        ...
        when Types::ConfigTypeData::AntennaDownlinkConfig
          data['antennaDownlinkConfig'] = (AntennaDownlinkConfig.stub(stub.__getobj__) unless stub.__getobj__.nil?)
        when Types::ConfigTypeData::TrackingConfig
          data['trackingConfig'] = (TrackingConfig.stub(stub.__getobj__) unless stub.__getobj__.nil?)
        when Types::ConfigTypeData::DataflowEndpointConfig
          data['dataflowEndpointConfig'] = (DataflowEndpointConfig.stub(stub.__getobj__) unless stub.__getobj__.nil?)
        when Types::ConfigTypeData::AntennaDownlinkDemodDecodeConfig
          data['antennaDownlinkDemodDecodeConfig'] = (AntennaDownlinkDemodDecodeConfig.stub(stub.__getobj__) unless stub.__getobj__.nil?)
        when Types::ConfigTypeData::AntennaUplinkConfig
          data['antennaUplinkConfig'] = (AntennaUplinkConfig.stub(stub.__getobj__) unless stub.__getobj__.nil?)
        when Types::ConfigTypeData::UplinkEchoConfig
          data['uplinkEchoConfig'] = (UplinkEchoConfig.stub(stub.__getobj__) unless stub.__getobj__.nil?)
        when Types::ConfigTypeData::S3RecordingConfig
          data['s3RecordingConfig'] = (S3RecordingConfig.stub(stub.__getobj__) unless stub.__getobj__.nil?)
        else
          raise ArgumentError,
    ...
    class AntennaUplinkConfig
      ...
      def self.stub(stub)
        ...
        data['spectrumConfig'] = UplinkSpectrumConfig.stub(stub[:spectrum_config]) unless stub[:spectrum_config].nil?
        data['targetEirp'] = Eirp.stub(stub[:target_eirp]) unless stub[:target_eirp].nil?
        data
      end
    end
    ...
    class UplinkSpectrumConfig
      ...
      def self.stub(stub)
        ...
        data = {}
        data['centerFrequency'] = Frequency.stub(stub[:center_frequency]) unless stub[:center_frequency].nil?
    ...
    class AntennaDownlinkDemodDecodeConfig
      ...
      def self.stub(stub)
        ...
        data = {}
        data['spectrumConfig'] = SpectrumConfig.stub(stub[:spectrum_config]) unless stub[:spectrum_config].nil?
        data['demodulationConfig'] = DemodulationConfig.stub(stub[:demodulation_config]) unless stub[:demodulation_config].nil?
        data['decodeConfig'] = DecodeConfig.stub(stub[:decode_config]) unless stub[:decode_config].nil?
        data
      end
    end
    ...
    class SpectrumConfig
      ...
      def self.stub(stub)
        ...
        data = {}
        data['centerFrequency'] = Frequency.stub(stub[:center_frequency]) unless stub[:center_frequency].nil?
        data['bandwidth'] = FrequencyBandwidth.stub(stub[:bandwidth]) unless stub[:bandwidth].nil?
        data['polarization'] = stub[:polarization] unless stub[:polarization].nil?
        data
      end
    end
    ...
    class GetDataflowEndpointGroup
      ...
      def self.stub(http_resp, stub:)
        ...
        data['endpointsDetails'] = EndpointDetailsList.stub(stub[:endpoints_details]) unless stub[:endpoints_details].nil?
        data['tags'] = TagsMap.stub(stub[:tags]) unless stub[:tags].nil?
        http_resp.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class EndpointDetailsList
      ...
      def self.stub(stub)
        ...
        data = []
        stub.each do |element|
          data << EndpointDetails.stub(element) unless element.nil?
        end
        data
      end
    end
    ...
    class GetMissionProfile
      ...
      def self.stub(http_resp, stub:)
        ...
        data['dataflowEdges'] = DataflowEdgeList.stub(stub[:dataflow_edges]) unless stub[:dataflow_edges].nil?
    ...
    class DataflowEdgeList
      ...
      def self.stub(stub)
        ...
        data = []
        stub.each do |element|
          data << DataflowEdge.stub(element) unless element.nil?
        end
        data
      end
    end
    ...
    class GetSatellite
      ...
      def self.stub(http_resp, stub:)
        ...
        data['groundStations'] = GroundStationIdList.stub(stub[:ground_stations]) unless stub[:ground_stations].nil?
        http_resp.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class ListConfigs
      ...
      def self.stub(http_resp, stub:)
        ...
        data['configList'] = ConfigList.stub(stub[:config_list]) unless stub[:config_list].nil?
        http_resp.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class ConfigList
      ...
      def self.stub(stub)
        ...
        data = []
        stub.each do |element|
          data << ConfigListItem.stub(element) unless element.nil?
        end
        data
      end
    end
    ...
    class ListContacts
      ...
      def self.stub(http_resp, stub:)
        ...
        http_resp.headers['Content-Type'] = 'application/json'
        data['nextToken'] = stub[:next_token] unless stub[:next_token].nil?
        data['contactList'] = ContactList.stub(stub[:contact_list]) unless stub[:contact_list].nil?
        http_resp.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class ListDataflowEndpointGroups
      ...
      def self.stub(http_resp, stub:)
        ...
        http_resp.headers['Content-Type'] = 'application/json'
        data['nextToken'] = stub[:next_token] unless stub[:next_token].nil?
        data['dataflowEndpointGroupList'] = DataflowEndpointGroupList.stub(stub[:dataflow_endpoint_group_list]) unless stub[:dataflow_endpoint_group_list].nil?
        http_resp.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class DataflowEndpointGroupList
      ...
      def self.stub(stub)
        ...
        data = []
        stub.each do |element|
          data << DataflowEndpointListItem.stub(element) unless element.nil?
        end
        data
      end
    end
    ...
    class ListGroundStations
      ...
      def self.stub(http_resp, stub:)
        ...
        http_resp.headers['Content-Type'] = 'application/json'
        data['nextToken'] = stub[:next_token] unless stub[:next_token].nil?
        data['groundStationList'] = GroundStationList.stub(stub[:ground_station_list]) unless stub[:ground_station_list].nil?
        http_resp.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class GroundStationList
      ...
      def self.stub(stub)
        ...
        data = []
        stub.each do |element|
          data << GroundStationData.stub(element) unless element.nil?
        end
        data
      end
    end
    ...
    class ListMissionProfiles
      ...
      def self.stub(http_resp, stub:)
        ...
        http_resp.headers['Content-Type'] = 'application/json'
        data['nextToken'] = stub[:next_token] unless stub[:next_token].nil?
        data['missionProfileList'] = MissionProfileList.stub(stub[:mission_profile_list]) unless stub[:mission_profile_list].nil?
        http_resp.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class MissionProfileList
      ...
      def self.stub(stub)
        ...
        data = []
        stub.each do |element|
          data << MissionProfileListItem.stub(element) unless element.nil?
        end
        data
      end
    end
    ...
    class ListSatellites
      ...
      def self.stub(http_resp, stub:)
        ...
        http_resp.headers['Content-Type'] = 'application/json'
        data['nextToken'] = stub[:next_token] unless stub[:next_token].nil?
        data['satellites'] = SatelliteList.stub(stub[:satellites]) unless stub[:satellites].nil?
        http_resp.body = ::StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class SatelliteList
      ...
      def self.stub(stub)
        ...
        data = []
        stub.each do |element|
          data << SatelliteListItem.stub(element) unless element.nil?
        end
        data
      end
    end
