...
module AWS::SDK::Mobile
  module Errors
    ...
    class AccountActionRequiredException < ApiClientError
      def initialize(http_resp:, **kwargs)
        @data = Parsers::AccountActionRequiredException.parse(http_resp)
        kwargs[:message] = @data.message if @data.respond_to?(:message)

        super(http_resp: http_resp, **kwargs)
      end

      # @return [Types::AccountActionRequiredException]
      #
      attr_reader :data
    end
