    ...
    class StartConversationRequestEventStream
      def self.validate!(input, context:)
        ...
        when Types::StartConversationRequestEventStream::DisconnectionEvent
          ...
          raise ArgumentError, "Expected #{context} to be a union member of Types::StartConversationRequestEventStream, got #{input.class}."
        end
      end
    ...
    class StartConversationResponseEventStream
      def self.validate!(input, context:)
        ...
        when Types::StartConversationResponseEventStream::BadGatewayException
          ...
          raise ArgumentError, "Expected #{context} to be a union member of Types::StartConversationResponseEventStream, got #{input.class}."
        end
      end
