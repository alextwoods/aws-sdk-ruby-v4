  ...
  module Validators
    ...
    class AcceptInboundCrossClusterSearchConnectionOutput
      def self.validate!(input, context:)
        ...
        Validators::InboundCrossClusterSearchConnection.validate!(input[:cross_cluster_search_connection], context: "#{context}[:cross_cluster_search_connection]") unless input[:cross_cluster_search_connection].nil?
      end
    end
    ...
    class CompatibleVersionsMap
      def self.validate!(input, context:)
        ...
        Validators::ElasticsearchVersionList.validate!(input[:target_versions], context: "#{context}[:target_versions]") unless input[:target_versions].nil?
      end
    end
    ...
    class CreateElasticsearchDomainInput
      def self.validate!(input, context:)
        ...
        Validators::ElasticsearchClusterConfig.validate!(input[:elasticsearch_cluster_config], context: "#{context}[:elasticsearch_cluster_config]") unless input[:elasticsearch_cluster_config].nil?
    ...
    class CreateElasticsearchDomainOutput
      def self.validate!(input, context:)
        ...
        Validators::ElasticsearchDomainStatus.validate!(input[:domain_status], context: "#{context}[:domain_status]") unless input[:domain_status].nil?
      end
    end
    ...
    class CreateOutboundCrossClusterSearchConnectionInput
      def self.validate!(input, context:)
        ...
        Validators::DomainInformation.validate!(input[:source_domain_info], context: "#{context}[:source_domain_info]") unless input[:source_domain_info].nil?
        Validators::DomainInformation.validate!(input[:destination_domain_info], context: "#{context}[:destination_domain_info]") unless input[:destination_domain_info].nil?
    ...
    class CreateOutboundCrossClusterSearchConnectionOutput
      def self.validate!(input, context:)
        ...
        Validators::DomainInformation.validate!(input[:destination_domain_info], context: "#{context}[:destination_domain_info]") unless input[:destination_domain_info].nil?
        Hearth::Validator.validate!(input[:connection_alias], ::String, context: "#{context}[:connection_alias]")
        Validators::OutboundCrossClusterSearchConnectionStatus.validate!(input[:connection_status], context: "#{context}[:connection_status]") unless input[:connection_status].nil?
        Hearth::Validator.validate!(input[:cross_cluster_search_connection_id], ::String, context: "#{context}[:cross_cluster_search_connection_id]")
      end
    end
    ...
    class DeleteOutboundCrossClusterSearchConnectionOutput
      def self.validate!(input, context:)
        ...
        Validators::OutboundCrossClusterSearchConnection.validate!(input[:cross_cluster_search_connection], context: "#{context}[:cross_cluster_search_connection]") unless input[:cross_cluster_search_connection].nil?
      end
    end
    ...
    class DescribeElasticsearchDomainConfigOutput
      def self.validate!(input, context:)
        ...
        Validators::ElasticsearchDomainConfig.validate!(input[:domain_config], context: "#{context}[:domain_config]") unless input[:domain_config].nil?
      end
    end
    ...
    class DescribeElasticsearchDomainsOutput
      def self.validate!(input, context:)
        ...
        Validators::ElasticsearchDomainStatusList.validate!(input[:domain_status_list], context: "#{context}[:domain_status_list]") unless input[:domain_status_list].nil?
      end
    end
    ...
    class DescribeInboundCrossClusterSearchConnectionsOutput
      def self.validate!(input, context:)
        ...
        Validators::InboundCrossClusterSearchConnections.validate!(input[:cross_cluster_search_connections], context: "#{context}[:cross_cluster_search_connections]") unless input[:cross_cluster_search_connections].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class DescribeOutboundCrossClusterSearchConnectionsOutput
      def self.validate!(input, context:)
        ...
        Validators::OutboundCrossClusterSearchConnections.validate!(input[:cross_cluster_search_connections], context: "#{context}[:cross_cluster_search_connections]") unless input[:cross_cluster_search_connections].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class DescribeReservedElasticsearchInstanceOfferingsOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Validators::ReservedElasticsearchInstanceOfferingList.validate!(input[:reserved_elasticsearch_instance_offerings], context: "#{context}[:reserved_elasticsearch_instance_offerings]") unless input[:reserved_elasticsearch_instance_offerings].nil?
      end
    end
    ...
    class DescribeReservedElasticsearchInstancesOutput
      def self.validate!(input, context:)
        ...
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
        Validators::ReservedElasticsearchInstanceList.validate!(input[:reserved_elasticsearch_instances], context: "#{context}[:reserved_elasticsearch_instances]") unless input[:reserved_elasticsearch_instances].nil?
      end
    end
    ...
    class ElasticsearchClusterConfigStatus
      def self.validate!(input, context:)
        ...
        Validators::ElasticsearchClusterConfig.validate!(input[:options], context: "#{context}[:options]") unless input[:options].nil?
        Validators::OptionStatus.validate!(input[:status], context: "#{context}[:status]") unless input[:status].nil?
      end
    end
    ...
    class ElasticsearchDomainConfig
      def self.validate!(input, context:)
        ...
        Validators::ElasticsearchVersionStatus.validate!(input[:elasticsearch_version], context: "#{context}[:elasticsearch_version]") unless input[:elasticsearch_version].nil?
        Validators::ElasticsearchClusterConfigStatus.validate!(input[:elasticsearch_cluster_config], context: "#{context}[:elasticsearch_cluster_config]") unless input[:elasticsearch_cluster_config].nil?
    ...
    class ElasticsearchDomainStatusList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::ElasticsearchDomainStatus.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class GetCompatibleElasticsearchVersionsOutput
      def self.validate!(input, context:)
        ...
        Validators::CompatibleElasticsearchVersionsList.validate!(input[:compatible_elasticsearch_versions], context: "#{context}[:compatible_elasticsearch_versions]") unless input[:compatible_elasticsearch_versions].nil?
      end
    end
    ...
    class InboundCrossClusterSearchConnection
      def self.validate!(input, context:)
        ...
        Validators::DomainInformation.validate!(input[:destination_domain_info], context: "#{context}[:destination_domain_info]") unless input[:destination_domain_info].nil?
        Hearth::Validator.validate!(input[:cross_cluster_search_connection_id], ::String, context: "#{context}[:cross_cluster_search_connection_id]")
        Validators::InboundCrossClusterSearchConnectionStatus.validate!(input[:connection_status], context: "#{context}[:connection_status]") unless input[:connection_status].nil?
      end
    end
    ...
    class InboundCrossClusterSearchConnections
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::InboundCrossClusterSearchConnection.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ListElasticsearchInstanceTypesOutput
      def self.validate!(input, context:)
        ...
        Validators::ElasticsearchInstanceTypeList.validate!(input[:elasticsearch_instance_types], context: "#{context}[:elasticsearch_instance_types]") unless input[:elasticsearch_instance_types].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class ListElasticsearchVersionsOutput
      def self.validate!(input, context:)
        ...
        Validators::ElasticsearchVersionList.validate!(input[:elasticsearch_versions], context: "#{context}[:elasticsearch_versions]") unless input[:elasticsearch_versions].nil?
        Hearth::Validator.validate!(input[:next_token], ::String, context: "#{context}[:next_token]")
      end
    end
    ...
    class OutboundCrossClusterSearchConnections
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::OutboundCrossClusterSearchConnection.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ReservedElasticsearchInstanceList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::ReservedElasticsearchInstance.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
    ...
    class ReservedElasticsearchInstanceOfferingList
      def self.validate!(input, context:)
        Hearth::Validator.validate!(input, ::Array, context: context)
        input.each_with_index do |element, index|
          Validators::ReservedElasticsearchInstanceOffering.validate!(element, context: "#{context}[#{index}]") unless element.nil?
        end
      end
    end
