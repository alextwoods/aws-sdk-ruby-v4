  ...
  module Builders
    ...
    class CreateHIT
      def self.build(http_req, input:)
        ...
        data['QualificationRequirements'] = Builders::QualificationRequirementList.build(input[:qualification_requirements]) unless input[:qualification_requirements].nil?
        data['UniqueRequestToken'] = input[:unique_request_token] unless input[:unique_request_token].nil?
        data['AssignmentReviewPolicy'] = Builders::ReviewPolicy.build(input[:assignment_review_policy]) unless input[:assignment_review_policy].nil?
        data['HITReviewPolicy'] = Builders::ReviewPolicy.build(input[:hit_review_policy]) unless input[:hit_review_policy].nil?
        data['HITLayoutId'] = input[:hit_layout_id] unless input[:hit_layout_id].nil?
        data['HITLayoutParameters'] = Builders::HITLayoutParameterList.build(input[:hit_layout_parameters]) unless input[:hit_layout_parameters].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class HITLayoutParameterList
      def self.build(input)
        ...
        input.each do |element|
          data << Builders::HITLayoutParameter.build(element) unless element.nil?
        end
        data
      end
    end
    ...
    class ReviewPolicy
      def self.build(input)
        ...
        data['Parameters'] = Builders::PolicyParameterList.build(input[:parameters]) unless input[:parameters].nil?
        data
      end
    end
    ...
    class PolicyParameterList
      def self.build(input)
        data = []
        input.each do |element|
          data << Builders::PolicyParameter.build(element) unless element.nil?
        end
        data
      end
    end
    ...
    class PolicyParameter
      def self.build(input)
        ...
        data['MapEntries'] = Builders::ParameterMapEntryList.build(input[:map_entries]) unless input[:map_entries].nil?
        data
      end
    end
    ...
    class ParameterMapEntryList
      def self.build(input)
        data = []
        input.each do |element|
          data << Builders::ParameterMapEntry.build(element) unless element.nil?
        end
        data
      end
    end
    ...
    class QualificationRequirementList
      def self.build(input)
        data = []
        input.each do |element|
          data << Builders::QualificationRequirement.build(element) unless element.nil?
        end
        data
      end
    end
    ...
    class QualificationRequirement
      def self.build(input)
        ...
        data['IntegerValues'] = Builders::IntegerList.build(input[:integer_values]) unless input[:integer_values].nil?
        data['LocaleValues'] = Builders::LocaleList.build(input[:locale_values]) unless input[:locale_values].nil?
    ...
    class LocaleList
      def self.build(input)
        data = []
        input.each do |element|
          data << Builders::Locale.build(element) unless element.nil?
        end
        data
      end
    end
    ...
    class ListAssignmentsForHIT
      def self.build(http_req, input:)
        ...
        data['AssignmentStatuses'] = Builders::AssignmentStatusList.build(input[:assignment_statuses]) unless input[:assignment_statuses].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class ListReviewPolicyResultsForHIT
      def self.build(http_req, input:)
        ...
        data = {}
        data['HITId'] = input[:hit_id] unless input[:hit_id].nil?
        data['PolicyLevels'] = Builders::ReviewPolicyLevelList.build(input[:policy_levels]) unless input[:policy_levels].nil?
    ...
    class NotifyWorkers
      def self.build(http_req, input:)
        ...
        data['WorkerIds'] = Builders::CustomerIdList.build(input[:worker_ids]) unless input[:worker_ids].nil?
        http_req.body = StringIO.new(Hearth::JSON.dump(data))
      end
    end
    ...
    class SendTestEventNotification
      def self.build(http_req, input:)
        ...
        data = {}
        data['Notification'] = Builders::NotificationSpecification.build(input[:notification]) unless input[:notification].nil?
    ...
    class NotificationSpecification
      def self.build(input)
        ...
        data['EventTypes'] = Builders::EventTypeList.build(input[:event_types]) unless input[:event_types].nil?
        data
      end
    end
