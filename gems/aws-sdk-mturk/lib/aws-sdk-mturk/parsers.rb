  ...
  module Parsers
    ...
    class CreateHIT
      def self.parse(http_resp)
        ...
        return data if body.empty?
        map = Hearth::JSON.load(body)
        data.hit = (HIT.parse(map['HIT']) unless map['HIT'].nil?)
        data
      end
    end
    ...
    class HIT
      def self.parse(map)
        ...
        data.qualification_requirements = (QualificationRequirementList.parse(map['QualificationRequirements']) unless map['QualificationRequirements'].nil?)
    ...
    class QualificationRequirementList
      def self.parse(list)
        list.map do |value|
          QualificationRequirement.parse(value) unless value.nil?
        end
      end
    end
    ...
    class QualificationRequirement
      def self.parse(map)
        ...
        data.integer_values = (IntegerList.parse(map['IntegerValues']) unless map['IntegerValues'].nil?)
        data.locale_values = (LocaleList.parse(map['LocaleValues']) unless map['LocaleValues'].nil?)
    ...
    class LocaleList
      def self.parse(list)
        list.map do |value|
          Locale.parse(value) unless value.nil?
        end
      end
    end
    ...
    class CreateQualificationType
      def self.parse(http_resp)
        ...
        return data if body.empty?
        map = Hearth::JSON.load(body)
        data.qualification_type = (QualificationType.parse(map['QualificationType']) unless map['QualificationType'].nil?)
        data
      end
    end
    ...
    class GetAssignment
      def self.parse(http_resp)
        ...
        return data if body.empty?
        map = Hearth::JSON.load(body)
        data.assignment = (Assignment.parse(map['Assignment']) unless map['Assignment'].nil?)
        data.hit = (HIT.parse(map['HIT']) unless map['HIT'].nil?)
        data
      end
    end
    ...
    class GetQualificationScore
      def self.parse(http_resp)
        ...
        return data if body.empty?
        map = Hearth::JSON.load(body)
        data.qualification = (Qualification.parse(map['Qualification']) unless map['Qualification'].nil?)
        data
      end
    end
    ...
    class Qualification
      def self.parse(map)
        ...
        data.locale_value = (Locale.parse(map['LocaleValue']) unless map['LocaleValue'].nil?)
    ...
    class ListAssignmentsForHIT
      def self.parse(http_resp)
        ...
        data.assignments = (AssignmentList.parse(map['Assignments']) unless map['Assignments'].nil?)
        data
      end
    end
    ...
    class AssignmentList
      def self.parse(list)
        list.map do |value|
          Assignment.parse(value) unless value.nil?
        end
      end
    end
    ...
    class ListBonusPayments
      def self.parse(http_resp)
        ...
        data.num_results = map['NumResults']
        data.next_token = map['NextToken']
        data.bonus_payments = (BonusPaymentList.parse(map['BonusPayments']) unless map['BonusPayments'].nil?)
        data
      end
    end
    ...
    class BonusPaymentList
      def self.parse(list)
        list.map do |value|
          BonusPayment.parse(value) unless value.nil?
        end
      end
    end
    ...
    class ListHITs
      def self.parse(http_resp)
        ...
        data.next_token = map['NextToken']
        data.num_results = map['NumResults']
        data.hi_ts = (HITList.parse(map['HITs']) unless map['HITs'].nil?)
        data
      end
    end
    ...
    class HITList
      def self.parse(list)
        list.map do |value|
          HIT.parse(value) unless value.nil?
        end
      end
    end
    ...
    class ListQualificationRequests
      def self.parse(http_resp)
        ...
        data.num_results = map['NumResults']
        data.next_token = map['NextToken']
        data.qualification_requests = (QualificationRequestList.parse(map['QualificationRequests']) unless map['QualificationRequests'].nil?)
        data
      end
    end
    ...
    class QualificationRequestList
      def self.parse(list)
        list.map do |value|
          QualificationRequest.parse(value) unless value.nil?
        end
      end
    end
    ...
    class ListQualificationTypes
      def self.parse(http_resp)
        ...
        data.num_results = map['NumResults']
        data.next_token = map['NextToken']
        data.qualification_types = (QualificationTypeList.parse(map['QualificationTypes']) unless map['QualificationTypes'].nil?)
        data
      end
    end
    ...
    class QualificationTypeList
      def self.parse(list)
        list.map do |value|
          QualificationType.parse(value) unless value.nil?
        end
      end
    end
    ...
    class ListReviewPolicyResultsForHIT
      def self.parse(http_resp)
        ...
        map = Hearth::JSON.load(body)
        data.hit_id = map['HITId']
        data.assignment_review_policy = (ReviewPolicy.parse(map['AssignmentReviewPolicy']) unless map['AssignmentReviewPolicy'].nil?)
        data.hit_review_policy = (ReviewPolicy.parse(map['HITReviewPolicy']) unless map['HITReviewPolicy'].nil?)
        data.assignment_review_report = (ReviewReport.parse(map['AssignmentReviewReport']) unless map['AssignmentReviewReport'].nil?)
        data.hit_review_report = (ReviewReport.parse(map['HITReviewReport']) unless map['HITReviewReport'].nil?)
        data.next_token = map['NextToken']
        data
      end
    end
    ...
    class ReviewReport
      def self.parse(map)
        ...
        data.review_results = (ReviewResultDetailList.parse(map['ReviewResults']) unless map['ReviewResults'].nil?)
        data.review_actions = (ReviewActionDetailList.parse(map['ReviewActions']) unless map['ReviewActions'].nil?)
        return data
      end
    end
    ...
    class ReviewActionDetailList
      def self.parse(list)
        list.map do |value|
          ReviewActionDetail.parse(value) unless value.nil?
        end
      end
    end
    ...
    class ReviewResultDetailList
      def self.parse(list)
        list.map do |value|
          ReviewResultDetail.parse(value) unless value.nil?
        end
      end
    end
    ...
    class ReviewPolicy
      def self.parse(map)
        ...
        data.parameters = (PolicyParameterList.parse(map['Parameters']) unless map['Parameters'].nil?)
        return data
      end
    end
    ...
    class PolicyParameterList
      def self.parse(list)
        list.map do |value|
          PolicyParameter.parse(value) unless value.nil?
        end
      end
    end
    ...
    class PolicyParameter
      def self.parse(map)
        ...
        data.key = map['Key']
        data.values = (StringList.parse(map['Values']) unless map['Values'].nil?)
        data.map_entries = (ParameterMapEntryList.parse(map['MapEntries']) unless map['MapEntries'].nil?)
        return data
      end
    end
    ...
    class ParameterMapEntryList
      def self.parse(list)
        list.map do |value|
          ParameterMapEntry.parse(value) unless value.nil?
        end
      end
    end
    ...
    class ListWorkerBlocks
      def self.parse(http_resp)
        ...
        data.next_token = map['NextToken']
        data.num_results = map['NumResults']
        data.worker_blocks = (WorkerBlockList.parse(map['WorkerBlocks']) unless map['WorkerBlocks'].nil?)
        data
      end
    end
    ...
    class WorkerBlockList
      def self.parse(list)
        list.map do |value|
          WorkerBlock.parse(value) unless value.nil?
        end
      end
    end
    ...
    class ListWorkersWithQualificationType
      def self.parse(http_resp)
        ...
        data.next_token = map['NextToken']
        data.num_results = map['NumResults']
        data.qualifications = (QualificationList.parse(map['Qualifications']) unless map['Qualifications'].nil?)
        data
      end
    end
    ...
    class QualificationList
      def self.parse(list)
        list.map do |value|
          Qualification.parse(value) unless value.nil?
        end
      end
    end
    ...
    class NotifyWorkers
      def self.parse(http_resp)
        ...
        return data if body.empty?
        map = Hearth::JSON.load(body)
        data.notify_workers_failure_statuses = (NotifyWorkersFailureStatusList.parse(map['NotifyWorkersFailureStatuses']) unless map['NotifyWorkersFailureStatuses'].nil?)
        data
      end
    end
    ...
    class NotifyWorkersFailureStatusList
      def self.parse(list)
        list.map do |value|
          NotifyWorkersFailureStatus.parse(value) unless value.nil?
        end
      end
    end
