...
module AWS::SDK::S3Control
  ...
  class Client
    ...
    #   resp.data.job.manifest_generator #=> JobManifestGenerator
    ...
    #   resp.data.configuration.transformation_configurations[0].content_transformation #=> ObjectLambdaContentTransformation
    #
