  ...
  module Parsers
    ...
    class DescribeSigningJob
      def self.parse(http_resp)
        ...
        data.signing_material = (SigningMaterial.parse(map['signingMaterial']) unless map['signingMaterial'].nil?)
        ...
        data.overrides = (SigningPlatformOverrides.parse(map['overrides']) unless map['overrides'].nil?)
        data.signing_parameters = (SigningParameters.parse(map['signingParameters']) unless map['signingParameters'].nil?)
        ...
        data.revocation_record = (SigningJobRevocationRecord.parse(map['revocationRecord']) unless map['revocationRecord'].nil?)
        data.signed_object = (SignedObject.parse(map['signedObject']) unless map['signedObject'].nil?)
    ...
    class SignedObject
      def self.parse(map)
        ...
        data.s3 = (S3SignedObject.parse(map['s3']) unless map['s3'].nil?)
        return data
      end
    end
    ...
    class SigningPlatformOverrides
      def self.parse(map)
        ...
        data.signing_configuration = (SigningConfigurationOverrides.parse(map['signingConfiguration']) unless map['signingConfiguration'].nil?)
    ...
    class Source
      def self.parse(map)
        ...
        data.s3 = (S3Source.parse(map['s3']) unless map['s3'].nil?)
        return data
      end
    end
    ...
    class GetSigningPlatform
      def self.parse(http_resp)
        ...
        data.signing_configuration = (SigningConfiguration.parse(map['signingConfiguration']) unless map['signingConfiguration'].nil?)
        data.signing_image_format = (SigningImageFormat.parse(map['signingImageFormat']) unless map['signingImageFormat'].nil?)
    ...
    class SigningImageFormat
      def self.parse(map)
        ...
        data.supported_formats = (ImageFormats.parse(map['supportedFormats']) unless map['supportedFormats'].nil?)
    ...
    class SigningConfiguration
      def self.parse(map)
        ...
        data.encryption_algorithm_options = (EncryptionAlgorithmOptions.parse(map['encryptionAlgorithmOptions']) unless map['encryptionAlgorithmOptions'].nil?)
        data.hash_algorithm_options = (HashAlgorithmOptions.parse(map['hashAlgorithmOptions']) unless map['hashAlgorithmOptions'].nil?)
        return data
      end
    end
    ...
    class HashAlgorithmOptions
      def self.parse(map)
        ...
        data.allowed_values = (HashAlgorithms.parse(map['allowedValues']) unless map['allowedValues'].nil?)
    ...
    class EncryptionAlgorithmOptions
      def self.parse(map)
        ...
        data.allowed_values = (EncryptionAlgorithms.parse(map['allowedValues']) unless map['allowedValues'].nil?)
        data.default_value = map['defaultValue']
        return data
      end
    end
    ...
    class GetSigningProfile
      def self.parse(http_resp)
        ...
        data.revocation_record = (SigningProfileRevocationRecord.parse(map['revocationRecord']) unless map['revocationRecord'].nil?)
        data.signing_material = (SigningMaterial.parse(map['signingMaterial']) unless map['signingMaterial'].nil?)
        data.platform_id = map['platformId']
        data.platform_display_name = map['platformDisplayName']
        data.signature_validity_period = (SignatureValidityPeriod.parse(map['signatureValidityPeriod']) unless map['signatureValidityPeriod'].nil?)
        data.overrides = (SigningPlatformOverrides.parse(map['overrides']) unless map['overrides'].nil?)
        data.signing_parameters = (SigningParameters.parse(map['signingParameters']) unless map['signingParameters'].nil?)
        data.status = map['status']
        data.status_reason = map['statusReason']
    ...
    class ListSigningJobs
      def self.parse(http_resp)
        ...
        map = Hearth::JSON.load(http_resp.body)
        data.jobs = (SigningJobs.parse(map['jobs']) unless map['jobs'].nil?)
        data.next_token = map['nextToken']
        data
      end
    end
    ...
    class SigningJobs
      def self.parse(list)
        data = []
        list.map do |value|
          data << SigningJob.parse(value) unless value.nil?
        end
        data
      end
    end
    ...
    class ListSigningPlatforms
      def self.parse(http_resp)
        ...
        map = Hearth::JSON.load(http_resp.body)
        data.platforms = (SigningPlatforms.parse(map['platforms']) unless map['platforms'].nil?)
        data.next_token = map['nextToken']
        data
      end
    end
    ...
    class SigningPlatforms
      def self.parse(list)
        data = []
        list.map do |value|
          data << SigningPlatform.parse(value) unless value.nil?
        end
        data
      end
    end
    ...
    class ListSigningProfiles
      def self.parse(http_resp)
        ...
        map = Hearth::JSON.load(http_resp.body)
        data.profiles = (SigningProfiles.parse(map['profiles']) unless map['profiles'].nil?)
        data.next_token = map['nextToken']
        data
      end
    end
    ...
    class SigningProfiles
      def self.parse(list)
        data = []
        list.map do |value|
          data << SigningProfile.parse(value) unless value.nil?
        end
        data
      end
    end
